...
// THÚ CƯNG
$thucung_chung = new db_query("SELECT `giong_thu_cung`,`do_tuoi`,`gioi_tinh`,`kich_co` FROM `new_description` WHERE `new_id` = $new_id");
$thucung_chung_ok = mysql_fetch_assoc($thucung_chung->result);
$gtc = $thucung_chung_ok['giong_thu_cung'];
$dotuoi = $thucung_chung_ok['do_tuoi'];
$gioitinh = $thucung_chung_ok['gioi_tinh'];
$kichco = $thucung_chung_ok['kich_co'];
    ...
    <div class="v-table mt-30 inf_ctiet_spham">
        <div class="row">
            <div class="col text_center">
                ...
                <p class="fs_14_16 mt_10">Cần bán</p>
            </div>
            <div class="col text_center">
                <p class="fs_16_19 font_600">TÊN TOÀ NHÀ / KHU DÂN CƯ</p>
                <p class="fs_14_16 mt_10">Biệt thự ven hồ</p>
            </div>
            <div class="col text_center">
            ...
            <div class="col text_center">
                ...
                <p class="fs_14_16 mt_10">Nam</p>
            </div>
        </div>
        <div class="row mt-50">
            <div class="col text_center">
                <p class="fs_16_19 font_600">GIẤY TỜ PHÁP LÝ</p>
                <p class="fs_14_16 mt_10">Đã có sổ</p>
            </div>
            <div class="col text_center">
    ...
    <div class="v-table mt-30 inf_ctiet_spham">
        <div class="row">
            ...
            <div class="col text_center">
                ...
                <p class="fs_14_16 mt_10">Đất cát</p>
            </div>
            <div class="col text_center">
        ...
        <div class="row mt-50">
            ...
            <div class="col text_center">
                <p class="fs_16_19 font_600">CHIỀU DÀI</p>
                <p class="fs_14_16 mt_10">100</p>
            </div>
            <div class="col text_center">
                <p class="fs_16_19 font_600">CHIỀU NGANG</p>
                <p class="fs_14_16 mt_10">80</p>
            </div>
            <div class="col text_center">
                <p class="fs_16_19 font_600">DIỆN TÍCH</p>
...
// Bất động sản Nhà trong ngõ
    ...
    <div class="v-table mt-30 inf_ctiet_spham">
        <div class="row">
            ...
            <div class="col text_center">
                <p class="fs_16_19 font_600">TÊN TOÀ NHÀ / KHU DÂN CƯ</p>
                <p class="fs_14_16 mt_10">Vin Home</p>
            </div>
            <div class="col text_center">
                <p class="fs_16_19 font_600">TỔNG SỐ TẦNG</p>
                <p class="fs_14_16 mt_10">4</p>
            ...
            <div class="col text_center">
                <p class="fs_16_19 font_600">HƯỚNG CỬA CHÍNH</p>
                <p class="fs_14_16 mt_10">Đông Nam</p>
            </div>
        </div>
        <div class="row mt-50">
            <div class="col text_center">
...
// Bất động sản Cửa hàng
    ...
    <div class="v-table mt-30 inf_ctiet_spham">
        <div class="row">
            ...
            <div class="col text_center">
                <p class="fs_16_19 font_600">HƯỚNG CỬA CHÍNH</p>
                <p class="fs_14_16 mt_10">Tây Bắc</p>
            </div>
        </div>
        <div class="row mt-50">
            <div class="col text_center">
    ...
    <div class="v-table mt-30 inf_ctiet_spham">
        <div class="row">
            ...
            <div class="col text_center">
                ...
                <p class="fs_14_16 mt_10">Giải trí</p>
            </div>
            <div class="col text_center">
                <p class="fs_16_19 font_600">TÌNH TRẠNG</p>
                <p class="fs_14_16 mt_10">Mới</p>
    ...
    <div class="v-table mt-30 inf_ctiet_spham">
        <div class="row">
            ...
            <div class="col text_center">
                ...
                <p class="fs_14_16 mt_10">09/6/2023</p>
            </div>
        </div>
    </div>
<? }
    ...
    <div class="v-table mt-30 inf_ctiet_spham">
        <div class="row">
            <div class="col text_center">
                ...
                <?$namethu = new db_query("SELECT `giong_thucung` FROM `giong_thu_cung` WHERE `id` = $gtc");
            ...
            <div class="col text_center">
                ...
                <p class="fs_14_16 mt_10"><?=$dotuoi?></p>
            </div>
            <div class="col text_center">
                <p class="fs_16_19 font_600">KÍCH CỠ THÚ CƯNG</p>
                <p class="fs_14_16 mt_10"><?=$kichco?></p>
            </div>
            <div class="col text_center">
                <p class="fs_16_19 font_600">GIỚI TÍNH</p>
                <p class="fs_14_16 mt_10"><?$gioitinh?></p>
            </div>
        </div>
    </div>
<? }
    ...
    <div class="v-table mt-30 inf_ctiet_spham">
        ...
        <? if ($id_nhom == 1) { ?>
            <div class="row">
                ...
                <div class="col text_center">
                    <p class="fs_16_19 font_600">HẠN SỬ DỤNG</p>
                    <p class="fs_14_16 mt_10">25/06/2022</p>
                </div>
                <div class="col text_center">
        ...
        <? if ($id_nhom == 1) { ?>
            ...
            <div class="row mt-50">
                ...
                <div class="col text_center">
                    ...
                    <p class="fs_14_16 mt_10">Ultra HD 8K</p>
                </div>
                <div class="col text_center">
                    <p class="fs_16_19 font_600">BẢO HÀNH</p>
                    <p class="fs_14_16 mt_10">Còn bảo hành</p>
        ...
        <? if ($id_nhom == 1 || $id_nhom == 2 || $id_nhom == 3) { ?>
            <div class="row">
                ...
                <div class="col text_center">
                    ...
                    <p class="fs_14_16 mt_10">GTS 3</p>
                </div>
                <div class="col text_center">
                    <p class="fs_16_19 font_600">BẢO HÀNH</p>
                    <p class="fs_14_16 mt_10">Còn bảo hành</p>
...
// Sức khỏe - Sắc đẹp Mỹ phẩm
    ...
    <div class="v-table mt-30 inf_ctiet_spham">
        <div class="row">
            ...
            <div class="col text_center">
                <p class="fs_16_19 font_600">HẠN SỬ DỤNG</p>
                <p class="fs_14_16 mt_10">03/2024</p>
            </div>
        </div>
    </div>
<? }
    ...
    <div class="v-table mt-30 inf_ctiet_spham">
        <div class="row">
            ...
            <div class="col text_center">
                ...
                <p class="fs_14_16 mt_10">Trung Quốc</p>
            </div>
            <div class="col text_center">
                <p class="fs_16_19 font_600">MÀU SẮC</p>
        ...
        <div class="row mt-50">
            <div class="col text_center">
                ...
                <p class="fs_14_16 mt_10">M (50cm)</p>
            </div>
            <div class="col text_center">
                <p class="fs_16_19 font_600">CHẤT LIỆU KHUNG</p>
                <p class="fs_14_16 mt_10">Thép</p>
        ...
        <div class="row">
            ...
            <div class="col text_center">
                <p class="fs_16_19 font_600">LOẠI XE ĐẠP</p>
                <p class="fs_14_16 mt_10">Xe đạp thể thao</p>
            </div>
            <div class="col text_center">
                <p class="fs_16_19 font_600">DÒNG XE ĐẠP THỂ THAO</p>
                <p class="fs_14_16 mt_10">Fixed Gear</p>
            </div>
            <div class="col text_center">
                <p class="fs_16_19 font_600">MÀU SẮC</p>
                <p class="fs_14_16 mt_10">Đen</p>
        ...
        <div class="row mt-50">
            <div class="col text_center">
                <p class="fs_16_19 font_600">XUẤT XỨ</p>
                <p class="fs_14_16 mt_10">Việt Nam</p>
            </div>
        </div>
    </div>
<? }
// Xe cộ Xe máy
    ...
    <div class="v-table mt-30 inf_ctiet_spham">
        ...
        <? } else if ($id_nhom == 2) { ?>
            ...
            <div class="row mt-50">
                <div class="col text_center">
                    <p class="fs_16_19 font_600">DUNG TÍCH XE</p>
                    <p class="fs_14_16 mt_10">150cc</p>
                </div>
                <div class="col text_center">
                    <p class="fs_16_19 font_600">BIỂN SỐ XE</p>
                    <p class="fs_14_16 mt_10">17B6-666.66</p>
                </div>
                <div class="col text_center">
                    <p class="fs_16_19 font_600">SỐ KM ĐÃ ĐI</p>
                    <p class="fs_14_16 mt_10">12.000</p>
                </div>
                <div class="col text_center">
                    <p class="fs_16_19 font_600">TÌNH TRẠNG</p>
                    <p class="fs_14_16 mt_10">Mới</p>
    ...
    <div class="v-table mt-30 inf_ctiet_spham">
        <? if ($id_nhom == 1) { ?>
            <div class="row">
                ...
                <div class="col text_center">
                    ...
                    <p class="fs_14_16 mt_10">Tự động</p>
                </div>
            </div>
            <div class="row mt-50">
                <div class="col text_center">
            ...
            <div class="row mt-50">
                <div class="col text_center">
                    ...
                    <p class="fs_14_16 mt_10">Sedan</p>
                </div>
                <div class="col text_center">
                    <p class="fs_16_19 font_600">BẢO HÀNH</p>
                    <p class="fs_14_16 mt_10">Còn bảo hành</p>
        ...
        <? } else if ($id_nhom == 2) { ?>
            ...
            <div class="row mt-50">
                ...
                <div class="col text_center">
                    <p class="fs_16_19 font_600">SỐ KM ĐÃ ĐI</p>
                    <p class="fs_14_16 mt_10">12.345</p>
                </div>
            </div>
        <? } ?>
    </div>
        ...
        <div class="row">
            ...
            <div class="col text_center">
                ...
                <?
                    if ($id_sp == 91) {
                ?>
                        <p class="fs_14_16 mt_10">Xe đạp điện</p>
                <?
                    } else if ($id_sp == 92) {
                ?>
                        <p class="fs_14_16 mt_10">Xe máy điện</p>
                <?
                    }
                ?>
            </div>
...
// Xe cộ Xe tải, xe khác
    ...
    <div class="v-table mt-30 inf_ctiet_spham">
        <div class="row">
            ...
            <div class="col text_center">
                <p class="fs_16_19 font_600">DUNG LƯỢNG LƯU TRỮ</p>
                <p class="fs_14_16 mt_10">64 GB</p>
            </div>
            <div class="col text_center">
                <p class="fs_16_19 font_600">TÌNH TRẠNG</p>
        ...
        <!-- <div class="row mt-50">
            <? if ($id_nhom == 2) { ?>
                <div class="col text_center">
                    <p class="fs_16_19 font_600">SỐ KM ĐÃ ĐI</p>
                    <? if ($id_nhom == 2) { ?>
                        <p class="fs_14_16 mt_10">15000</p>
                    <? } ?>
                </div>
            <? } ?>
            <div class="col text_center">
