...
$listAll = $menu->getAllChild("categories_pro","cat_id","cat_parent_id",$iCat,$sql . " AND lang_id = " . $lang_id . $sqlcategory,"cat_id,cat_name,cat_order,cat_type,cat_parent_id,cat_has_child,cat_picture,cat_active,admin_id,cat_show","cat_type ASC,cat_order ASC, cat_name ASC","cat_has_child");
