...
$myform->add("cat_type","cat_type",0,0,$cat_type,0,translate_text("Please choose category type"),0,"");
...
if($array_config["description"]==1) echo $form->textarea(translate_text("Mô tả"), "cat_description", "cat_description", $cat_description, translate_text("Mô tả"), 1, 600, 120, "", "", "");
