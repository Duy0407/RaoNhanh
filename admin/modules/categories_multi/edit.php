...
$menu 				= 	new menu();
$listAll 			= 	$menu->getAllChild("category","cat_id","cat_parent_id","0",$sql . " AND lang_id = " . $_SESSION["lang_id"] . $sqlcategory,"cat_id,cat_name,cat_order,cat_type,cat_parent_id,cat_has_child","cat_order ASC, cat_name ASC","cat_has_child");
?>
...
<? 
if($array_config["order"]==1) echo $form->text(translate_text("Thứ tự"),"cat_order","cat_order",$cat_order,translate_text("Thứ tự"),1,50,"",255);
if($array_config["image"]==1) echo $form->getFile(translate_text("Ảnh đại diện"), "picture", "picture", translate_text("Ảnh đại diện"), 0, 32, "", '(Dung lượng tối đa <font color="#FF0000">' . $limit_size . ' Kb</font>)');
if($array_config["description"]==1) echo $form->textarea(translate_text("Mô tả"), "cat_description", "cat_description", $cat_description, translate_text("Mô tả"), 0, 600, 120, "", "", "");
