...
$list->add("usc_store_name", "Tên người dùng", "string", 0, 1);
...
if ($xuatex != "") {
   ...
   header("Content-Disposition: attachment; filename=gianhang_raonhanh.xlsx");
   readfile("https://raonhanh365.vn/admin/modules/gianhang/gianhang_raonhanh.xlsx");
}
?>
<!DOCTYPE html>
...
<body>
   <div id="listing">
      ...
      ?>
         ...
         <td width="300" align="center"><a href="/gian-hang/<?= $row['usc_id'] ?>/<?= replaceTitle($row['usc_store_name']) ?>.html" target="_blank"><?= $row['usc_store_name'] ?></a></td>
         <td width="200" align="center"><a><?= ($row['usc_email'] != '') ? $row['usc_email'] : 'Chưa cập nhật' ?></a></td>
