...
$myform->add("han_ghim", "han_ghim", 0, 0, 0, 0, "", 0, "");
$myform->add("ghim_gian_hang", "ghim_gian_hang", 1, 0, 0, 0, "", 0, "");
$myform->add("time_update_ghim", "time_update_ghim", 1, 0, 0, 0, "", 0, "");
#+
...
if ($action == "submitForm") {
    if($_POST['han_ghim'] != "" && $_POST['han_ghim'] < time()){
        $errorMsg .= 'Thời gian hết hạn ghim phải lớn hơn thời gian hiện tại';
    }
    #+
    #+ Kiểm tra lỗi
    ...
    if ($errorMsg == "") {
        ...
        $han_ghim2    = strtotime($han_ghim);
        $query        = str_replace($han_ghim, $han_ghim2, $query);
...
<body topmargin="0" bottommargin="0" leftmargin="0" rightmargin="0">
    ...
    <tr>
        <td>Ghim gian hàng đến ngày:</td>
        <td><input type="datetime-local" name="han_ghim" id="han_ghim" value="<?= ($rowdb->han_ghim != 0) ? date('Y-m-d\TH:i', $rowdb->han_ghim) : '' ?>" /></td>
    </tr>
    <tr>
        <td>Ghim gian hàng:</td>
        <td class="form_text">
            <input type="checkbox" name="ghim_gian_hang" id="ghim_gian_hang" value="1" <?= ($rowdb->ghim_gian_hang) ? "checked" : "" ?> />
        </td>
    </tr>
    <tr><input type="hidden" name="time_update_ghim" value="<?= time() ?>"></tr>
