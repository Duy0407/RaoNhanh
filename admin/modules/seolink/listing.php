...
require_once("inc_security.php");
	...
	$list->add("seo_link","Đường dẫn","string",0,0);
	$list->add($field_name, translate_text("Tiêu đề"), "string", 1, 0);
	$list->add("seo_description","Mô tả","string",0,0);
	$list->add("seo_keyword","Từ khóa","string",0,0);
	$list->add("seo_date","Ngày tạo","date",1,0, 'width="100"');
	$list->add("seo_active", "Active", "checkbox", 1, 0);
