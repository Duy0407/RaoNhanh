...
<?=$form->text(translate_text("Đường dẫn"),"seo_link","seo_link",$seo_link,translate_text("link"),1,550,"",255)?>
<?=$form->text(translate_text("Tiêu đề"),"seo_title","seo_title",$seo_title,translate_text("title"),1,250,"",255)?>
<?=$form->textarea(translate_text("Mô tả"), "seo_description", "seo_description", $seo_description, translate_text("description"), 1, 600, 120, "", "", "");?>
<?=$form->textarea(translate_text("Từ khóa"), "seo_keyword", "seo_keyword", $seo_keyword, translate_text("keyword"), 1, 600, 120, "", "", "");?>
