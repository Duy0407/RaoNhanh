...
// $myform->add("ngay_bdghim", "new_update_time", 1, 0, 0, 0, "", 0, "");
#+
...
if ($action == "submitForm") {
    ...
    $ngay_kt = $_POST['ngay_ktghim'];
    $ngay_kt = strtotime($ngay_kt);
    $thoigian_bd = $_POST['new_update_time'];

    $innser_gt = new db_query("UPDATE `new` SET `new_pin_home`='$new_pin_home',`new_pin_cate`='$new_pin_cate',
                            `thoigian_bdghim`='$thoigian_bd',`ngay_bdghim`='$thoigian_bd',`ngay_ktghim`='$ngay_kt' WHERE `new_id`='$record_id' ");
...
<body topmargin="0" bottommargin="0" leftmargin="0" rightmargin="0">
    ...
    <tr>
        <td>
            <span class="form_asterisk">*</span>Tiêu đề tin
        </td>
        <td><input type="text" name="new_title" id="new_title" value="<?= $rowdb->new_title  ?>" readonly /></td>
    </tr>
    <tr>
        <td>Thời gian kết thúc ghim</td>
        <td><input type="datetime-local" name="ngay_ktghim" id="ngay_ktghim" value="<?= ($rowdb->ngay_ktghim != 0) ? date('Y-m-d\TH:i', $rowdb->ngay_ktghim) : '' ?>" /></td>
    </tr>
    <tr>
        <td>Gói ghim trang chủ:</td>
        <td class="form_text">
            <input type="radio" name="new_pin_home" id="new_pin_home" value="1" <?= ($rowdb->new_pin_home) ? "checked" : "" ?> />
        </td>
    </tr>
    <tr>
        <td>Gói ghim trang ngành</td>
        <td><input type="radio" name="new_pin_home" id="new_pin_cate" value="2" <?= ($rowdb->new_pin_cate) ? "checked" : "" ?> /></td>
    </tr>
    <tr><input type="hidden" name="new_update_time" value="<?= strtotime(date('Y-m-d H:i:s', time())) ?>"></tr>
