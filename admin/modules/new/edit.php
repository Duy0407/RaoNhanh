...
$mo_ta = getValue('new_description', 'str', 'POST', '');
#+
...
if ($action == "submitForm") {
	...
	if ($errorMsg == "") {
		...
		$update_des = new db_query("UPDATE `new_description` SET `new_description` = '$mo_ta' WHERE `new_id` = $record_id ");
...
<body topmargin="0" bottommargin="0" leftmargin="0" rightmargin="0">
	...
	<?= $form->close_table(); ?>
	<?= $form->wysiwyg("<font class='form_asterisk'>*</font>Mô tả chi tiết", "new_description", $new_description, "../../resource/ckeditor/", "99%", 300) ?>
	<?= $form->create_table(); ?>
