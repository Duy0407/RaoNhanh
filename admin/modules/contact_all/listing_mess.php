...
require_once("inc_security.php");
	...
	//gọi class DataGird
	$list = new fsDataGird($field_id_mess,$field_name_mess,translate_text("Listing"));
   ...
   $list->add("con_email", translate_text("Email"), "string", 1, 0);
   $list->add("con_mess", translate_text("Message"), "string", 1, 0);
	...
	$db_listing = new db_query("SELECT * 
										 FROM " . $fs_table_mess . "
										 WHERE 1 " . $sql . "
										 ORDER BY " . $list->sqlSort() . $field_id_mess . " DESC
  ...
  while($row  = mysql_fetch_assoc($db_listing->result)){
    ...
    ?>
         <?=$list->start_tr($i, $row['con_id'])?>
         	<td width="300" align="center"><p style="padding: 0; margin: 0;"><?=$row['con_fullname']?></p></td>
            <td width="300" align="center"><p style="padding: 0; margin: 0;"><?=$row['con_email']?></p></td>
            <td width="300" align="center"><p style="padding: 0; margin: 0;"><?=$row['con_mess']?></p></td>
