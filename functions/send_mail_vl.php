   ...
   $body = '<body style="width: 100%;text-align: center;background-color: #eeeeee;padding: 0;margin: 0;font-family: Arial,sans-serif;padding-top: 20px;padding-bottom: 20px;">
      <table style="width: 600px;background: #fff;margin: 0 auto;border-collapse: collapse;">
         <tr style="background: #f1f6f9;border-bottom: 5px solid #daa52e;height: 81px;">
            ...
            <a title="Tìm việc làm nhanh, việc làm thêm" style="text-decoration: none;">
            ...
            <a style="text-decoration:none;color:#f26222;font-size:14px;float:right;padding-top:25px;padding-right:34px;" title="Chợ mua bán, quảng cáo, rao vặt miễn phí">Raonhanh365</a>
            </td>
         </tr>
         <tbody >
         <tr>
            <td style="width: 100%;padding: 0 33px;">
               ...
               <p style="margin: 0;font-size: 14px;text-align: left;color: #3a4c56;line-height: 20px;margin-bottom: 10px;">Chúc mừng bạn đã hoàn thành thông tin đăng ký tài khoản tại <a style="color: #269b91;font-size: 14px;font-weight: 600;" href="https://raonhanh365.vn" title="Rao nhanh 365" >Raonhanh365.vn</a></p>
      ...
      <table style="width: 600px;background: #fff;margin: 0 auto;border-collapse: collapse;">
         ...
         <tr>
            <td style="width: 100%;padding: 0 33px;">
               ...
               <a target="_blank" href="https://raonhanh365.vn/doi-mat-khau-vl.html?reset_token='.$token.'&id='.$id.'" font-size: 15px;">https://raonhanh365.vn/doi-mat-khau-vl.html?reset_token='.$token.'&id='.$id.'</a></h2>
