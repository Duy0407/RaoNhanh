                ...
                if ($cou_file > 0 || $cou_dang > 0) {
                    ...
                    if (mysql_num_rows($query_check->result) > 0) {
                        ...
                        $query_dt = new db_query("INSERT INTO `new`(`new_title`,`link_title`,`new_money`, `new_cate_id`, `new_city`, `new_user_id`, `new_image`,
                                    ...
                                    '" . $so_nha . "','" . $td_diachi_nha . "','$file_video','$ctiet_dmuc','$ngay_dang','$tien_datcoc','$dc_new_unit')");
                        ...
                        $query_decription = new db_query("INSERT INTO `new_description`(`new_id`, `new_description`,`can_ban_mua`, `ten_toa_nha`,
                                                    ...
                                                    VALUES ('$id','$mo_ta','$ban_thue','$ten_toanha','$so_tang','$huong_cua','$so_phongngu','$so_phong_vs',
                                                    '$giayto','$tinhtrangnt', '$dacdiem','$dientich','$chieudai','$chieungang',
                        ...
                        //     'FromWeb' => $domain
                        // ];
                        // $MessageInforSupport = "Xin chào, " . $usc_company . "" . $phone . "" . $email . "tôi vừa đăng tin bất động sản nhà đất trên " . $domain;
                        // $data_send_to_group = [
                        //     'LiveChat' => $LiveChat,
