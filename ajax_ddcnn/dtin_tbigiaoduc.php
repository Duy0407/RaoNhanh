                ...
                if ($cou_file > 0 || $cou_dang > 0) {
                    ...
                    if (mysql_num_rows($check_tde->result) > 0) {
                        ...
                        $inser_td = new db_query("INSERT INTO `new`(`new_title`,`link_title`, `new_money`, `new_cate_id`, `new_city`, `new_user_id`, `new_image`,
                                        ...
                                        `chotang_mphi`, `quan_huyen`, `phuong_xa`, `new_sonha`, `dia_chi`, `new_video`, `new_ctiet_dmuc`,`new_tinhtrang`,`new_buy_sell`,`new_update_time`)
                        ...
                        $inser_des = new db_query("INSERT INTO `new_description`(`new_id`, `new_description`)
                                    VALUES ('$id_dt','$mo_ta')");
                        ...
                        $MessageInforSupport = "Xin chào, " . $usc_company . "" . $phone . "" . $email . "tôi vừa đăng tin thiết bị giao dục trên " . $domain;
                        $data_send_to_group = [
                            'LiveChat' => $LiveChat,
