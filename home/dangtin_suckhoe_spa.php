...
<head>
    ...
    <title>Đăng tin sức khỏe sắc đẹp Spa</title>
        ...
        <div class="tindang-container">
            ...
            <div class="tindang-content-cont hd-disflex">
                ...
                <div class="tindang-col-right">
                    <form class="form-dtin-cont" id="form_spa" data="<?= $acc_id ?>" data1="<?= $acc_type ?>">
                        <div class="row-tin-dang danhmuc_tt">
                            <p class="font-dam hd_font15-17">Danh mục sản phẩm <span class="color_red">*</span></p>
                            <input type="text" class="dmuc-spham" data="62" readonly name="san-pham-laptop" placeholder="Sức khỏe - Sắc đẹp >> Spa">
                        </div>
                        ...
                        <div class="row-tin-dang cont-btn-sb hd-disflex hide-480-mobile">
                            ...
                            <button type="button" id="xoa_tddang_tin" class="btn-submit td-dang-tin dt_spa hd_cspointer font-bold">ĐĂNG TIN</button>
                        </div>
                    </form>
                </div>
            </div>
...
<script>
    $(".td-dang-tin").click(function() {
        ...
        if (form_spa.valid() === true) {
            ...
            $.ajax({
                url: '/ajax_sksd/dangtin_sksd_spa.php',
                type: 'POST',
                data: fd,
                contentType: false,
                processData: false,
                beforeSend: function() {
                    $('.dt_spa').prop('disabled', true);
                },
