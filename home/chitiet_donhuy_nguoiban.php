...
if (isset($_COOKIE['UID']) && isset($_COOKIE['UT']) && $id != 0) {
    ...
    $list_dh = new db_query("SELECT `dh_id`,`id_nguoi_dh`, `id_nguoi_ban`, `id_spham`, `ghi_chu`, `loai_ttoan`, `tien_ttoan`, `dia_chi_nhanhang`, `trang_thai`,
                            `tgian_xnbh`, `usc_name`, `usc_logo`,`chat365_id`,`usc_id`, `usc_phone`, `new_title`, `new_money`, `new_unit`, `new_user_id`,
                            `new_type`, `new_image`, `ly_do_hdon`,
                            `tgian_huydhang` FROM `dat_hang` INNER JOIN `new` ON `new`.`new_id` = `dat_hang`.`id_spham`
                            INNER JOIN `user` ON `user`.`usc_id` = `dat_hang`.`id_nguoi_dh`
                            WHERE `trang_thai` = 5 AND `id_nguoi_ban` = $id_user AND `dh_id` = $id ");
        ...
        <div class="box-right edit_pers">
            <div class="box-right-detail">
                <div class="detail-top">
                    <a href="../quan-ly-don-hang-nguoi-ban.html"><img src="/images/bo-sung-raonhanh/muiten-back.svg" alt=""></a>
                ...
                <div class="detail-main">
                    <div class="detail-main-t">
                        ...
                        <div class="main-t-p">
                            ...
                            <p class="color_orange text_status">ĐÃ HỦY</p>
                        </div>
                            ...
                            <div class="bot-ql">
                                ...
                                <div class="content-bot-c">
                                    <div class="detail-sp">
                                        ...
                                        <p class="text_reason">Lý do: <?= $row_tin['ly_do_hdon'] ?></p>
                                    </div>
                                </div>
                            </div>
                            <div class="sp-price">
                        ...
                        <div class="main-t-note">
                            ...
                            <div class="input-mar"><input class="input-note" type="text" value="<?= $row_tin['ghi_chu'] ?>" readonly></div>
                        </div>
                        <div class="box-right-rec"></div>
                        <div class="main-pay">
                            <div class="pay-left">
