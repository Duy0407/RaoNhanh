...
<body>
    ...
    <section id="m_dangtin_thethao" class="thethao">
        ...
        <form class="form-dtin-cont form_bds_chung" id="form_thethaothoitrang" data="<?= $acc_id ?>" data1="<?= $acc_type ?>" data2="<?= $id_nd ?>" data3="<?= $xacthuc_lket ?>">
            <div class="container_content">
                ...
                <div class="b6_monthethao d_flex fl_cl box_input_infor">
                    ...
                    <select class="slect-hang hd_height36 mon_the_thao" name="mon_thethao">
    ...
    <script>
        ...
        $(".b11_btn_chinhsua").click(function() {
            ...
            if (form_thethaothoitrang.valid() === true) {
                ...
                var id_nd = $("#form_thethaothoitrang").attr("data2");
                var id_dm = $(".b1_fr2_title_p").attr('data');
