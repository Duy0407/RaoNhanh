...
<head>
    ...
    <title>Chỉnh sửa bất động sản nhà đất</title>
...
<body>
    ...
    <!-- content -->
    <section id="m_dangtin_bds_nhadat">
                ...
                <div class="ctn_ct_box1 d_flex fl_cl w100">
                    ...
                    <div class="ctn_ct_b1_fr2 w100">
                        <div class="b1_fr2_title w100">
                            <p class="b1_fr2_title_p p_400_s16_l19 d_flex fl_row al_ct" data="11" data1="<?= $id_nd ?>">
                    ...
                    <div class="ctn_ct_b6_ft d_flex fl_row al_ct">
                        <div class="b6_ft1 d_flex fl_cl">
                            ...
                            <select class="slect-hang  hd_height36" name="so_tang">
                                <option selected value="">Tổng số tầng</option>
    ...
    <script>
        ...
        $(".b11_btn_dangtin").click(function() {
            ...
            form_bds_nhadat.validate({
                ...
                messages: {
                    ...
                    td_gia_datcoc: "Vui lòng nhập giá đặt cọc",
                    mota: {
        ...
        function xem_trc_tin() {
            ...
            if (form_bds_nhadat.valid() === true) {
                ...
                fd.append('loai_sp6', so_phong_vs);
