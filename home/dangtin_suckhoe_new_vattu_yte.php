...
if (isset($_COOKIE['UID']) && isset($_COOKIE['UT'])) {
    ...
    $acc_type = $_COOKIE['UT'];
    $id_cat_parent = 209;
    $sql_dm = new db_query("SELECT `tags_id`, `ten_tags` FROM `key_tags` WHERE id_danhmuc = 63");
...
<head>
    ...
    <title>Đăng tin Vật tư - Y tế </title>
...
<body>
    ...
    <section id="m_dangtin_sk_vattu_yte" class="suckhoe">
        ...
        <form class="form-dtin-cont form_bds_chung" id="form_vattu_yte" data="<?= $acc_id ?>" data1="<?= $acc_type ?>" data3="<?= $xacthuc_lket ?>">
            <div class="container_content">
                ...
                <div class="b6_hangvattu d_flex fl_cl box_input_infor">
                    ...
                    <input type="text" class="b6_hvt_input hd_height36 w100" name="hang" placeholder="Nhập hãng">
                </div>
                <!-- tinh trang -->
