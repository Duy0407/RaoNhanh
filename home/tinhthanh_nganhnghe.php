<?
    ...
    $url_default = "https://raonhanh365.vn".rewriteCate1($catid,$catname,$city,$cit_name);

    $urluri = "https://raonhanh365.vn".$_SERVER['REQUEST_URI'];

    $url_default_n = $url_default;

    if ($page > 1) {
       $url_default_n = $url_default.'?page='.$page;
   }

   if($url_default_n != $urluri)
   {
       header("HTTP/1.1 301 Moved Permanently"); 
       header("Location: $url_default_n");
       exit();
   }
?>
<!DOCTYPE html>
...
<head>
    ...
    <?if ($city != 0){?>
    <title>Tuyển dụng, tìm việc làm tại <?=$cit_name?> - <?= $m = date('m', time());?>/<?=$y = date('Y', time());?></title>
    <meta name="robots" content="noindex,nofollow"/>
    <link rel="canonical" href="https://raonhanh365.vn/viec-lam-tai-<?= replaceTitle($cit_name) ?>-n0t<?=$city?>" />
    <meta name="description" content="Việc làm tại <?=$cit_name?> mới nhất được cập nhật trên Raonhanh365. Danh sách tin tuyển dụng việc làm <?=$cit_name?>  lương cao cập nhật thường xuyên và liên tục."/>
    <meta name="Keywords" content="tìm việc làm tại <?=$cit_name?>, việc làm tại <?=$cit_name?>"/>

    <meta property="og:locale" content="vi_VN" />
    <meta property="og:type" content="website" />
    <meta property="og:title" content="Tuyển dụng, tìm việc làm tại <?=$cit_name?> - <?= $m = date('m', time());?>/<?=$y = date('Y', time());?>"/>
    <meta property="og:description" content="Việc làm tại <?=$cit_name?> mới nhất được cập nhật trên Raonhanh365. Danh sách tin tuyển dụng việc làm <?=$cit_name?>  lương cao cập nhật thường xuyên và liên tục."/>
    <meta property="og:site_name" content="raonhanh365.vn" />

    <meta name="twitter:card" content="summary" />
    <meta name="twitter:description" content="Việc làm tại <?=$cit_name?> mới nhất được cập nhật trên Raonhanh365. Danh sách tin tuyển dụng việc làm <?=$cit_name?>  lương cao cập nhật thường xuyên và liên tục." />
    <meta name="twitter:title" content="Tuyển dụng, tìm việc làm tại <?=$cit_name?> - <?= $m = date('m', time());?>/<?=$y = date('Y', time());?>" />
    <?}?>
    <?if ($catid != 0){?>
    <title>Tuyển dụng, tìm việc làm  <?=$catname_vl?> - <?= $m = date('m', time());?>/<?=$y = date('Y', time());?></title>
    <meta name="robots" content="noindex,nofollow"/>
    <link rel="canonical" href="https://raonhanh365.vn/viec-lam-<?= replaceTitle($catname_vl) ?>-n<?=$catid?>t0" />
    <meta name="description" content="Danh sách việc làm <?=$catname_vl?> mới nhất được cập nhật thường xuyên và liên tục trên Raonhanh365. Tin tuyển dụng việc làm <?=$catname_vl?> lương cao - <?= $m = date('m', time());?>/<?=$y = date('Y', time());?>"/>
    <meta name="Keywords" content="việc làm <?=$catname_vl?>"/>

    <meta property="og:locale" content="vi_VN" />
    <meta property="og:type" content="website" />
    <meta property="og:title" content="Tuyển dụng, tìm việc làm  <?=$catname_vl?> - <?= $m = date('m', time());?>/<?=$y = date('Y', time());?>"/>
    <meta property="og:description" content="Danh sách việc làm <?=$catname_vl?> mới nhất được cập nhật thường xuyên và liên tục trên Raonhanh365. Tin tuyển dụng việc làm <?=$catname_vl?> lương cao - <?= $m = date('m', time());?>/<?=$y = date('Y', time());?>"/>
    <meta property="og:site_name" content="raonhanh365.vn" />

    <meta name="twitter:card" content="summary" />
    <meta name="twitter:description" content="Danh sách việc làm <?=$catname_vl?> mới nhất được cập nhật thường xuyên và liên tục trên Raonhanh365. Tin tuyển dụng việc làm <?=$catname_vl?> lương cao - <?= $m = date('m', time());?>/<?=$y = date('Y', time());?>" />
    <meta name="twitter:title" content="Tuyển dụng, tìm việc làm  <?=$catname_vl?> - <?= $m = date('m', time());?>/<?=$y = date('Y', time());?>" />
    <?}?>
