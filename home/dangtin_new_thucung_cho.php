...
if (isset($_COOKIE['UID']) && isset($_COOKIE['UT'])) {
    $acc_id = $_COOKIE['UID'];
    $acc_type = $_COOKIE['UT'];
    $sql_dm = new db_query("SELECT `tags_id`, `ten_tags` FROM `key_tags` WHERE id_danhmuc = 111");
...
<body>
    ...
    <section id="m_dangtin_thucung" class="suckhoe thucung">
        ...
        <form class="form-dtin-cont form_bds_chung" id="form_tc_cho" data="<?= $acc_id ?>" data1="<?= $acc_type ?>" data3="<?= $xacthuc_lket ?>">
    ...
    <script>
        $(".b11_btn_dangtin").click(function() {
            ...
            if (form_tc_cho.valid() === true) {
                ...
                var xac_thuc = $("#form_tc_cho").attr("data3");
