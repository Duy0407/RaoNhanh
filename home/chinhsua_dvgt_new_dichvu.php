...
<body>
    ...
    <section id="m_dangtin_dichvu" class="suckhoe dichvugiaitri">
        ...
        <form class="form-dtin-cont form_bds_chung" id="form_service" data="<?= $acc_id ?>" data1="<?= $acc_type ?>" data2="<?= $id_nd ?>" data3="<?= $xacthuc_lket ?>">
                ...
                <div class="ctn_ct_box1 d_flex fl_cl w100">
                    ...
                    <div class="ctn_ct_b1_fr2 w100">
                        <div class="b1_fr2_title w100">
                            <p class="b1_fr2_title_p p_400_s16_l19 d_flex fl_row al_ct" data="65">
    ...
    <script>
        $(".b11_btn_chinhsua").click(function() {
            ...
            if (form_service.valid() === true) {
                ...
                var id_nd = $("#form_service").attr("data2");
                ...
                var xac_thuc = $("#form_service").attr("data3");
    ...
    <script>
        ...
        function xem_trc_tin() {
            var form_service = $(".form-dtin-cont");
            form_service.validate({
                errorPlacement: function(error, element) {
                    error.appendTo(element.parents(".box_input_infor"));
                    error.wrap("<span class='error'>");
