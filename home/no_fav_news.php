        ...
        <div class="themdivkhongtimyeuthich">
            ...
            <div class="box-right">
                ...
                <div class="text-no-news text-no-news_df">
                    ...
                    <div class="content-fav">Bạn chưa yêu thích tin nào <br> Hãy lướt tìm Raonhanh365 và kiếm cho mình những món hàng yêu thích nhé</div>
                    <div class="box-up-news">
                        <a href="" class="text-box-return">Về trang chủ</a>
                    </div>
                </div>
            </div>
        </div>
