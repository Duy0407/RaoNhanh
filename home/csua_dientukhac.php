        ...
        <div class="tindang-container">
            ...
            <div class="tindang-content-cont hd-disflex">
                ...
                <div class="tindang-col-right" data="<?= $id_cs ?>">
                    <form class="form-dtin-cont" id="form_dt_dientukhac" data="<?= $us_id ?>" data1="<?= $us_type ?>">
                        <div class="row-tin-dang-dau">
                            <p class="font-dam hd_font15-17">Danh mục sản phẩm<span class="color_red">*</span></p>
                            <input data="<?= $id_dm ?>" type="text" class="dmuc-spham" readonly name="danhmucsanpham_dt" placeholder="Đồ điện tử >> Đồ điện tử khác">
                        </div>
...
<script>
    $(".td-dang-tin").click(function() {
        ...
        if (form_dt_dientukhac.valid() === true) {
            ...
            var bao_hanh = $("select[name='baohanh']").val();
            ...
            $.ajax({
                type: 'POST',
                url: '/ajax_ddtu/csua_dodientukhac.php',
                data: fd,
                processData: false,
                contentType: false,
