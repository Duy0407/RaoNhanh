...
if (isset($_COOKIE['UID']) && isset($_COOKIE['UT'])) {
    ...
    $acc_type = $_COOKIE['UT'];
    $id_cat_parent = 209;
    $sql_dm = new db_query("SELECT `tags_id`, `ten_tags` FROM `key_tags` WHERE id_danhmuc = 19");
...
<body>
    ...
    <section id="m_dangtin_ship" class="suckhoe ship">
        ...
        <form class="form-dtin-cont form_bds_chung" id="form_ship" data="<?= $acc_id ?>" data1="<?= $acc_type ?>">
                    ...
                    <div class="box_thoiganlamviec d_flex fl_row gap20">
                        <div class="tglv_thoigian d_flex fl_row gap20 al_ct">
                            <div class="box_batdau_tglv box_input_infor">
                                <input type="time" class="batdau_tglv input_infor_tag error time_work" name="time_lamviec">
                            </div>
                            <img src="/images/m_raonhanh_imgnew/Line 12.png" class="thanhngang_tglv">
                            <div class="box_batdau_tglv box_input_infor">
                                <input type="time" class="ketthuc_tglv input_infor_tag error time_work" name="time_ketthuc">
                            </div>
                        </div>
                        <div class="tglv_cangay d_flex fl_row al_ct gap10">
                            <input type="checkbox" class="img20 tglv_cangay_input" name="checkbox_time">
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data == "") {
                            ...
                            $('.disable_chung').prop('disabled', false);
                        }
                    }
                })
            }
