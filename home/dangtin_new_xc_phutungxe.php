...
if (isset($_COOKIE['UID']) && isset($_COOKIE['UT'])) {
    $acc_id = $_COOKIE['UID'];
    $acc_type = $_COOKIE['UT'];
    $sql_dm = new db_query("SELECT `tags_id`, `ten_tags` FROM `key_tags` WHERE id_danhmuc = 39");
...
<head>
    ...
    <title>Đăng tin xe cộ phụ tùng xe</title>
...
<body>
    ...
    <section id="m_dangtin_xc_phutungxe" class="xeco">
        ...
        <form class="form-dtin-cont form_bds_chung" id="form_xeco_phutung" data="<?= $acc_id ?>" data1="<?= $acc_type ?>" data3="<?= $xacthuc_lket ?>">
                        ...
                        <div class="b6_ft1 d_flex fl_cl danhmuc_tag box_input_infor">
                            ...
                            <select id="loai_phutung" class="slect-hang  hd_height36" name="loai_phu_tung">
                                ...
                                <? foreach ($query_pt as $pt) : ?>
                                    <option value="<?= $pt['id'] ?>"><?= $pt['ten_loai'] ?></option>
                                <? endforeach ?>
                            </select>
                        </div>
                    </div>
    ...
    <script>
        $(".b11_btn_dangtin").click(function() {
            ...
            if (form_xeco_phutung.valid() === true) {
                ...
                $.ajax({
                    url: '/ajax_xeco/dangtin_xeco_phutung.php',
                    type: 'POST',
                    data: fd,
                    contentType: false,
                    processData: false,
