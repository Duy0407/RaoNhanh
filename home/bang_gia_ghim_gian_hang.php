<?
include("config.php");
$list_gia = new db_query("SELECT `bg_id`, `bg_thoigian`, `bg_dongia`, `bg_chietkhau`, `bg_thanhtien`, `bg_ttien_vat` FROM `bang_gia` WHERE `bg_type` = 1 ");
...
<head>
    ...
    <title>Bảng giá ghim gian hàng</title>
        ...
        <div class="main_bggt_content">
            ...
            <div class="main_bggt_content_noidung">
                ...
                <div class="main_bggt_content_noidung_sub">
                    <div class="main_bggt_noidung_hd">Gói dịch vụ ghim gian hàng trên Raonhanh được báo giá như sau : </div>
