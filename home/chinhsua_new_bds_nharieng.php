...
if (isset($_COOKIE['UID']) && isset($_COOKIE['UT']) && $id_nd != 0) {
    ...
    $list_tin = new db_query("SELECT `new`.`new_id`, `new_title`,`link_title`,`new_money`, `new_cate_id`, `new_city`, `new_user_id`, `new_image`,
                            ...
                            `new_ctiet_dmuc`, `new_update_time`, `datcoc`, `dc_unit`, `new_description`,`can_ban_mua`, `ten_toa_nha`,
    ...
    if (mysql_num_rows($list_tin->result) > 0) {
        ...
        // tag danh muc
        $ban = new db_query("SELECT `tags_id`, `ten_tags` FROM `key_tags` WHERE `id_danhmuc` = 29 AND type_tags = '" . $item_td['can_ban_mua'] . "' ");
...
<head>
    ...
    <title>Chỉnh sửa bất động sản nhà riêng</title>
            ...
            <div class="container_content">
                ...
                <div class="ctn_ct_box1 d_flex fl_cl w100">
                    ...
                    <div class="ctn_ct_b1_fr2 w100">
                        <div class="b1_fr2_title w100">
                            <p class="b1_fr2_title_p p_400_s16_l19 d_flex fl_row al_ct" data="29" data1="<?= $id_nd ?>">
                ...
                <div class="ctn_ct_box4 d_flex fl_cl">
                    ...
                    <div class="ctn_ct_b4_fr d_flex fl_row al_ct">
                        ...
                        <div class="ctn_ct_b4_fr2 box_input_infor">
                            ...
                            <input type="text" name="td_diachi_nha" class="td_ttin_diachi b4_fr2_input p_400_s14_l17" value="<?= $item_td['dia_chi'] ?>" data-tt="<?= $tinh_thanh ?>" data-qh="<?= $quan_huyen ?>" data-px="<?= $phuong_xa ?>" data-sn="<?= $so_nha ?>" placeholder="Địa chỉ nhà" autocomplete="off">
                        </div>
                    </div>
                </div>
                <!-- ----------------------------------------------------------------------box5--------------------------------------------------------------------- -->
                <div class="ctn_ct_box5 d_flex fl_cl">
                    ...
                    <div class="ctn_ct_b5_fr d_flex fl_row al_ct">
                        ...
                        <div class="b5_fr2">
                            <p class="b5_fr2_title p_400_s15_l18">Tên phân khu/lô</p>
                            <input type="text" name="td_tenpk_lo" class="b5_fr2_input p_400_s14_l17" value="<?= $item_td['ten_phan_khu'] ?>" placeholder="Tên phân khu/lô" autocomplete="off">
                        </div>
                    </div>
                ...
                <div class="ctn_ct_box6 d_flex fl_cl">
                    ...
                    <div class="ctn_ct_b6_ft d_flex fl_row al_ct">
                        <div class="b6_ft1 d_flex fl_cl">
                            <p class="b6_ft1_title p_400_s15_l18">Tổng số tầng</p>
                ...
                <div class="ctn_ct_box7 d_flex fl_cl">
                    ...
                    <div class="ctn_ct_b7_fr d_flex fl_row">
                        ...
                        <div class="b7_fr2 d_flex fl_cl al_ct">
                            <p class="b7_fr2_title p_400_s15_l18">Tình trạng nội thất</p>
                ...
                <div class="ctn_ct_box8 d_flex fl_cl">
                    ...
                    <div class="ctn_ct_b8_fr d_flex fl_row">
                        <div class="b8_fr1 d_flex fl_cl box_input_infor">
                            <p class="b8_fr1_title p_400_s15_l18">Diện tích đất <span class="cl_red">*</span></p>
                        ...
                        <div class="b8_fr2 d_flex fl_cl">
                            <p class="b8_fr2_title p_400_s15_l18">Diện tích sử dụng</p>
                            <div class="b8_fr2_content d_flex fl_row jtf_spb">
                                <input name="dientichsd" type="text" class="b8_fr2_input p_400_s14_l17" value="<?= ($item_td['dientichsd'] != 0) ? $item_td['dientichsd'] : '' ?>" autocomplete="off" placeholder="Diện tích sử dụng" oninput="<?= $oninput ?>">
                    ...
                    <div class="ctn_ct_b8_ft d_flex fl_row">
                        <div class="b8_ft1 d_flex fl_cl">
                            <p class="b8_ft1_title p_400_s15_l18">Chiều dài</p>
                        ...
                        <div class="b8_ft2 d_flex fl_cl">
                            <p class="b8_ft2_title p_400_s15_l18">Chiều ngang</p>
    ...
    <script>
        ...
        $(".b11_btn_dangtin").click(function() {
            ...
            if (form_bds_nhadat.valid() === true) {
                ...
                $.ajax({
                    url: '/ajax_bds/chinhsua_bdsnharieng.php',
                    type: 'POST',
                    data: fd,
                    contentType: false,
                    processData: false,
