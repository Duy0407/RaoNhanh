...
if (isset($_COOKIE['UID']) && isset($_COOKIE['UT'])) {
    $acc_id = $_COOKIE['UID'];
    $acc_type = $_COOKIE['UT'];
    $sql_dm = new db_query("SELECT `tags_id`, `ten_tags` FROM `key_tags` WHERE id_danhmuc = 95");
...
<body>
    ...
    <section id="m_dangtin_douongthucpham" class="suckhoe douongthucpham" data="<?= date('Y-m-d', time()) ?>">
        ...
        <form class="form-dtin-cont form_bds_chung" id="form_douong" data="<?= $acc_id ?>" data1="<?= $acc_type ?>" data3="<?= $xacthuc_lket ?>">
            <div class="container_content">
                ...
                <div class="b6_loaihinh loai_dungcu d_flex fl_cl box_input_infor">
                    <p class="b6_lhinh_txt p_400_s15_l18">
                        Loại đồ uống <span class="cl_red">*</span>
                    </p>
                    <select class="slect-hang hd_height36 b6_lhinh_select loai_do_uong" name="loai_do_uong">
                        <option value="" selected disabled>Loại đồ uống</option>
    ...
    <script>
        ...
        $(".b11_btn_dangtin").click(function() {
            ...
            if (form_douong.valid() === true) {
                ...
                var xac_thuc = $("#form_douong").attr("data3");
