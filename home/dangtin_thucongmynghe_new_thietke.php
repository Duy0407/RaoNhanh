...
if (isset($_COOKIE['UID']) && isset($_COOKIE['UT'])) {
    $acc_id = $_COOKIE['UID'];
    $acc_type = $_COOKIE['UT'];
    $sql_dm = new db_query("SELECT `tags_id`, `ten_tags` FROM `key_tags` WHERE id_danhmuc = 84");
...
<head>
    ...
    <title>Đăng tin Thiết kế, Phong thủy </title>
...
<body>
    ...
    <section id="m_dangtin_thucongmynghe" class="suckhoe thucongmynghe">
        ...
        <form class="form-dtin-cont form_bds_chung" id="form_tcmn_thietkephongthuy" data="<?= $acc_id ?>" data1="<?= $acc_type ?>" data3="<?= $xacthuc_lket ?>">
    ...
    <script>
        $(".b11_btn_dangtin").click(function() {
            ...
            if (form_tcmn_thietkephongthuy.valid() === true) {
                ...
                $.ajax({
                    url: '/ajax_tcquatang/dtin_thietke.php',
                    type: 'POST',
                    data: fd,
                    contentType: false,
                    processData: false,
