            ...
            <div class="tindang-container">
                ...
                <div class="tindang-content-cont hd-disflex">
                    ...
                    <div class="tindang-col-right" data="<?= $id_cs ?>">
                        <form class="form-dtin-cont" id="form_book" data="<?= $us_id ?>" data1="<?= $us_type ?>">
                            <div class="row-tin-dang danhmuc_tt">
                                <p class="font-dam hd_font15-17">Danh mục sản phẩm <span class="color_red">*</span></p>
                                <input type="text" class="dmuc-spham" readonly name="san-pham-laptop" data="<?= $id_dm ?>" placeholder="Dịch vụ - Giải trí >> Sách">
                            </div>
                            ...
                            <div class="row-tin-dang cont-btn-sb hd-disflex">
                                ...
                                <button type="button" class="btn-submit td-dang-tin dt_book hd_cspointer font-bold">ĐĂNG TIN</button>
                            </div>
                        </form>
                    </div>
                </div>
    ...
    <script>
        $(".dt_book").click(function() {
            ...
            if (form_book.valid() === true) {
                ...
                $.ajax({
                    type: 'POST',
                    url: '/ajax_dvgiaitri/csua_sach.php',
                    data: fd,
                    processData: false,
                    contentType: false,
