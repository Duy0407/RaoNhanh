...
if (isset($_COOKIE['UID']) && isset($_COOKIE['UT'])) {
    ...
    $sql_dm = new db_query("SELECT `tags_id`, `ten_tags` FROM `key_tags` WHERE id_danhmuc = 10");
...
<head>
    ...
    <title>Đăng tin xe cộ ô tô</title>
...
<body>
    ...
    <section id="m_dangtin_xc_oto" class="xeco">
        ...
        <form class="form-dtin-cont form_bds_chung" id="form_xeco_car" data="<?= $acc_id ?>" data1="<?= $acc_type ?>" data3="<?= $xacthuc_lket ?>">
                ...
                <div class="ctn_ct_box6 d_flex fl_cl">
                            ...
                            <div class="xc_nam_xs">
                                <select class="slect-hang  hd_height36" name="nam_san_xuat">
                                    ...
                                    <? foreach ($db_nsanxuat as $rows) : ?>
                                        <option value="<?= $rows['id'] ?>"><?= $rows['nam_san_xuat'] ?></option>
                                    <? endforeach ?>
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="ctn_ct_b6_hs d_flex fl_cl box_input_infor">
                        ...
                        <div class="b6_hs_fr d_flex fl_row">
                            <div class="b6_hs_child b6_hs_td d_flex fl_row al_ct ">
                                <input type="radio" name="hop_so" value="1" class="img20 cursor_Pt b6_hs_td_input b6_hs_input">
                                <p class="b6_hs_td_text pdl_10">Tự động</p>
                            </div>
                            <div class="b6_hs_child b6_hs_san d_flex fl_row al_ct ">
                                <input type="radio" name="hop_so" value="2" class="img20 cursor_Pt b6_hs_san_input b6_hs_input">
                                <p class="b6_hs_san_text pdl_10">Số sàn</p>
                            </div>
                            <div class="b6_hs_child b6_hs_btd d_flex fl_row al_ct ">
                                <input type="radio" name="hop_so" value="3" class="img20 cursor_Pt b6_hs_btd_input b6_hs_input">
                    ...
                    <div class="ctn_ct_b6_nl d_flex fl_cl box_input_infor">
                        ...
                        <div class="b6_nl_fr d_flex fl_row">
                            <div class="b6_nl_child b6_nl_xang d_flex fl_row al_ct ">
                                <input type="radio" name="nhien_lieu" value="1" class="img20 cursor_Pt b6_nl_xang_input b6_nl_input">
                                <p class="b6_nl_xang_text pdl_10">Xăng</p>
                            </div>
                            <div class="b6_nl_child b6_nl_dau d_flex fl_row al_ct ">
                                <input type="radio" name="nhien_lieu" value="2" class="img20 cursor_Pt b6_nl_dau_input b6_nl_input">
                                <p class="b6_nl_dau_text pdl_10">Dầu</p>
                            </div>
                            <div class="b6_nl_child b6_nl_hybrid d_flex fl_row al_ct ">
                                <input type="radio" name="nhien_lieu" value="3" class="img20 cursor_Pt b6_nl_hybrid_input b6_nl_input">
                                <p class="b6_nl_hybrid_text pdl_10">Động cơ Hybrid</p>
                            </div>
                            <div class="b6_nl_child b6_nl_dien d_flex fl_row al_ct ">
                                <input type="radio" name="nhien_lieu" value="4" class="img20 cursor_Pt b6_nl_dien_input b6_nl_input">
                        ...
                        <div class="b6_scms_socho d_flex fl_cl">
                            ...
                            <select class="b6_scms_socho_select slect-hang hd_height36" name="so_cho">
                                ...
                                <? foreach ($db_soluong as $sc) {
                                    if ($sc['id_parents'] == 10) {
                                ?>
                                        <option value="<?= $sc['id'] ?>"><?= $sc['so_luong'] ?></option>
                                <? }
                                } ?>
                            </select>
                        </div>
                    ...
                    <div class="ctn_ct_b6_bs">
                        <div class="b6_bs_biensoxe">
                            ...
                            <input type="text" autocomplete="off" name="td_bien_soxe" class="b6_bs_biensoxe_select hd_height36" placeholder="Biển số xe" oninput="">
                        </div>
                    </div>
                    <div class="ctn_ct_b6_tinhtrang d_flex fl_cl">
                        ...
                        <div class="b6_tinhtrang_fr d_flex fl_row">
                            <div class="b6_tinhtrang_cu d_flex fl_row box_input_infor">
                            ...
                            <div class="b6_tinhtrang_moi d_flex fl_row box_input_infor">
                    ...
                    <div class="ctn_ct_b6_sokmdadi">
                        <div class="b6_sokmdadi d_flex fl_cl flex_start box_input_infor">
                            ...
                            <input type="text" autocomplete="off" class="b6_sokmdadi_input" name="km_di" onkeydown="javascript: return ['Backspace','Delete','ArrowLeft','ArrowRight'].includes(event.code) ? true : !isNaN(Number(event.key)) && event.code!=='Space'" placeholder="Số Km đã đi">
                        </div>
                    </div>
                </div>
                <!-- ---------------------------------------------------------------------Thong tin ban hang------------------------------------------------------------------------- -->
    ...
    <script>
        $(".b11_btn_dangtin").click(function() {
            ...
            if (form_xeco_car.valid() === true) {
                ...
                $.ajax({
                    url: '/ajax_xeco/dangtin_xeco_oto.php',
                    type: 'POST',
                    data: fd,
                    contentType: false,
                    processData: false,
