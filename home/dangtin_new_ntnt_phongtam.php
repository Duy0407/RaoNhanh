...
if (isset($_COOKIE['UID']) && isset($_COOKIE['UT'])) {
   ...
   $qr_loai = new db_query("SELECT `id`, `ten_loai` FROM `loai_chung` WHERE `id_danhmuc` = $id ");
} else {
   header('Location: /');
}
?>
            ...
            <div class="b6_nl_title d_flex fl_cl">
               <div class="d_flex fl_row fl_st w_100">
                  <div class="d_flex fl_cl box_input_infor w_100">
                     ...
                     <select class="b6_fr1_select slect-hang hd_height36 loai_spham" name="loai_spham" data="<?= $id ?>">
   ...
   <script type="text/javascript">
      ...
      $(".b11_btn_dangtin").click(function() {
         ...
         if (form_pc.valid() === true) {
            ...
            $.ajax({
               type: 'POST',
               url: '/ajax_noithat_ngoaithat/dtin_phongtam.php',
               data: fd,
               processData: false,
               contentType: false,
               success: function(data) {
