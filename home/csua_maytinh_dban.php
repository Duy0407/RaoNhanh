                ...
                <div class="tindang-col-right" data="<?= $id_cs ?>">
                    <form class="form-dtin-cont" id="form_dt_pc" data="<?= $us_id ?>" data1="<?= $us_type ?>">
                        <div class="row-tin-dang-dau">
                            ...
                            <input type="text" class="dmuc-spham" readonly name="dmuc_spham_mtinh" data="<?= $id_dm ?>" placeholder="Đồ điện tử >> Máy tính để bàn">
                        </div>
                        <div class="row-tin-dang box_input_infor">
                            <p class="font-dam hd_font15-17">Tiêu đề <span class="color_red">*</span></p>
                            <input class="input_infor_tag tieu-de-dang-tin error" type="text" name="tieude_pc" value="<?= $row_tt['new_title'] ?>" placeholder="Nhập tiêu đề" autocomplete="off">
                        </div>
                        ...
                        <div class="row-tin-dang box_input_infor">
                            ...
                            <textarea name="mota" class="texa-mo-ta font-14-16 input_infor_tag error" placeholder="Nhập mô tả"><?= $row_tt['new_description'] ?></textarea>
                        </div>
                        <div class="box_input_infor">
