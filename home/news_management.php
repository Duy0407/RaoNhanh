...
if (isset($_COOKIE['UID']) && isset($_COOKIE['UT'])) {
    ...
    if ($type_user == 1) {
        ...
        // end phan trang
        // tổng tất cả tin bán
        $all_tin = new db_query("SELECT `new_id`, `new_title`, `link_title`, `new_cate_id`, `da_ban`,`sluong_daban`,`new_active` ,`new_money`, `new_unit`, `new_image`, `new_create_time`, `dia_chi`,
                    `chotang_mphi`, `new_pin_cate`,`tgian_ban` ,`new_pin_home`, `new_day_tin`,tong_sluong FROM `new` WHERE `new_type` = $usertype AND `new_user_id` = $id_user
        ...
        // TIN DA AN
        $tongtindaan = new db_query("SELECT new_id FROM `new` WHERE `new_type` = $usertype AND `new_user_id` = $id_user AND `da_ban` = 0 AND `new_buy_sell` = 2
        AND `new_cate_id` != 120 AND `new_cate_id` != 121  AND new_active = 0 ");
        $result_tongtindaan = mysql_num_rows($tongtindaan->result);
        $showtin_daan = mysql_fetch_assoc($tongtindaan->result);
        //
...
<body>
    ...
    <section class="news_managenment_post d_flex tca_tdang_cnhan">
        ...
        <div class="box-right">
            ...
            <div class="box_rightdf" data="<?= $id_user ?>" data2="<?= $type_user ?>" id="m_quanlytin_tct">
                            ...
                            <div class="chu">
                                <div class="m_box_chu d_flex fl_row w100">
                                    <div class="anh anh_qltin_df">
                                        ...
                                        <? if ($showtin_nguoiban['da_ban'] == 0 && $xacthuc_lket == 1) { ?>
                                            <!-- đang ghim -->
                                            ...
                                            <? } ?>
                                            <!-- het hang -->
                                            <? if ($showtin_nguoiban['tong_sluong'] == 0) { ?>
                                                <p class="hethang_img">Hết hàng</p>
                                            <? } ?>
                                            <!-- het hang -->
                                            <? if ($showtin_nguoiban['new_active'] == 0) { ?>
                                                <p class="dangan_img">Tin đang ẩn</p>
                                            <? } ?>
                                        <? } else if ($showtin_nguoiban['da_ban'] == 0 && $xacthuc_lket == 0) { ?>
                                            <!-- đang ghim -->
                                            <? if ($showtin_nguoiban['new_pin_home'] != 0 || $showtin_nguoiban['new_pin_cate'] != 0 || $showtin_nguoiban['new_day_tin'] != "") { ?>
                                                <p class="text-main-content-ghim">ĐANG GHIM</p>
                                            <? } ?>
                                    ...
                                    <div class="m_box-txttilte d_flex fl_cl w100">
                                        <div class="text-tilte d_flex fl_row al_ct jtf_spb">
                                            <a href="/<?= replaceTitle($showtin_nguoiban['link_title']) ?>-c<?= $id_tin ?>.html">
                                                <div class="text-title-qlt text_ellipsis pr_10"><?= $showtin_nguoiban['new_title'] ?></div>
                                            </a>
                                            <? if ( $showtin_nguoiban['da_ban'] == 0 && $showtin_nguoiban['new_active'] != 0) { ?>
                                                <div class="m_refresh_qltb d_flex fl_row al_ct cursor_Pt" data="<?= $id_tin ?>" data1="<?= $showtin_nguoiban['new_create_time'] ?>">
                                            ...
                                            <div class="menu-bot">
                                                ...
                                                <div class="m_tieuthu_qlt d_flex fl_row jtf_spb">
                                                    <div class="m_money_qlt">
                                                        <? if ($showtin_nguoiban['chotang_mphi'] == 1) { ?>
                                                            <div class="money-qlt">Cho tặng miễn phí</div>
                                                        <? } else if ($showtin_nguoiban['new_money'] > 0) { ?>
                                                            <div class="money-qlt d_flex fl_row al_ct">
                                                                <div class="pdr_5">
                                                                    <?= number_format($showtin_nguoiban['new_money']) ?> <?= $arr_dvtien[$showtin_nguoiban['new_unit']] ?>
                                                                </div>
                                                                <? if ($xacthuc_lket == 1) { ?>
                                                    ...
                                                    <? if ($xacthuc_lket == 1) { ?>
                                                        <!-- <div class="m_amount_qlt d_flex fl_row al_ct">
                                                            ...
                                                            <p class="m_amount_qlt_text pdl_5 pdr_5 p_400_s14_l17">
                                                                Số lượng: <?= $showtin_nguoiban['tong_sluong'] ?>
                                                            </p>
                                                        ...
                                                        <div class="m_sold_qlt d_flex fl_row al_ct">
                                                            ...
                                                            <p class="m_sold_qlt_text pdl_5 p_400_s14_l17">
                                                                Đã bán: <?= $showtin_nguoiban['sluong_daban'] ?>
                                                            </p>
                                                        </div> -->
                                                    <? } ?>
                                                </div>
                                    ...
                                    <!-- <div class="btn_qlt_df btn_qlt_df_chung btn_qlt_df_dbl hid_1200">
                                        <span class="border-dbl">
                                            <div class="btn-dbl btn_dbldf cus_poi d_flex fl_row al_ct" data="<?= $id_tin ?>">
                                                <img src="/images/m_raonhanh_imgnew/eye.png" alt="" class="m_antin_qlt img20">
                                ...
                                <? } else { ?>
                                    <div class="btn_div_3cham_bao_nut btn_qlt_df btn_qlt_df_chung btn_qlt_df_3 hid_1200">
                                        <!-- <span class="border-ddldb btn_qlt_df_3_d">
                                                <img src="/images/m_raonhanh_imgnew/eye-slash.png" alt="" class="m_antin_qlt img20">
                                        ...
                                        <? if ($xacthuc_lket == 0 && $showtin_nguoiban['new_active'] == 1) { ?>
                                            <span class="m_daban_cxtlk cursor_Pt df_daban" data="<?= $id_tin ?>" data1="<?= $showtin_nguoiban['da_ban'] ?>">
                                        ...
                                        <? if ($showtin_nguoiban['new_pin_home'] == 0 && $showtin_nguoiban['new_pin_cate'] == 0 && $showtin_nguoiban['new_day_tin'] == "") { ?>
                                            <? if ($xacthuc_lket == 1  && $showtin_nguoiban['new_active'] == 0) { ?>
                                                <span class="boder_bnh_cn border-gt btn_qlt_df_3_d <?= ($xacthuc_lket == 1 && $showtin_nguoiban['new_active'] == 0) ? "op0_5" : "aaaa" ?>">
                                                    <div class="btn-gt btn_bnh_cn cus_poi text-gt" data="<?= $id_tin ?>">
                                                        ...
                                                        <span class="txt_bnh_cn text-gt" data="<?= $id_tin ?>">Bán nhanh hơn</span>
                                                    </div>
                                                </span>
                                            <? } else if ($xacthuc_lket == 1  && $showtin_nguoiban['new_active'] == 1) { ?>
                                            ...
                                            <? } else if ($xacthuc_lket == 0  && $showtin_nguoiban['new_active'] == 0) { ?>
