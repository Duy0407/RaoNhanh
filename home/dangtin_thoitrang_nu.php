                ...
                <div class="tindang-col-right">
                    <form class="form-dtin-cont" id="form_thoitrang_nu" data="<?= $us_id ?>" data1="<?= $us_type ?>">
                        <div class="row-tin-dang danhmuc_tt">
                            ...
                            <input type="text" class="dmuc-spham" readonly name="san-pham-laptop" data="<?= $id ?>" placeholder="Thời trang >> Thời trang nữ">
                        </div>
                            ...
                            <div class="d_themdiv_gia_7_8">
                                <div class="input-gia-cont d_8-7_tclass3">
                                    <div class="box_input_infor">
                                        <input class="input_infor_tag error" type="text" name="td_gia_spham" id="gia-ban-sp" onkeyup="format_gtri(this)" autocomplete="off" oninput="<?= $oninput; ?>">
                                    </div>
                        ...
                        <div class="row-tin-dang-btn cont-btn-sb hd-disflex hide-480-mobile">
                            ...
                            <button type="button" id="xoa_tddang_tin" class="btn-submit td-dang-tin thoitrang_nu hd_cspointer font-bold">ĐĂNG TIN</button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        $(".td-dang-tin").click(function() {
            ...
            if (form_thoitrang_nu.valid() === true) {
                ...
                $.ajax({
                    ...
                    contentType: false,
                    beforeSend: function() {
                        $('.thoitrang_nu').prop('disabled', true);
                    },
                    success: function(data) {
                        if (data == "") {
                            ...
                            $('.thoitrang_nu').prop('disabled', false);
                        }
                    }
                })
            }
