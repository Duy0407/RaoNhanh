...
<head>
    ...
    <title>Đăng tin thiết bị giáo dục</title>
                ...
                <div class="tindang-col-right">
                    <form class="form-dtin-cont" id="form_tbgiaoduc" data="<?= $us_id ?>" data1="<?= $us_type ?>">
                        <div class="row-tin-dang danhmuc_tt">
                            ...
                            <input type="text" class="dmuc-spham" readonly name="san-pham-laptop" data="<?= $id ?>" placeholder="Đồ dùng văn phòng, công nông nghiệp  >>  Thiết bị giáo dục">
                        </div>
                        ...
                        <div class="row-tin-dang cont-btn-sb hd-disflex hide-480-mobile">
                            ...
                            <button type="button" id="xoa_tddang_tin" class="btn-submit td-dang-tin tb_giaoduc hd_cspointer font-bold">ĐĂNG TIN</button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <script type="text/javascript">
        $(".td-dang-tin").click(function() {
            ...
            if (form_tbgiaoduc.valid() === true) {
                ...
                $.ajax({
                    type: 'POST',
                    url: '/ajax_ddcnn/dtin_tbigiaoduc.php',
                    data: fd,
                    processData: false,
                    contentType: false,
                    beforeSend: function() {
                        $('.tb_giaoduc').prop('disabled', true);
                    },
                    success: function(data) {
                        if (data == "") {
                            ...
                            $('.tb_giaoduc').prop('disabled', false);
                        }
                    }
                })
            }
