...
$urlcano = "https://raonhanh365.vn/tim-viec/".$ali."-p".$row['new_id'].".html";
...
<head>
    ...
    <link rel="canonical" href="https://raonhanh365.vn/tim-viec/<?= replaceTitle($row['new_title']) ?>-p<?= $row['new_id'] ?>.html" />
        ...
        <div class="row">
            ...
            <div class="right">
                <div class="vllq">
                    ...
                    ?>
                    <div class="group">
                        <div class="vieclam"><h3 style="font-size: 16px;"><a href="/tim-viec/<?= replaceTitle($rownew['new_title']) ?>-p<?= $rownew['new_id'] ?>.html"><?= $rownew['new_title']?></a></h3></div>
