...
if (isset($_COOKIE['UID']) && isset($_COOKIE['UT'])) {
    $acc_id = $_COOKIE['UID'];
    $acc_type = $_COOKIE['UT'];
    $sql_dm = new db_query("SELECT `tags_id`, `ten_tags` FROM `key_tags` WHERE id_danhmuc = 70");
...
<body>
    ...
    <section id="m_dangtin_dichvu" class="suckhoe dichvugiaitri">
        ...
        <form class="form-dtin-cont form_bds_chung" id="form_sothichkhac" data="<?= $acc_id ?>" data1="<?= $acc_type ?>" data3="<?= $xacthuc_lket ?>">
