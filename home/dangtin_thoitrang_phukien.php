...
<head>
    ...
    <title>Đăng tin thời trang phụ kiện </title>
...
<body>
        ...
        <div class="tindang-container">
            ...
            <div class="tindang-content-cont hd-disflex">
                ...
                <div class="tindang-col-right">
                    <form class="form-dtin-cont" id="form_thoitrang_pk" data="<?= $us_id ?>" data1="<?= $us_type ?>">
                        <div class="row-tin-dang danhmuc_tt">
                            <p class="font-dam hd_font15-17">Danh mục sản phẩm <span class="color_red">*</span></p>
                            <input type="text" class="dmuc-spham" readonly name="san-pham-laptop" data="<?= $id ?>" placeholder="Thời trang >> Phụ kiện">
                        </div>
                        ...
                        <div class="row-tin-dang-btn cont-btn-sb hd-disflex hide-480-mobile">
                            ...
                            <button type="button" id="xoa_tddang_tin" class="btn-submit td-dang-tin pk_thoitrang hd_cspointer font-bold">ĐĂNG TIN</button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <script type="text/javascript">
        $(".td-dang-tin").click(function() {
            var form_thoitrang_pk = $("#form_thoitrang_pk");
            form_thoitrang_pk.validate({
            ...
            if (form_thoitrang_pk.valid() === false) {
            ...
            if (form_thoitrang_pk.valid() === true) {
                ...
                $.ajax({
                    type: 'POST',
                    url: '/ajax_thoitrang/dtin_phukien.php',
                    data: fd,
                    processData: false,
                    contentType: false,
                    beforeSend: function() {
                        $('.pk_thoitrang').prop('disabled', true);
                    },
                    success: function(data) {
                        if (data == "") {
                            ...
                            $('.pk_thoitrang').prop('disabled', false);
                        }
                    }
                })
            }
