        ...
        <div class="tindang-container">
            ...
            <div class="tindang-content-cont hd-disflex">
                ...
                <div class="tindang-col-right">
                    <form class="form-dtin-cont" id="form_xeco_moto" data="<?= $acc_id ?>" data1="<?= $acc_type ?>">
                        <div class="row-tin-dang danhmuc_tt">
                            <p class="font-dam hd_font15-17">Danh mục sản phẩm <span class="color_red">*</span></p>
                            <input type="text" class="dmuc-spham" data="9" readonly name="san-pham-laptop" placeholder="Xe cộ  >>  Xe máy">
                        </div>
                        ...
                        <div class="row-tin-dang">
                            ...
                            <select class="slect-hang  hd_height36" name="dung_tich_xe">
                                ...
                                <? foreach ($result_dt as $dt) : ?>
                                    <option value="<?= $dt['id_dl'] ?>"><?= $dt['ten_dl'] ?></option>
                                <? endforeach ?>
                            </select>
                        </div>
                        <div class="row-tin-dang">
                        ...
                        <div class="box_input_infor row-tin-dang">
                            ...
                            <select class="slect-chitiet_dm hd_height36" style="width:100%" name="chitiet_dm">
                                ...
                                <?
                                $sql_dm = new db_query("SELECT `tags_id`, `ten_tags` FROM `key_tags` WHERE id_danhmuc = 9");
                        ...
                        <div class="row-tin-dang cont-btn-sb hd-disflex">
                            ...
                            <button type="button" id="xoa_tddang_tin" class="btn-submit xe_may td-dang-tin hd_cspointer font-bold">ĐĂNG TIN</button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    $(".td-dang-tin").click(function() {
        ...
        form_xeco_moto.validate({
            ...
            messages: {
                ...
                dongmay: "Vui lòng không bỏ trống trường này",
        ...
        if (form_xeco_moto.valid() === true) {
            ...
            $.ajax({
                url: '/ajax_xeco/dangtin_xeco_xemay.php',
                type: 'POST',
                data: fd,
                contentType: false,
                processData: false,
                beforeSend: function() {
                    $('.xe_may').prop('disabled', true);
                },
