...
if (isset($_COOKIE['UID']) && isset($_COOKIE['UT']) && $id_nd != 0 && $id_dm != 0) {
    ...
    if (mysql_num_rows($list_tin->result) > 0) {
        ...
        // tag danh muc
        $ban = new db_query("SELECT `tags_id`, `ten_tags` FROM `key_tags` WHERE `id_danhmuc` = 117 AND type_tags = '" . $item_td['can_ban_mua'] . "' ");
...
<head>
    ...
    <title>Chỉnh sửa Công Nông Nghiệp </title>
...
<body>
    ...
    <section id="m_dangtin_vanphongcnn" class="suckhoe vanphongcnn">
        ...
        <form class="form-dtin-cont form_bds_chung" id="form_congnongnghiep" data="<?= $acc_id ?>" data1="<?= $acc_type ?>" data2="<?= $id_nd ?>">
    ...
    <script>
        $(".b11_btn_chinhsua").click(function() {
            ...
            form_congnongnghiep.validate({
                ...
                messages: {
                    tieu_de: {
                        ...
                        minlength: "Nhập ít nhất 40 ký tự",
            ...
            if (form_congnongnghiep.valid() === true) {
                ...
                var id_nd = $("#form_congnongnghiep").attr("data2");
                ...
                $.ajax({
                    type: 'POST',
                    url: '/ajax_ddcnn/csua_gnuoitrong.php',
                    data: fd,
                    processData: false,
                    contentType: false,
