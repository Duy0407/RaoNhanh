...
if (isset($_COOKIE['UID']) && isset($_COOKIE['UT']) && $id_cs != 0 && $id_dm != 0) {
    ...
    if (mysql_num_rows($check_tind->result) > 0) {
        $list_tt = new db_query("SELECT n.`new_title`, n.`new_money`, n.`gia_kt`, n.`new_cate_id`, n.`new_city`, n.`new_image`, n.`new_unit`, n.`new_tinhtrang`,
                                ...
                                d.`new_description`, d.`loai_chung`, d.`han_su_dung`, n.`new_phone`, n.`new_email`
                ...
                <div class="tindang-col-right" data="<?= $id_cs ?>" data1="<?= $hom_nay ?>">
                    <form class="form-dtin-cont" id="form_thucpham" data="<?= $us_id ?>" data1="<?= $us_type ?>">
                        <div class="row-tin-dang danhmuc_tt">
                            ...
                            <input type="text" class="dmuc-spham" readonly name="dmuc_thuc_pham" data="<?= $id_dm ?>" value="Thực phẩm đồ uống >> Thực phẩm">
                        </div>
                        ...
                        <div class="row-tin-dang them_class1 box_input_infor">
                            ...
                            <select class="slect-hang hd_height36 loai_thucpham" name="loai_tp" onchange="tags_tdoi(this)">
                        ...
                        <div class="row-tin-dang cont-btn-sb hd-disflex hide-480-mobile">
                            ...
                            <button type="button" class="btn-submit td-dang-tin thuc_pham hd_cspointer font-bold">ĐĂNG TIN</button>
                        </div>
                    </form>
                </div>
            </div>
