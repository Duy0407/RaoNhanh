...
<head>
    ...
    <title>Đăng tin thú cưng khác</title>
        ...
        <div class="tindang-container">
            ...
            <div class="tindang-content-cont hd-disflex">
                ...
                <div class="tindang-col-right">
                    <form class="form-dtin-cont" id="form_thucung_khac" data="<?= $acc_id ?>" data1="<?= $acc_type ?>">
                        <div class="row-tin-dang danhmuc_tt">
                            <p class="font-dam hd_font15-17">Danh mục sản phẩm <span class="color_red">*</span></p>
                            <input type="text" class="dmuc-spham" data="115" readonly name="san-pham-laptop" placeholder="Thú cưng >> Thú cưng khác">
                        </div>
                        ...
                        <div class="row-tin-dang box_input_infor">
                            ...
                            <input class="input_infor_tag error" type="text" name="do_tuoi" placeholder="Nhập độ tuổi">
                        </div>
                        <div class="d_flex j_between box_input_infor">
                            <div class="row-tin-dang rowflex2">
                                ...
                                <input class="input_infor_tag error" type="text" name="kichco" placeholder="Nhập kích cỡ">
                            </div>
                            <div class="row-tin-dang rowflex2">
                        ...
                        <div class="box_input_infor mt20">
                            ...
                            <select class="slect-chitiet_dm hd_height36" style="width:100%" name="chitiet_dm">
                                ...
                                <?
                                $sql_dm = new db_query("SELECT `tags_id`, `ten_tags` FROM `key_tags` WHERE id_danhmuc = 115 AND id_parent = 0");
                        ...
                        <div class="row-tin-dang cont-btn-sb hd-disflex hide-480-mobile">
                            ...
                            <button type="button" id="xoa_tddang_tin" class="btn-submit td-dang-tin thucung_khac hd_cspointer font-bold">ĐĂNG TIN</button>
                        </div>
                    </form>
                </div>
            </div>
...
<script>
    $(".td-dang-tin").click(function() {
        ...
        if (form_thucung_khac.valid() === true) {
            ...
            $.ajax({
                url: '/ajax_thucung/dangtin_thucung_khac.php',
                type: 'POST',
                data: fd,
                contentType: false,
                processData: false,
                beforeSend: function() {
                    $('.thucung_khac').prop('disabled', true);
                },
                success: function(data) {
                    if (data == "") {
                        ...
                        $('.thucung_khac').prop('disabled', false);
                    }
                }
            })
        }
