...
if (isset($_COOKIE['UID']) && isset($_COOKIE['UT'])) {
    $acc_id = $_COOKIE['UID'];
    $acc_type = $_COOKIE['UT'];
    $sql_dm = new db_query("SELECT `tags_id`, `ten_tags` FROM `key_tags` WHERE id_danhmuc = 117");
...
<head>
    ...
    <title>Đăng tin Công Nông Nghiệp </title>
...
<body>
    ...
    <section id="m_dangtin_vanphongcnn" class="suckhoe vanphongcnn">
        ...
        <form class="form-dtin-cont form_bds_chung" id="form_congnongnghiep" data="<?= $acc_id ?>" data1="<?= $acc_type ?>" data3="<?= $xacthuc_lket ?>">
                ...
                <div class="ctn_ct_box1 d_flex fl_cl w100">
                    ...
                    <div class="ctn_ct_b1_fr2 w100">
                        <div class="b1_fr2_title w100">
                            <p class="b1_fr2_title_p p_400_s16_l19 d_flex fl_row al_ct" data="117">
                                Đồ dùng văn phòng, công nông nghiệp <span class="d_flex fl_row al_ct pdl_5 pdr_5">
                                    <img src="/images/m_raonhanh_imgnew/double_angle.png" alt="" class="img_16">
                                </span> Công Nông Nghiệp
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="ctn_ct_b6_tinhtrang d_flex fl_cl box_input_infor">
                    ...
                    <div class="b6_tinhtrang_fr d_flex fl_row">
                        ...
                        <div class="b6_tinhtrang_cu d_flex fl_row">
                            ...
                            <p class="b6_tinhtrang_cu_text pdl_10">Cũ (Đã sửa chữa)</p>
                        </div>
                        <div class="b6_tinhtrang_cu d_flex fl_row">
                            <input type="radio" name="cu_moi" value="3" class="img20 cursor_Pt b6_tinhtrang_cu_input b6_tinhtrang_chung">
                            <p class="b6_tinhtrang_cu_text pdl_10">Cũ (Chưa sửa chữa)</p>
                        </div>
                    </div>
                </div>
    ...
    <script>
        $(".b11_btn_dangtin").click(function() {
            var form_congnongnghiep = $("#form_congnongnghiep");
            form_congnongnghiep.validate({
            ...
            if (form_congnongnghiep.valid() === false) {
            ...
            if (form_congnongnghiep.valid() === true) {
                $("#xoa_tddang_tin").removeClass("b11_btn_dangtin");
                var user_id = $("#form_congnongnghiep").attr("data");
                var user_type = $("#form_congnongnghiep").attr("data1");
                ...
                var xac_thuc = $("#form_congnongnghiep").attr("data3");
                ...
                $.ajax({
                    url: '/ajax_ddcnn/dtin_gnuoitrong.php',
                    type: 'POST',
                    data: fd,
                    contentType: false,
                    processData: false,
    ...
    <script>
        ...
        function xem_trc_tin() {
            var form_congnongnghiep = $(".form-dtin-cont");
            form_congnongnghiep.validate({
                errorPlacement: function(error, element) {
                    error.appendTo(element.parents(".box_input_infor"));
                    error.wrap("<span class='error'>");
