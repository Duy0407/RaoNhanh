            ...
            <div class="container_content">
                ...
                <div class="d_flex fl_cl">
                    <div class="ctn_ct_b6_fr box_input_infor w_100">
                        ...
                        <input type="text" name="tieu_de" class="b3_fr1_input p_400_s14_l17" placeholder="Nhập tiêu đề" autocomplete="off">
                    </div>
                    <div class="ctn_ct_b6_fr d_flex fl_row fl_st w_100">
                        <div class="d_flex fl_cl box_input_infor w_100">
                            ...
                            <input type="text" name="diachi_lv" class="td_ttin_diachi b3_fr1_input p_400_s14_l17" placeholder="Địa chỉ" readonly autocomplete="off">
                        </div>
                    </div>
                    ...
                    <div class="ctn_ct_b6_fr d_flex fl_row fl_st w_100">
                        <div class="b6_fr2 d_flex fl_cl box_input_infor">
                            ...
                            <input type="text" name="tuoi" class="b3_fr1_input p_400_s14_l17" placeholder="Tuổi" autocomplete="off">
                        </div>
                    ...
                    <div class="ctn_ct_b6_fr d_flex fl_row fl_st w_100">
                        <div class="d_flex fl_cl box_input_infor w_100">
                            ...
                            <input type="text" name="chung_chi" class="b3_fr1_input p_400_s14_l17" placeholder="Chứng chỉ" autocomplete="off">
                        </div>
                    </div>
                    <div class="ctn_ct_b6_fr box_input_infor w_100">
                        <p class="b3_fr3_title p_400_s15_l18">Kỹ năng</p>
                        <textarea rows="6" placeholder="Nhập kỹ năng" class="b3_fr3_txt p_400_s14_l17" maxlength="10000" name="ky_nang"></textarea>
                    </div>
