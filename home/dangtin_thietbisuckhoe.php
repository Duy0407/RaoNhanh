...
if (isset($_COOKIE['UID']) && isset($_COOKIE['UT'])) {
    ...
    $query = new db_query("SELECT `id`, `name` FROM `nhom_sanpham` WHERE `id_danhmuc` = $id ");
...
<head>
    ...
    <title>Đăng tin thiết bị sức khỏe</title>
        ...
        <div class="tindang-container">
            ...
            <div class="tindang-content-cont hd-disflex">
                ...
                <div class="tindang-col-right">
                    <form class="form-dtin-cont" id="form_tb_suckhoe">
                        <div class="row-tin-dang danhmuc_tt">
                            <p class="font-dam hd_font15-17">Danh mục sản phẩm <span class="color_red">*</span></p>
                            <input data="<?= $id ?>" type="text" class="dmuc-spham" readonly name="san-pham-laptop" placeholder="Đồ gia dụng  >>  Thiết bị sức khoẻ">
                        </div>
                        ...
                        <div class="row-tin-dang cont-btn-sb hd-disflex hide-480-mobile">
                            ...
                            <button type="button" id="xoa_tddang_tin" class="btn-submit td-dang-tin tb_suckhoe hd_cspointer font-bold">ĐĂNG TIN</button>
                        </div>
                    </form>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    $(".td-dang-tin").click(function() {
        var form_tb_suckhoe = $("#form_tb_suckhoe");
        form_tb_suckhoe.validate({
        ...
        if (form_tb_suckhoe.valid() === false) {
        ...
        if (form_tb_suckhoe.valid() === true) {
            ...
            $.ajax({
                type: 'POST',
                url: '/ajax_dogiadung/dtin_thietbisuckhoe.php',
                data: fd,
                processData: false,
                contentType: false,
                beforeSend: function() {
                    $('.tb_suckhoe').prop('disabled', true);
                },
                success: function(data) {
                    if (data == "") {
                        ...
                        $('.tb_suckhoe').prop('disabled', false);
                    }
                }
            })
        }
