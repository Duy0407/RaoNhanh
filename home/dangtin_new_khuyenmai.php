...
if (isset($_COOKIE['UID']) && isset($_COOKIE['UT'])) {
    ...
    $acc_type = $_COOKIE['UT'];
    $id_cat_parent = 209;
    $sql_dm = new db_query("SELECT `tags_id`, `ten_tags` FROM `key_tags` WHERE id_danhmuc = 24");
...
<head>
    ...
    <title>Đăng tin Khuyến Mãi </title>
...
<body>
    ...
    <!-- content -->
    <section id="m_dangtin_khuyenmai" class="suckhoe khuyenmai">
        <div class="container_title">
            <p class="ctn_tt_p p_600_s24_l28">Đăng tin</p>
        </div>
        <form class="form-dtin-cont form_bds_chung" id="form_khuyenmai" data="<?= $acc_id ?>" data1="<?= $acc_type ?>" data3="<?= $xacthuc_lket ?>">
                ...
                <div class="ctn_ct_box1 d_flex fl_cl w100">
                    ...
                    <div class="ctn_ct_b1_fr2 w100">
                        <div class="b1_fr2_title w100">
                            <p class="b1_fr2_title_p p_400_s16_l19 d_flex fl_row al_ct" data="24">
                                Khuyến Mãi
                            </p>
                        </div>
                    </div>
    ...
    <script>
        ...
        $(".b11_btn_dangtin").click(function() {
            ...
            if (form_khuyenmai.valid() === true) {
                ...
                var user_id = $("#form_khuyenmai").attr("data");
                var user_type = $("#form_khuyenmai").attr("data1");
                ...
                var xac_thuc = $("#form_khuyenmai").attr("data3");
    ...
    <script>
        ...
        function xem_trc_tin() {
            var form_khuyenmai = $(".form-dtin-cont");
            form_khuyenmai.validate({
                errorPlacement: function(error, element) {
                    error.appendTo(element.parents(".box_input_infor"));
                    error.wrap("<span class='error'>");
