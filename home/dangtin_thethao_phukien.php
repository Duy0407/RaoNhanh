...
if (isset($_COOKIE['UID']) && isset($_COOKIE['UT']) && $_GET['id'] != "") {
    $us_id = $_COOKIE['UID'];
    $us_type = $_COOKIE['UT'];
...
<head>
    ...
    <title>Đăng tin phụ kiện thể thao</title>
        ...
        <div class="tindang-container">
            ...
            <div class="tindang-content-cont hd-disflex">
                ...
                <div class="tindang-col-right">
                    <form class="form-dtin-cont fid_gia_mb" id="form_pkthethao" data="<?= $us_id ?>" data1="<?= $us_type ?>">
                        <div class="row-tin-dang danhmuc_tt">
                            <p class="font-dam hd_font15-17">Danh mục sản phẩm <span class="color_red">*</span></p>
                            <input type="text" class="dmuc-spham" readonly name="san-pham-laptop" data="<?= $id ?>" placeholder="Thể thao >> Phụ kiện thể thao">
                        </div>
                        ...
                        <div class="box_input_infor ctiet_danhmuc mt20 d_none">
                        ...
                        <div class="row-tin-dang cont-btn-sb hd-disflex">
                            ...
                            <button type="button" id="xoa_tddang_tin" class="btn-submit td-dang-tin pk_thethao hd_cspointer font-bold">ĐĂNG TIN</button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <script type="text/javascript">
        ...
        $(".td-dang-tin").click(function() {
            ...
            if (form_pkthethao.valid() === true) {
                ...
                $.ajax({
                    url: '/ajax/dangtin_thethao_pkien.php',
                    type: 'POST',
                    data: fd,
                    processData: false,
                    contentType: false,
                    beforeSend: function() {
                        $('.pk_thethao').prop('disabled', true);
                    },
                    success: function(data) {
                        if (data == "") {
                            tbao_dtin_tcong();
                            ...
                            $('.pk_thethao').prop('disabled', false);
                        }
                    }
                })
            }
