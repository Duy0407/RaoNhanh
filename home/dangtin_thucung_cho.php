...
<head>
    ...
    <title>Đăng tin thú cưng chó</title>
        ...
        <div class="tindang-container">
            ...
            <div class="tindang-content-cont hd-disflex">
                ...
                <div class="tindang-col-right">
                    <form class="form-dtin-cont" id="form_thucung_cho" data="<?= $acc_id ?>" data1="<?= $acc_type ?>">
                        <div class="row-tin-dang danhmuc_tt">
                            <p class="font-dam hd_font15-17">Danh mục sản phẩm <span class="color_red">*</span></p>
                            <input type="text" class="dmuc-spham" data="111" readonly name="san-pham-laptop" placeholder="Thú cưng >> Chó">
                        </div>
                        ...
                        <div class="row-tin-dang box_input_infor">
                            ...
                            <select class="slect-hang  hd_height36" name="giong_thucung">
                                ...
                                <? foreach ($result_cho as $cho) : ?>
                                    <option value="<?= $cho['id'] ?>"><?= $cho['giong_thucung'] ?></option>
                                <? endforeach ?>
                            </select>
                        </div>
                        <div class="row-tin-dang box_input_infor">
                        ...
                        <div class="box_input_infor mt20">
                            ...
                            <select class="slect-chitiet_dm hd_height36" style="width:100%" name="chitiet_dm">
                                ...
                                <?
                                $sql_dm = new db_query("SELECT `tags_id`, `ten_tags` FROM `key_tags` WHERE id_danhmuc = 111 AND id_parent = 0");
                        ...
                        <div class="row-tin-dang cont-btn-sb hd-disflex hide-480-mobile">
                            ...
                            <button type="button" id="xoa_tddang_tin" class="btn-submit td-dang-tin thucung_cho hd_cspointer font-bold">ĐĂNG TIN</button>
                        </div>
                    </form>
                </div>
            </div>
...
<script type="text/javascript">
    $(".td-dang-tin").click(function() {
        ...
        if (form_thucung_cho.valid() === true) {
            ...
            $.ajax({
                url: '/ajax_thucung/dangtin_thucung_cho.php',
                type: 'POST',
                data: fd,
                contentType: false,
                processData: false,
                beforeSend: function() {
                    $('.thucung_cho').prop('disabled', true);
                },
                success: function(data) {
                    if (data == "") {
                        ...
                        $('.thucung_cho').prop('disabled', false);
                    }
                }
            })
        }
