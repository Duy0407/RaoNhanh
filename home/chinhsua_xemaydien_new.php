...
if (isset($_COOKIE['UID']) && isset($_COOKIE['UT']) && $id_nd != 0) {
    ...
    if (mysql_num_rows($list_tin->result) > 0) {
        ...
        // tag danh muc
        $ban = new db_query("SELECT `tags_id`, `ten_tags` FROM `key_tags` WHERE `id_danhmuc` = 41 AND type_tags = '" . $item_td['can_ban_mua'] . "' ");
...
<head>
    ...
    <title>Chỉnh sửa xe cộ xe máy điện</title>
...
<body>
    ...
    <section id="m_dangtin_xc_xemaydien" class="xeco">
        ...
        <form class="form-dtin-cont form_bds_chung" id="form_xeco_xemaydien" data="<?= $acc_id ?>" data1="<?= $acc_type ?>" data2="<?= $id_nd ?>" data3="<?= $xacthuc_lket ?>">
                ...
                <div class="ctn_ct_box1 d_flex fl_cl w100">
                    ...
                    <div class="ctn_ct_b1_fr2 w100">
                        <div class="b1_fr2_title w100">
                            <p class="b1_fr2_title_p p_400_s16_l19 d_flex fl_row al_ct" data="41">
    ...
    <script>
        $(".b11_btn_chinhsua").click(function() {
            ...
            if (form_xeco_xemaydien.valid() === true) {
                ...
                var id_nd = $("#form_xeco_xemaydien").attr("data2");
