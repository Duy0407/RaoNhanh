...
if (isset($_COOKIE['UID']) && isset($_COOKIE['UT']) && $id_nd != 0 && $id_dm != 0) {
    ...
    if (mysql_num_rows($list_tin->result) > 0) {
        ...
        // tag danh muc
        $ban = new db_query("SELECT `tags_id`, `ten_tags` FROM `key_tags` WHERE `id_danhmuc` = 46 AND type_tags = '" . $item_td['can_ban_mua'] . "' ");
...
<head>
    ...
    <title>Chỉnh sửa Thời trang bé </title>
...
<body>
    ...
    <section id="m_dangtin_thoitrang" class="suckhoe thoitrang">
        ...
        <form class="form-dtin-cont form_bds_chung" id="form_thoitrang_be" data="<?= $acc_id ?>" data1="<?= $acc_type ?>" data2="<?= $id_nd ?>" data3="<?= $xacthuc_lket ?>">
                ...
                <div class="ctn_ct_box1 d_flex fl_cl w100">
                    ...
                    <div class="ctn_ct_b1_fr2 w100">
                        <div class="b1_fr2_title w100">
                            <p class="b1_fr2_title_p p_400_s16_l19 d_flex fl_row al_ct" data="46">
    ...
    <script>
        $(".b11_btn_chinhsua").click(function() {
            var form_thoitrang_be = $("#form_thoitrang_be");
            form_thoitrang_be.validate({
            ...
            if (form_thoitrang_be.valid() === false) {
            ...
            if (form_thoitrang_be.valid() === true) {
                var user_id = $("#form_thoitrang_be").attr("data");
                var user_type = $("#form_thoitrang_be").attr("data1");
                var id_nd = $("#form_thoitrang_be").attr("data2");
                ...
                var xac_thuc = $("#form_thoitrang_be").attr("data3");
                ...
                $.ajax({
                    type: 'POST',
                    url: '/ajax_thoitrang/csua_ttrang_be.php',
                    data: fd,
                    processData: false,
                    contentType: false,
    ...
    <script>
        ...
        function xem_trc_tin() {
            var form_thoitrang_be = $(".form-dtin-cont");
            form_thoitrang_be.validate({
                errorPlacement: function(error, element) {
                    error.appendTo(element.parents(".box_input_infor"));
                    error.wrap("<span class='error'>");
