...
<head>
    ...
    <title>Chỉnh sửa tin xe tải xe khác</title>
                ...
                <div class="tindang-col-right">
                    <form class="form-dtin-cont" id="form_xeco_xetaixekhac" data="<?= $acc_id ?>" data1="<?= $acc_type ?>" data2="<?= $id_xc ?>">
                        <div class="row-tin-dang danhmuc_tt">
                            ...
                            <input type="text" data="<?= $sql_nd['new_cate_id'] ?>" class="dmuc-spham" readonly name="san-pham-laptop" placeholder="Xe cộ  >>  Xe tải, xe khác">
                        </div>
                        <div class="row-tin-dang box_input_infor">
                            <p class="font-dam hd_font15-17">Tiêu đề <span class="color_red">*</span></p>
                            <input class="input_infor_tag error" type="text" name="tieu_de1" autocomplete="off" placeholder="Nhập tiêu đề" value="<?= $sql_nd['new_title'] ?>">
                        </div>
                        <div class="row-tin-dang box_input_infor">
                        ...
                        <div class="row-tin-dang box_input_infor">
                            ...
                            <select class="slect-hang  hd_height36" name="trong_tai">
                                <option disabled value="">Trọng tải</option>
                        ...
                        <? if ($tinhtrang == 2 || $tinhtrang == 3) { ?>
                            <div class="sokm_show">
                                <div class="row-tin-dang">
                                    ...
                                    <input type="text" name="km_di" placeholder="Số km đã đi" onkeydown="javascript: return ['Backspace','Delete','ArrowLeft','ArrowRight'].includes(event.code) ? true : !isNaN(Number(event.key)) && event.code!=='Space'" value="<?= $sql_des['so_km_da_di'] ?>">
                                </div>
                            </div>
                        <? } ?>
                        <div class="row-tin-dang">
                        ...
                        <div class="row-tin-dang cont-btn-sb hd-disflex">
                            ...
                            <button type="button" class="btn-submit xetai_xekhac td-dang-tin hd_cspointer font-bold">CHỈNH SỬA</button>
                        </div>
                    </form>
                </div>
            </div>
