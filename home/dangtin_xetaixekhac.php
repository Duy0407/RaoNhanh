...
<head>
    ...
    <title>Đăng tin xe tải xe khác</title>
        ...
        <div class="tindang-container">
            ...
            <div class="tindang-content-cont hd-disflex">
                ...
                <div class="tindang-col-right">
                    <form class="form-dtin-cont" id="form_xeco_xetaixekhac" data="<?= $acc_id ?>" data1="<?= $acc_type ?>">
                        <div class="row-tin-dang danhmuc_tt">
                            <p class="font-dam hd_font15-17">Danh mục sản phẩm <span class="color_red">*</span></p>
                            <input type="text" class="dmuc-spham" data="38" readonly name="san-pham-laptop" placeholder="Xe cộ  >>  Xe tải, xe khác">
                        </div>
                        <div class="row-tin-dang box_input_infor">
                            <p class="font-dam hd_font15-17">Tiêu đề <span class="color_red">*</span></p>
                            <input class="input_infor_tag error" type="text" name="tieu_de1" autocomplete="off" placeholder="Nhập tiêu đề">
                        </div>
                        <div class="row-tin-dang box_input_infor">
                            ...
                            <select class="slect-hang  hd_height36" name="hang_xe">
                                ...
                                <? foreach ($result_hang as $hangxe) : ?>
                                    <option value="<?= $hangxe['id'] ?>"><?= $hangxe['ten_hang'] ?></option>
                                <? endforeach ?>
                            </select>
                        </div>
                        <div class="row-tin-dang box_input_infor">
                            <p class="font-dam hd_font15-17">Trọng tải<span class="color_red">*</span></p>
                            <select class="slect-hang  hd_height36" name="trong_tai">
                                <option disabled selected value="">Trọng tải</option>
                                <?
                                ...
                                <? foreach ($result_tt as $tt) : ?>
                                    <option value="<?= $tt['id_dl'] ?>"><?= $tt['ten_dl'] ?></option>
                                <? endforeach ?>
                            </select>
                        </div>
                        <div class="row-tin-dang box_input_infor">
                            ...
                            <select class="slect-hang  hd_height36" name="nhienlieu">
                                <option disabled selected value="">Nhiên liệu</option>
                                <option value="1">Xăng</option>
                                <option value="2">Dầu</option>
                                <option value="3">Động cơ Hybird</option>
                            </select>
                        </div>
                        ...
                        <div class="row-tin-dang box_input_infor">
                            ...
                            <select id="tinhtrangxe" class="slect-hang  hd_height36" name="tinhtrang">
                                ...
                                <option value="2">Cũ (Chưa sửa chữa)</option>
                                <option value="3">Cũ (Đã sửa chữa)</option>
                            </select>
                        </div>

                        <div class="sokm_show" hidden>
                            <div class="row-tin-dang">
                                <p class="font-dam hd_font15-17">Số Km đã đi</p>
                                <input type="text" name="km_di" placeholder="Số km đã đi" onkeydown="javascript: return ['Backspace','Delete','ArrowLeft','ArrowRight'].includes(event.code) ? true : !isNaN(Number(event.key)) && event.code!=='Space'">
                            </div>
                        </div>
                        ...
                        <div class="row-tin-dang box_input_infor">
                            ...
                            <select class="slect-chitiet_dm hd_height36" style="width:100%" name="chitiet_dm">
                                ...
                                <?
                                $sql_dm = new db_query("SELECT `tags_id`, `ten_tags` FROM `key_tags` WHERE id_danhmuc = 38");
                        ...
                        <div class="row-tin-dang cont-btn-sb hd-disflex">
                            ...
                            <button type="button" id="xoa_tddang_tin" class="btn-submit xetai_xekhac td-dang-tin hd_cspointer font-bold">ĐĂNG TIN</button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    $(".td-dang-tin").click(function() {
        ...
        form_xeco_xetaixekhac.validate({
            ...
            messages: {
                ...
                trong_tai: "Vui lòng chọn trọng tải xe",
        ...
        if (form_xeco_xetaixekhac.valid() === true) {
            ...
            $.ajax({
                url: '/ajax_xeco/dangtin_xeco_xetaixekhac.php',
                type: 'POST',
                data: fd,
                contentType: false,
                processData: false,
                beforeSend: function() {
                    $('.xetai_xekhac').prop('disabled', true);
                },
                success: function(data) {
                    if (data == "") {
                        ...
                        $('.xetai_xekhac').prop('disabled', false);
                    }
                }
            })
        }
