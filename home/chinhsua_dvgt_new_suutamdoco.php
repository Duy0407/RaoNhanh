...
<head>
    ...
    <title>Chỉnh sửa Đồ sưu tầm, Đồ cổ </title>
...
<body>
    ...
    <section id="m_dangtin_dichvu" class="suckhoe dichvugiaitri">
        ...
        <form class="form-dtin-cont form_bds_chung" id="form_doco" data="<?= $acc_id ?>" data1="<?= $acc_type ?>" data2="<?= $id_nd ?>" data3="<?= $xacthuc_lket ?>">
                ...
                <div class="ctn_ct_box1 d_flex fl_cl w100">
                    ...
                    <div class="ctn_ct_b1_fr2 w100">
                        <div class="b1_fr2_title w100">
                            <p class="b1_fr2_title_p p_400_s16_l19 d_flex fl_row al_ct" data="102">
    ...
    <script>
        // 
        $('.loai_san_pham').on('change', function() {
        ...
        $(".b11_btn_chinhsua").click(function() {
            ...
            form_doco.validate({
                ...
                messages: {
                    ...
                    loai_san_pham: "Vui lòng chọn loại nhạc cụ",
            ...
            if (form_doco.valid() === true) {
                ...
                var id_dm = $(".b1_fr2_title_p").attr('data');
                var id_nd = $("#form_doco").attr("data2");
                ...
                var xac_thuc = $("#form_doco").attr("data3");
