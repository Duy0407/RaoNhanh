...
<head>
    ...
    <title>Đăng tin mẹ và bé- đồ cho bé</title>
        ...
        <div class="tindang-container">
            ...
            <div class="tindang-content-cont hd-disflex">
                ...
                <div class="tindang-col-right">
                    <form class="form-dtin-cont" id="form_mvb_be" data="<?= $us_id ?>" data1="<?= $us_type ?>">
                        <div class="row-tin-dang danhmuc_tt">
                            <p class="font-dam hd_font15-17">Danh mục sản phẩm <span class="color_red">*</span></p>
                            <input type="text" class="dmuc-spham" readonly name="san-pham-laptop" data="<?= $id ?>" placeholder="Mẹ và bé >> Đồ cho bé">
                        </div>
            ...
            form_dangtin.validate({
                ...
                messages: {
                    tieu_de: {
                        ...
                        maxlength: "Mô tả nhiều nhất 70 ký tự",
                    },
