    ...
    <section class="register_buy_container">
        <div class="content-register">
            <div class="box_title_register">
                <p class="title_register">Đăng ký tài khoản <span class="break">doanh nghiệp</span></p>
            </div>
            <div class="form_regis_buy">
                <form class="register_buy" id="register_buy_enterprise" data="<?= $hom_nay ?>">
                    <p class="form_regis_buy-title">ĐĂNG KÝ TÀI KHOẢN DOANH NGHIỆP</p>
                    <div id="regis_step1">
                        <div class="form-control box_input_infor">
                            <label class="label_form">Số điện thoại/email đăng nhập <i class="sao">*</i></label>
                            <input class="numbersOnly2 input_form input_infor_tag" type="text" placeholder="Nhập số điện thoại hoặc email" id="Phone" name="Phone" value="">
                        ...
                        <div class="form-control form_pass box_input_infor">
                            ...
                            <div class="form-control_position mg_b0 form-control">
                        ...
                        <div class="form-control box_input_infor">
                            <label class="label_form">Tên công ty <i class="sao">*</i></label>
                            <input type="text" placeholder="Nhập họ tên" id="Hoten" name="Hoten" class="input_form input_infor_tag error">
                            <div class='noti-error error_hoten'></div>
                        </div>
                        <div class="form-control box_input_infor">
                            <label class="label_form">Email</label>
                            <input type="text" placeholder="Nhập email" name="email" id="Email" class="input_form input_infor_tag error">
                            <span class='noti-error error_email'></span>
                        </div>
                        <div class="form-control dangky_nban">
                            <input type="button" class="btn_regist_buy btn_next input_form" value="Tiếp tục">
                        </div>
                    </div>
                </form>
            </div>
        ...
        form.validate({
            ...
            messages: {
                ...
                Phone: {
                    ...
                    // checktk_dn: "Không đúng định dạng"
                },
            },
