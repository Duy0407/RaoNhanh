...
<head>
    ...
    <title>Đăng tin bất động sản văn phòng</title>
        ...
        <div class="tindang-container">
            ...
            <div class="tindang-content-cont hd-disflex">
                ...
                <div class="tindang-col-right">
                    <form class="form-dtin-cont" id="form_bds_vanphong" data="<?= $acc_id ?>" data1="<?= $acc_type ?>">
                        <div class="row-tin-dang danhmuc_tt">
                            <p class="font-dam hd_font15-17">Danh mục sản phẩm <span class="color_red">*</span></p>
                            <input type="text" class="dmuc-spham" data="34" readonly name="san-pham-laptop" placeholder="Bất động sản >> Văn phòng">
                        </div>
                        ...
                        <div class="d_flex j_between mb20 d_so_sl_sotang">
                            <div class="row-tin-dang rowflex2">
                                <p class="font-dam hd_font15-17">Số tầng </p>
                            ...
                            <div class="row-tin-dang rowflex2">
                                ...
                                <select class="slect-hang  hd_height36" name="huong_cua">
                                    <option selected value="">Hướng cửa chính</option>
                        ...
                        <div class="d_flex j_between d_so_sl_sotang">
                            <div class="row-tin-dang rowflex2">
                                ...
                                <select class="slect-hang  hd_height36" name="giayto">
                                    <option selected value="">Giấy tờ pháp lý</option>
                            ...
                            <div class="row-tin-dang rowflex2">
                                ...
                                <select class="slect-hang  hd_height36" name="tinhtrang_nt">
                                    <option selected value="">Tình trạng nội thất</option>
                        ...
                        <div class="row-tin-dang div-ma-xac-nhan box_input_infor">
                            ...
                            <div class="khung_input_capcha">
                                ...
                                <div class="bao_p_capcha chan_cp">
                                    <input readonly type="text" class="ma_dcap_2 ma_dcap_2_df sh_clr_five sh_size_five b_radius_5 background-none chan_cp" id="captcha"></input>
                                    <div class="img_df">
                        ...
                        <div class="row-tin-dang-btn cont-btn-sb hd-disflex">
                            ...
                            <button type="button" id="xoa_tddang_tin" class="btn-submit dang_tin dangtin_bds_vphong td-dang-tin hd_cspointer font-bold">
                                ĐĂNG TIN</button>
                        </div>
                    </form>
                </div>
...
<style type='text/css'>
    /*Chặn copy*/
    /* .chan_cp{-webkit-touch-callout:none;-webkit-user-select:none;-khtml-user-select:none;-ms-user-select:none;-moz-user-select:none;} */
</style>
<script>
