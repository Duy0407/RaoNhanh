                ...
                <div class="tindang-col-right" data="<?= date('Y-m-d', time()) ?>">
                    <form class="form-dtin-cont" id="form_tuyen_dung" data="<?= $acc_id ?>" data1="<?= $acc_type ?>">
                        ...
                        <div class="row-tin-dang box_input_infor">
                            ...
                            <input class="input_infor_tag error" type="text" name="ten_cty" placeholder="Nhập tên">
                        </div>
                        <div class="row-tin-dang box_input_infor">
                            <p class="font-dam hd_font15-17">Địa chỉ <span class="color_red">*</span></p>
                            <input readonly type="text" name="td_diachi" class="td_ttin_diachi input_infor_tag error" placeholder="Địa chỉ">
                        </div>
                        ...
                        <div class="row-tin-dang box_input_infor">
                            ...
                            <input class="input_infor_tag error" type="text" name="vitri_td" placeholder="VD: Tuyển nhân viên kế toán tổng hợp">
                        </div>
                        <div class="row-tin-dang box_input_infor">
                        ...
                        <div class="row-tin-dang box_input_infor">
                            ...
                            <input readonly type="text" name="td_diachi_lamviec" class="diadiem_lamviec input_infor_tag error" placeholder="Địa chỉ">
                        </div>
                        <div class="row-tin-dang box_input_infor">
                            <p class="font-dam hd_font15-17">Mức lương</p>
                            <div class="item_muc_luong d_flex">
                                <div data-id="1" class="muc_luong active">Thỏa thuận</div>
                        ...
                        <div class="row-tin-dang box_input_infor">
                            ...
                            <input type="text" name="quantity" autocomplete="off" placeholder="Nhập số lượng" onkeydown="javascript: return ['Backspace','Delete','ArrowLeft','ArrowRight'].includes(event.code) ? true : !isNaN(Number(event.key)) && event.code!=='Space'">
                        </div>
                        <div class="row-tin-dang box_input_infor">
...
Những kỹ năng mang tính khuyến khích" name="mota"></textarea>
                        </div>
                        <div class="row-tin-dang box_input_infor">
                            <p class="font-dam hd_font15-17">Hạn nộp <span class="color_red">*</span></p>
                            <input class="input_infor_tag error" type="date" name="hannop">
                        </div>
                        <div class="row-tin-dang box_input_infor">
                        ...
                        <div class="row-tin-dang box_input_infor">
                            ...
                            <div class="item_muc_luong d_flex">
                                <div data-id="0" class="gioi_tinh active">Không yêu cầu</div>
                        ...
                        <div class="row-tin-dang">
                            ...
                            <div class="d_flex j_between">
                                <div class="nhap_dotuoi">
                                    <input type="text" name="minAge" class="tuoi_den" autocomplete="off" placeholder="Tối thiểu" onkeydown="javascript: return ['Backspace','Delete','ArrowLeft','ArrowRight'].includes(event.code) ? true : !isNaN(Number(event.key)) && event.code!=='Space'">
                                </div>
                                <div class="nhap_dotuoi">
                                    <input type="text" name="maxAge" class="tuoi_den" autocomplete="off" placeholder="Tối đa" onkeydown="javascript: return ['Backspace','Delete','ArrowLeft','ArrowRight'].includes(event.code) ? true : !isNaN(Number(event.key)) && event.code!=='Space'">
                                </div>
                            </div>
                            <span class="noti-error error_dotuoi"></span>
                        </div>
                        <div class="row-tin-dang">
                        ...
                        <div class="row-tin-dang">
                            ...
                            <input class="input_infor_tag error" type="text" name="chungchi" placeholder="Nhập chứng chỉ">
                        </div>
                        ...
                        <div class="row-tin-dang-btn cont-btn-sb hd-disflex">
                            ...
                            <button type="button" class="btn-submit dang_tin dang_tin_td td-dang-tin hd_cspointer font-bold">ĐĂNG TIN</button>
                        </div>
                    </form>
                </div>
            </div>
...
<script>
    ...
    $(".td-xem-truoc").click(function() {
        ...
        if (form_tuyen_dung.valid() === true) {
            ...
            // logo công ty
            var logo = $("#upload_logo")[0].files;
            // fd.append('logo', URL.createObjectURL($("#upload_logo")[0].files));
            // ảnh hoạt động công ty
