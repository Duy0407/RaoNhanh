...
if (isset($_COOKIE['UID']) && isset($_COOKIE['UT'])) {
    ...
    $list_lc1 = "SELECT `id`, `ten_loai` FROM `loai_chung` WHERE `id_danhmuc` = $id ";
...
<head>
    ...
    <title>Đăng tin thời trang thể thao</title>
...
<body>
        ...
        <div class="tindang-container">
            ...
            <div class="tindang-content-cont hd-disflex">
                ...
                <div class="tindang-col-right">
                    <form class="form-dtin-cont fid_gia_mb" id="form_thethaothoitrang" data="<?= $us_id ?>" data1="<?= $us_type ?>">
                        <div class="row-tin-dang danhmuc_tt">
                            <p class="font-dam hd_font15-17">Danh mục sản phẩm <span class="color_red">*</span></p>
                            <input type="text" class="dmuc-spham" readonly name="san-pham-laptop" data="<?= $id ?>" placeholder="Thể thao >> Thời trang thể thao">
                        </div>
                        ...
                        <div class="row-tin-dang box_input_infor">
                            ...
                            <select class="slect-hang  hd_height36 mon_the_thao" name="mon_thethao" onchange="hang_doi(this)" data="<?= $id ?>">
                        ...
                        <div class="d_flex j_between dangtin_tt_fl_des mt20">
                            <div class="row-tin-dang rowflex2 box_input_infor fid_gia_mt0 fig_manbe">
                                ...
                                <select class="slect-hang  hd_height36 loai_dungcu_ban" name="loai_thoitrang_ban">
                                    ...
                                    <? while ($row_lc = mysql_fetch_assoc($list_lc->result)) { ?>
                                        <option value="<?= $row_lc['id'] ?>"> <?= $row_lc['ten_loai'] ?></option>
                                    <? } ?>
                                </select>
                            </div>
                        ...
                        <div class="row-tin-dang box_input_infor dong_doi d_none">
                        ...
                        <div class="row-tin-dang box_input_infor">
                            ...
                            <input type="text" name="td_dia_chi" class="td_ttin_diachi input_infor_tag error" readonly autocomplete="off" placeholder="Địa chỉ">
                        </div>
                        <div class="row-tin-dang box_input_infor">
                        ...
                        <div class="row-tin-dang cont-btn-sb hd-disflex">
                            ...
                            <button type="button" id="xoa_tddang_tin" class="btn-submit td-dang-tin tt_thethao hd_cspointer font-bold">ĐĂNG TIN</button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <script>
        $(".mon_the_thao").change(function() {
            var id = $(this).val();
            if (id != "") {
                $(".dong_doi").removeClass("d_none");
            } else {
                $(".dong_doi").addClass("d_none");
            }
        })
        $(".td-dang-tin").click(function() {
            ...
            if (form_thethaothoitrang.valid() === true) {
                ...
                $.ajax({
                    url: '/ajax/dangtin_thethao_ttrang.php',
                    type: 'POST',
                    data: fd,
                    processData: false,
                    contentType: false,
                    beforeSend: function() {
                        $('.tt_thethao').prop('disabled', true);
                    },
                    success: function(data) {
                        if (data == "") {
                            ...
                            $('.tt_thethao').prop('disabled', false);
                        }
                    }
                })
            }
