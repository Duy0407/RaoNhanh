...
<head>
    ...
    <title>Đăng tin sở thích khác</title>
...
<body>
            ...
            <div class="tindang-container">
                ...
                <div class="tindang-content-cont hd-disflex">
                    ...
                    <div class="tindang-col-right">
                        <form class="form-dtin-cont fid_gia_mb" id="form_sothichkhac" data="<?= $us_id ?>" data1="<?= $us_type ?>">
                            <div class="row-tin-dang danhmuc_tt">
                                <p class="font-dam hd_font15-17">Danh mục sản phẩm <span class="color_red">*</span></p>
                                <input type="text" class="dmuc-spham" readonly name="san-pham-laptop" data="<?= $id ?>" placeholder="Dịch vụ - Giải trí >> Sở thích khác">
                            </div>
                            ...
                            <div class="row-tin-dang d_8-7_tclass1">
                                <p class="font-dam hd_font15-17 d_8-7_tclass2">Giá <span class="color_red">*</span>
                                </p>
                                <div class="d_themdiv_gia_7_8 fid_gia_mb1">
                                    <div class="input-gia-cont d_8-7_tclass3">
                                        <div class="box_input_infor">
                                            <input class="input_infor_tag" type="text" name="td_gia_spham" onkeyup="format_gtri(this)" id="gia-ban-sp" autocomplete="off" oninput="<?php echo $oninput; ?>">
                                        </div>
                            ...
                            <div class="row-tin-dang cont-btn-sb hd-disflex">
                                ...
                                <button type="button" id="xoa_tddang_tin" class="btn-submit td-dang-tin dt_sothichkhac hd_cspointer font-bold">ĐĂNG TIN</button>
                            </div>
                        </form>
                    </div>
                </div>
    ...
    <script>
        $(".td-dang-tin").click(function() {
            var form_sothichkhac = $("#form_sothichkhac");
            form_sothichkhac.validate({
            ...
            if (form_sothichkhac.valid() === false) {
            ...
            if (form_sothichkhac.valid() === true) {
                $("#xoa_tddang_tin").removeClass("td-dang-tin");
                var user_id = $("#form_sothichkhac").attr("data");
                var user_type = $("#form_sothichkhac").attr("data1");
                ...
                $.ajax({
                    type: 'POST',
                    url: '/ajax_dvgiaitri/dtin_sothichkhac.php',
                    data: fd,
                    processData: false,
                    contentType: false,
                    beforeSend: function() {
                        $('.dt_sothichkhac').prop('disabled', true);
                    },
                    success: function(data) {
                        if (data == "") {
                            ...
                            $('.dt_sothichkhac').prop('disabled', false);
                        }
                    }
                })
            }
