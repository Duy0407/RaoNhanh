...
if (isset($_COOKIE['UID']) && isset($_COOKIE['UT']) && $id_nd != 0) {
    ...
    $list_tin = new db_query("SELECT `new`.`new_id`, `new_title`,`link_title`,`new_money`, `new_cate_id`, 
                                ...
                                `new_description`,`loai_phu_tung`,`canhan_moigioi`,
    ...
    if (mysql_num_rows($list_tin->result) > 0) {
        ...
        // tag danh muc
        $ban = new db_query("SELECT `tags_id`, `ten_tags` FROM `key_tags` WHERE `id_danhmuc` = 39 AND type_tags = '" . $item_td['can_ban_mua'] . "' ");
...
<head>
    ...
    <title>Chỉnh sửa xe cộ phụ tùng xe</title>
...
<body>
    ...
    <!-- content -->
    <section id="m_dangtin_xc_phutungxe" class="xeco">
        <div class="container_title">
            <p class="ctn_tt_p p_600_s24_l28">Chỉnh sửa</p>
        </div>
        <form class="form-dtin-cont form_bds_chung" id="form_xeco_phutung" data="<?= $acc_id ?>" data1="<?= $acc_type ?>" data2="<?= $id_nd ?>" data3="<?= $xacthuc_lket ?>">
            <div class="container_content">
                ...
                <div class="ctn_ct_box1 d_flex fl_cl w100">
                    ...
                    <div class="ctn_ct_b1_fr2 w100">
                        <div class="b1_fr2_title w100">
                            <p class="b1_fr2_title_p p_400_s16_l19 d_flex fl_row al_ct" data="39">
                ...
                <div class="ctn_ct_box6 d_flex fl_cl">
                    ...
                    <div class="ctn_ct_b6_ft d_flex fl_row fl_st">
                        <div class="b6_ft1 d_flex fl_cl danhmuc_tag box_input_infor">
                            <p class="b6_ft1_title p_400_s15_l18">
                                Loại phụ tùng <span class="cl_red">*</span>
                            </p>
                            <select id="loai_phutung" class="slect-hang  hd_height36" name="loai_phu_tung">
                                <option disabled selected value="">Loại phụ tùng</option>
                                <?
                                ...
                                <? foreach ($query_pt as $pt) : ?>
                                    <option <?= ($pt['id'] == $item_td['loai_phu_tung']) ? "selected" : "" ?> value="<?= $pt['id'] ?>"><?= $pt['ten_loai'] ?></option>
                                <? endforeach ?>
                            </select>
                        </div>
                    </div>
    ...
    <script>
        $('#loai_phutung').on('change', function() {
            var id_pt = $("select[name='loai_phu_tung']").val();
            if (id_pt == 1916) {
                $('.danhmuc_tag').hide()
            } else {
                $('.danhmuc_tag').show()
    ...
    <script>
        $(".b11_btn_chinhsua").click(function() {
            ...
            if (form_xeco_phutung.valid() === true) {
                ...
                var id_nd = $("#form_xeco_phutung").attr("data2");
                ...
                var xac_thuc = $("#form_xeco_phutung").attr("data3");
