...
<body>
    ...
    <!-- content -->
    <section id="m_dangtin_mevabe" class="suckhoe mevabe">
        <div class="container_title">
            <p class="ctn_tt_p p_600_s24_l28">Đăng tin</p>
        </div>
        <form class="form-dtin-cont form_bds_chung" id="form_mevabe" data="<?= $acc_id ?>" data1="<?= $acc_type ?>" data2="<?= $id_nd ?>" data3="<?= $xacthuc_lket ?>">
                ...
                <div class="ctn_ct_box1 d_flex fl_cl w100">
                    ...
                    <div class="ctn_ct_b1_fr2 w100">
                        <div class="b1_fr2_title w100">
                            <p class="b1_fr2_title_p p_400_s16_l19 d_flex fl_row al_ct" data="53">
                                Mẹ và bé <span class="d_flex fl_row al_ct pdl_5 pdr_5">
    ...
    <script>
        ...
        $(".b11_btn_chinhsua").click(function() {
            var form_mevabe = $("#form_mevabe");
            form_mevabe.validate({
                ...
                messages: {
                    ...
                    loai_san_pham: "Vui lòng chọn loại sản phẩm",
            ...
            if (form_mevabe.valid() === true) {
                $("#xoa_tddang_tin").removeClass("b11_btn_dangtin");
                var user_id = $("#form_mevabe").attr("data");
                var user_type = $("#form_mevabe").attr("data1");
                var id_nd = $("#form_mevabe").attr("data2");
                var id_dm = $(".b1_fr2_title_p").attr('data');
                ...
                var xac_thuc = $("#form_mevabe").attr("data3");
    ...
    <script>
        ...
        function xem_trc_tin() {
            var form_mevabe = $(".form-dtin-cont");
            form_mevabe.validate({
                errorPlacement: function(error, element) {
                    error.appendTo(element.parents(".box_input_infor"));
                    error.wrap("<span class='error'>");
