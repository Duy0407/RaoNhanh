...
if (isset($_COOKIE['UID']) && isset($_COOKIE['UT'])) {
    ...
    $list_nhom = new db_query("SELECT `id`, `name`  FROM `nhom_sanpham` WHERE `id_danhmuc` = $id ");
} else {
    header('Location: /');
}
...
<head>
    ...
    <title>Đăng tin thiết bị theo mùa</title>
        ...
        <div class="tindang-container">
            ...
            <div class="tindang-content-cont hd-disflex">
                ...
                <div class="tindang-col-right">
                    <form class="form-dtin-cont" id="form_tb_theomua">
                        <div class="row-tin-dang danhmuc_tt">
                            <p class="font-dam hd_font15-17">Danh mục sản phẩm <span class="color_red">*</span></p>
                            <input data="<?= $id ?>" type="text" class="dmuc-spham" readonly name="san-pham-laptop" placeholder="Đồ gia dụng  >>  Thiết bị theo mùa">
                        </div>
                        ...
                        <div class="row-tin-dang box_input_infor">
                            ...
                            <select class="slect-hang  loai_thiet_bi hd_height36" name="loai_thiet_bi" data="<?= $id ?>" onchange="tags_doi(this)">
                                <option disabled selected value="">Loại thiết bị</option>
                                <? while ($row_nhom = mysql_fetch_assoc($list_nhom->result)) { ?>
                                    <option value="<?= $row_nhom['id'] ?>"><?= $row_nhom['name'] ?></option>
                                <? } ?>
                            </select>
                        </div>
                        <!-- render -->
                            ...
                            <div class="d_themdiv_gia_7_8">
                                <div class="input-gia-cont d_8-7_tclass3">
                                    <div class="box_input_infor">
                                        <input class="input_infor_tag error" type="text" name="td_gia_spham" id="gia-ban-sp" autocomplete="off" oninput="<?php echo $oninput; ?>" onkeyup="format_gtri(this)">
                                    </div>
                        ...
                        <div class="row-tin-dang div-ma-xac-nhan box_input_infor">
                            ...
                            <div class="khung_input_capcha">
                                ...
                                <div class="bao_p_capcha">
                                    <input readonly type="text" class="ma_dcap_2 ma_dcap_2_df sh_clr_five sh_size_five b_radius_5 background-none d_none" id="captcha"></input>
                                    <div class="img_df">
                        ...
                        <div class="row-tin-dang cont-btn-sb hd-disflex hide-480-mobile">
                            ...
                            <button type="button" id="xoa_tddang_tin" class="btn-submit td-dang-tin tb_theomua hd_cspointer font-bold">ĐĂNG TIN</button>
                        </div>
                    </form>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    $(".td-dang-tin").click(function() {
        var form_tb_theomua = $("#form_tb_theomua");
        form_tb_theomua.validate({
        ...
        if (form_tb_theomua.valid() === false) {
        ...
        if (form_tb_theomua.valid() === true) {
            ...
            $.ajax({
                type: 'POST',
                url: '/ajax_dogiadung/dtin_thietbitheomua.php',
                data: fd,
                processData: false,
                contentType: false,
                beforeSend: function() {
                    $('.tb_theomua').prop('disabled', true);
                },
                success: function(data) {
                    if (data == "") {
                        ...
                        $('.tb_theomua').prop('disabled', false);
                    }
                }
            })
        }
