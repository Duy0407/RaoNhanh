...
if (isset($_COOKIE['UID']) && isset($_COOKIE['UT']) && $id_nd != 0 && $id_dm != 0) {
    ...
    if (mysql_num_rows($list_tin->result) > 0) {
        ...
        // tag danh muc
        $ban = new db_query("SELECT `tags_id`, `ten_tags` FROM `key_tags` WHERE `id_danhmuc` = 45 AND type_tags = '" . $item_td['can_ban_mua'] . "' ");
...
<head>
    ...
    <title>Chỉnh sửa Đồng phục, Đồ đôi </title>
...
<body>
    ...
    <section id="m_dangtin_thoitrang" class="suckhoe thoitrang">
        ...
        <form class="form-dtin-cont form_bds_chung" id="form_thoitrang_dongphuc" data="<?= $acc_id ?>" data1="<?= $acc_type ?>" data2="<?= $id_nd ?>" data3="<?= $xacthuc_lket ?>">
    ...
    <script>
        $(".b11_btn_chinhsua").click(function() {
            var form_thoitrang_dongphuc = $("#form_thoitrang_dongphuc");
            form_thoitrang_dongphuc.validate({
            ...
            if (form_thoitrang_dongphuc.valid() === false) {
            ...
            if (form_thoitrang_dongphuc.valid() === true) {
                var user_id = $("#form_thoitrang_dongphuc").attr("data");
                var user_type = $("#form_thoitrang_dongphuc").attr("data1");
                var id_nd = $("#form_thoitrang_dongphuc").attr("data2");
                ...
                var xac_thuc = $("#form_thoitrang_dongphuc").attr("data3");
                ...
                $.ajax({
                    type: 'POST',
                    url: '/ajax_thoitrang/csua_ttrang_nu.php',
                    data: fd,
                    processData: false,
                    contentType: false,
    ...
    <script>
        ...
        function xem_trc_tin() {
            var form_thoitrang_dongphuc = $(".form-dtin-cont");
            form_thoitrang_dongphuc.validate({
                errorPlacement: function(error, element) {
                    error.appendTo(element.parents(".box_input_infor"));
                    error.wrap("<span class='error'>");
