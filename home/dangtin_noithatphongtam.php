        ...
        <div class="tindang-container">
            ...
            <div class="tindang-content-cont hd-disflex">
                ...
                <div class="tindang-col-right">
                    <form class="form-dtin-cont" id="form_noithatphongtam">
                        ...
                        <div class="row-tin-dang box_input_infor">
                            ...
                            <select class="slect-hang loaisanpham hd_height36" name="loai_sanpham" data="<?= $id ?>">
                        ...
                        <div class="row-tin-dang-btn cont-btn-sb hd-disflex hide-480-mobile">
                            ...
                            <button type="button" id="xoa_tddang_tin" class="btn-submit td-dang-tin noithatphongtam hd_cspointer font-bold">ĐĂNG TIN</button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    $(".td-dang-tin").click(function() {
        ...
        if (form_noithatphongtam.valid() === true) {
            ...
            $.ajax({
                ...
                contentType: false,
                beforeSend: function() {
                    $('.noithatphongtam').prop('disabled', true);
                },
                success: function(data) {
                    if (data == "") {
                        tbao_dtin_tcong();
                        ...
                        $('.noithatphongtam').prop('disabled', false);
                    }
                }
            })
        }
