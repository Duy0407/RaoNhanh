...
if (isset($_COOKIE['UID']) && isset($_COOKIE['UT']) && $id_nd != 0) {
    ...
    $list_tin = new db_query("SELECT `new`.`new_id`, `new_title`,`link_title`,`new_money`, `new_cate_id`, 
                                ...
                                `new_description`,`new_description`,`loai_sanpham`,`hang_vattu`,`canhan_moigioi`
    ...
    if (mysql_num_rows($list_tin->result) > 0) {
        ...
        // tag danh muc
        $ban = new db_query("SELECT `tags_id`, `ten_tags` FROM `key_tags` WHERE `id_danhmuc` = 63 AND type_tags = '" . $item_td['can_ban_mua'] . "' ");
...
<body>
    ...
    <!-- content -->
    <section id="m_dangtin_sk_vattu_yte" class="suckhoe">
        <div class="container_title">
            <p class="ctn_tt_p p_600_s24_l28">Chỉnh sửa</p>
        </div>
        <form class="form-dtin-cont form_bds_chung" id="form_vattu_yte" data="<?= $acc_id ?>" data1="<?= $acc_type ?>" data2="<?= $id_nd ?>" data3="<?= $xacthuc_lket ?>">
            <div class="container_content">
                ...
                <div class="ctn_ct_box1 d_flex fl_cl w100">
                    ...
                    <div class="ctn_ct_b1_fr2 w100">
                        <div class="b1_fr2_title w100">
                            <p class="b1_fr2_title_p p_400_s16_l19 d_flex fl_row al_ct" data="63">
                ...
                <div class="b6_loaihinh d_flex fl_cl box_input_infor">
                    <p class="b6_lhinh_txt p_400_s15_l18">
                        Loại vật tư <span class="cl_red">*</span>
                    </p>
                    <select id="loai_vattu" class="b6_lhinh_select slect-hang  hd_height36" name="loai_vattu">
                        <option value="" disabled selected>Vật liệu y tế tiêu hao</option>
                        <? foreach ($db_lchung as $rows) {
                            if ($rows['id_danhmuc'] == 63) { ?>
                ...
                <!-- hang -->
                <div class="b6_hangvattu d_flex fl_cl box_input_infor">
                    <p class="b6_hvt_txt p_400_s15_l18">
                        Hãng <span class="cl_red">*</span>
                    </p>
                    <input type="text" value="<?= $item_td['hang_vattu'] ?>" class="b6_hvt_input hd_height36 w100" name="hang" placeholder="Nhập hãng">
                </div>
                <!-- tinh trang -->
    ...
    <script>
        ...
        $(".b11_btn_chinhsua").click(function() {
            ...
            if (form_vattu_yte.valid() === true) {
                ...
                var id_nd = $("#form_vattu_yte").attr("data2");
                ...
                var xac_thuc = $("#form_vattu_yte").attr("data3");
