...
<head>
    ...
    <title>Chỉnh sửa nội thất văn phòng</title>
                ...
                <div class="b6_nl_title d_flex fl_cl">
                    <div class="d_flex fl_row fl_st w_100">
                        <div class="d_flex fl_cl box_input_infor w_100">
                            ...
                            <select class="b6_fr1_select slect-hang hd_height36 nhom_spham" name="nhom_spham" data="<?= $id_dm ?>" data1="<?= $id_nd ?>">
