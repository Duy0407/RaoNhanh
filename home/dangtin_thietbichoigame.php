...
<head>
    ...
    <title>Đăng tin thiết bị chơi game</title>
            ...
            <div class="tindang-container">
                ...
                <div class="tindang-content-cont hd-disflex">
                    ...
                    <div class="tindang-col-right">
                        <form class="form-dtin-cont fid_gia_mb" id="form_tbchoigame" data="<?= $us_id ?>" data1="<?= $us_type ?>">
                            <div class="row-tin-dang danhmuc_tt">
                                <p class="font-dam hd_font15-17">Danh mục sản phẩm <span class="color_red">*</span></p>
                                <input type="text" class="dmuc-spham" readonly name="san-pham-laptop" data="<?= $id ?>" placeholder="Dịch vụ - Giải trí >> Thiết bị chơi game">
                            </div>
                            ...
                            <div class="row-tin-dang cont-btn-sb hd-disflex">
                                ...
                                <button type="button" id="xoa_tddang_tin" class="btn-submit td-dang-tin dt_choigame hd_cspointer font-bold">ĐĂNG TIN</button>
                            </div>
                        </form>
                    </div>
                </div>
        ...
        $(".td-dang-tin").click(function() {
            ...
            form_tbchoigame.validate({
                ...
                messages: {
                    ...
                    tinhtrang: "Vui lòng chọn tình trạng thiết bị",
            ...
            if (form_tbchoigame.valid() === true) {
                ...
                $.ajax({
                    type: 'POST',
                    url: '/ajax_dvgiaitri/dtin_tbichoigame.php',
                    data: fd,
                    processData: false,
                    contentType: false,
                    beforeSend: function() {
                        $('.dt_choigame').prop('disabled', true);
                    },
                    success: function(data) {
                        if (data == "") {
                            ...
                            $('.dt_choigame').prop('disabled', false);
                        }
                    }
                })
            }
