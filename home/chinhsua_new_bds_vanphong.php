...
if (isset($_COOKIE['UID']) && isset($_COOKIE['UT']) && $id_nd != 0) {
    ...
    $list_tin = new db_query("SELECT `new`.`new_id`, `new_title`, `link_title`, `new_money`, `new_cate_id`, `new_city`, `new_image`,
                            `new_unit`, `new_name`, `new_phone`, `new_email`, `new_address`, `quan_huyen`, `phuong_xa`, `new_sonha`, `dia_chi`,
                            `new_video`, `new_ctiet_dmuc`, `new_description`,`can_ban_mua`, `ten_toa_nha`, `huong_chinh`, `giay_to_phap_ly`,
                            `tinh_trang_noi_that`, `dien_tich`, `chieu_dai`, `chieu_rong`, `loaihinh_vp`, `tang_so`,
                            `td_block_thap`, `canhan_moigioi`, `td_macanho`, `td_htmch_rt` FROM `new`
    ...
    if (mysql_num_rows($list_tin->result) > 0) {
        ...
        // tag danh muc
        $ban = new db_query("SELECT `tags_id`, `ten_tags` FROM `key_tags` WHERE `id_danhmuc` = 34 AND type_tags = '" . $item_td['can_ban_mua'] . "' ");
...
<head>
    ...
    <title>Chỉnh sửa bất động sản văn phòng</title>
...
<body>
    ...
    <!-- content -->
    <section id="m_dangtin_bds_vanphong">
        <div class="container_title">
            <p class="ctn_tt_p p_600_s24_l28">Chỉnh sửa tin đăng</p>
        </div>
        <form class="form-dtin-cont form_bds_chung" id="form_bds_vanphong" data="<?= $acc_id ?>" data1="<?= $acc_type ?>">
                ...
                <div class="ctn_ct_box1 d_flex fl_cl w100">
                    ...
                    <div class="ctn_ct_b1_fr2 w100">
                        <div class="b1_fr2_title w100">
                            <p class="b1_fr2_title_p p_400_s16_l19 d_flex fl_row al_ct" data="34" data1="<?= $id_nd ?>">
                ...
                <div class="ctn_ct_box4 d_flex fl_cl">
                    ...
                    <div class="ctn_ct_b4_fr d_flex fl_row al_ct">
                        <div class="ctn_ct_b4_fr1">
                            ...
                            <input type="text" name="ten_toanha" class="b4_fr1_input p_400_s14_l17" value="<?= $item_td['ten_toa_nha'] ?>" placeholder="Tên toà nhà/Khu dân cư" autocomplete="off">
                        </div>
                        <div class="ctn_ct_b4_fr2 box_input_infor">
                            <p class="b4_fr2_title p_400_s15_l18">
                                Địa chỉ văn phòng <span class="cl_red">*</span>
                            </p>
                            <input type="text" name="td_diachi_nha" class="td_ttin_diachi b4_fr2_input p_400_s14_l17" value="<?= $item_td['dia_chi'] ?>" data-tt="<?= $item_td['new_city'] ?>" data-qh="<?= $item_td['quan_huyen'] ?>" data-px="<?= $item_td['phuong_xa'] ?>" data-sn="<?= $item_td['so_nha'] ?>" placeholder="Địa chỉ căn hộ" autocomplete="off">
                        </div>
                    </div>
                </div>
                <!-- ----------------------------------------------------------------------box5--------------------------------------------------------------------- -->
                ...
                <div class="ctn_ct_box6 d_flex fl_cl">
                    ...
                    <div class="ctn_ct_b6_box">
                        <div class="b6_box d_flex fl_cl box_input_infor">
                            <p class="b6_box_title p_400_s15_l18">Loại hình văn phòng <span class="cl_red">*</span></p>
                            <select class="slect-hang  hd_height36" name="loaihinh">
                                <option disabled value="">Chọn</option>
                                <option value="1" <?= ($item_td['loaihinh_vp'] == 1) ? 'selected' : '' ?>>Mặt bằng kinh doanh</option>
                                <option value="2" <?= ($item_td['loaihinh_vp'] == 2) ? 'selected' : '' ?>>Văn phòng</option>
                                <option value="3" <?= ($item_td['loaihinh_vp'] == 3) ? 'selected' : '' ?>>Shophouse</option>
                                <option value="4" <?= ($item_td['loaihinh_vp'] == 4) ? 'selected' : '' ?>>Officetel</option>
                            </select>
                        </div>
                        <div class="b6_ft2 d_flex fl_cl">
                            ...
                            <select class="b6_ft2_select slect-hang" name="huong_cua">
                                <option value="" class="p_400_s14_l17 ">Chọn</option>
                                <option value="1" class="p_400_s14_l17" <?= ($item_td['huong_chinh'] == 1) ? 'selected' : '' ?>>Đông</option>
                                <option value="2" class="p_400_s14_l17" <?= ($item_td['huong_chinh'] == 2) ? 'selected' : '' ?>>Tây </option>
                                <option value="3" class="p_400_s14_l17" <?= ($item_td['huong_chinh'] == 3) ? 'selected' : '' ?>>Nam </option>
                                <option value="4" class="p_400_s14_l17" <?= ($item_td['huong_chinh'] == 4) ? 'selected' : '' ?>>Bắc </option>
                                <option value="5" class="p_400_s14_l17" <?= ($item_td['huong_chinh'] == 5) ? 'selected' : '' ?>>Đông bắc </option>
                                <option value="6" class="p_400_s14_l17" <?= ($item_td['huong_chinh'] == 6) ? 'selected' : '' ?>>Đông nam </option>
                                <option value="7" class="p_400_s14_l17" <?= ($item_td['huong_chinh'] == 7) ? 'selected' : '' ?>>Tây bắc </option>
                                <option value="8" class="p_400_s14_l17" <?= ($item_td['huong_chinh'] == 8) ? 'selected' : '' ?>>Tây nam </option>
                            </select>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="ctn_ct_b8_fr d_flex fl_row ">
                        <div class="b8_fr1 d_flex fl_cl box_input_infor">
                            ...
                            <div class="b8_fr1_content d_flex fl_row jtf_spb">
                                <input name="dientich" type="text" value="<?= $item_td['dien_tich'] ?>" class="b8_fr1_input p_400_s14_l17" autocomplete="off" placeholder="Diện tích">
        ...
        $(".b11_btn_dangtin").click(function() {
            ...
            form_bds_vanphong.validate({
                ...
                messages: {
                    ...
                    loaihinh: "Vui lòng chọn loại hình văn phòng",
                    mota: {
