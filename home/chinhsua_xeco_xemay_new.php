...
<head>
    ...
    <title>Chỉnh sửa đăng tin xe máy</title>
                    ...
                    <div class="ctn_ct_b6_fr b6_fr_hangxe d_flex fl_row fl_st">
                        ...
                        <div class="b6_fr2 m_dongxe d_flex fl_cl box_input_infor">
                            <? if ($hang == 1286) { ?>
                                ...
                                <input type="text" name="dongmay" class="dong_may input_infor_tag" autocomplete="off" placeholder="Nhập dòng xe" value="<?= $item_td['dong_xe'] ?>">
                            <? } else { ?>
                                <p class="b6_fr2_title p_400_s15_l18">
                                    Dòng xe <span class="cl_red">*</span>
                                </p>
