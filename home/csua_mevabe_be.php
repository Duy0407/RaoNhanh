                ...
                <div class="tindang-col-right" data="<?= $id_cs ?>">
                    <form class="form-dtin-cont" id="form_mvb_be" data="<?= $us_id ?>" data1="<?= $us_type ?>">
                        <div class="row-tin-dang danhmuc_tt">
                            ...
                            <input type="text" class="dmuc-spham" readonly name="san-pham-laptop" data="<?= $id_dm ?>" placeholder="Mẹ và bé >> Đồ cho bé">
                        </div>
            ...
            form_dangtin.validate({
                ...
                messages: {
                    tieu_de: {
                        ...
                        maxlength: 'Tiêu đề ít hơn 70 ký tự',
                    },
