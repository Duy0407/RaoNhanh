...
if (isset($_COOKIE['UID']) && isset($_COOKIE['UT']) && $id_cs != 0 && $id_dm != 0) {
    ...
    if (mysql_num_rows($check_tind->result) > 0) {
        $list_tt = new db_query("SELECT n.`new_title`, n.`new_money`, n.`gia_kt`, n.`new_cate_id`, n.`new_city`, n.`new_image`, n.`new_unit`, n.`new_tinhtrang`,
                                n.`chotang_mphi`, n.`quan_huyen`, n.`phuong_xa`, n.`new_sonha`, n.`dia_chi`, n.`new_video`, n.`new_baohanh`,
...
<head>
    ...
    <title>Đăng tin đồ gia dụng khác</title>
        ...
        <div class="tindang-container">
            ...
            <div class="tindang-content-cont hd-disflex">
                ...
                <div class="tindang-col-right" data="<?= $id_cs ?>">
                    <form class="form-dtin-cont" id="form_dogiadungkhac" data="<?= $us_id ?>" data1="<?= $us_type ?>">
                        <div class="row-tin-dang danhmuc_tt">
                            <p class="font-dam hd_font15-17">Danh mục sản phẩm <span class="color_red">*</span></p>
                            <input type="text" class="dmuc-spham" readonly name="san-pham-laptop" data="<?= $id_dm ?>" placeholder="Đồ gia dụng  >>  Đồ gia dụng khác">
                        </div>
                        ...
                        <div class="row-tin-dang div-ma-xac-nhan box_input_infor">
                            ...
                            <div class="khung_input_capcha">
                                ...
                                <div class="bao_p_capcha">
                                    <input readonly readonly type="text" class="ma_dcap_2 ma_dcap_2_df sh_clr_five sh_size_five b_radius_5 background-none" id="captcha"></input>
                                    <div class="img_df">
                        ...
                        <div class="row-tin-dang cont-btn-sb hd-disflex hide-480-mobile">
                            ...
                            <button type="button" class="btn-submit td-dang-tin dogiadungkhac hd_cspointer font-bold">ĐĂNG TIN</button>
                        </div>
                    </form>
                </div>
            </div>
...
<script type="text/javascript">
    $(".dogiadungkhac").click(function() {
        var form_dogiadungkhac = $("#form_dogiadungkhac");
        form_dogiadungkhac.validate({
        ...
        if (form_dogiadungkhac.valid() === true) {
    ...
    $(".td-xem-truoc").click(function() {
        ...
        if (form_dogiadungkhac.valid() === false) {
