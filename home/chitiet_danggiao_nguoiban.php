                ...
                <div class="detail-main">
                    <div class="detail-main-t">
                        ...
                        <div class="main-t-p">
                            ...
                            <? if ($row_tin['tgian_ghthatbai'] != 0 && $row_tin['tgian_ghthatbai'] != "") { ?>
                                <p class="color_orange text_status">Giao hàng thất bại</p>
                            <? } else { ?>
                                <p class="color_orange text_status">ĐANG GIAO HÀNG</p>
                            <? } ?>
                        </div>
                            ...
                            <div class="bot-ql">
                                ...
                                <div class="content-bot-c">
                                    <div class="detail-sp">
                                        ...
                                        <? if ($row_tin['tgian_ghthatbai'] != 0 && $row_tin['tgian_ghthatbai'] != "") { ?>
                                            <p class="text_sp">Ngày giao: <?= date('d/m/Y', $row_tin['tgian_giaohang']) ?> &nbsp;&nbsp;<?= date('H:i', $row_tin['tgian_giaohang']) ?></p>
                                            <p class="text_reason">Lý do: <?= $row_tin['lydo_ghtbai'] ?></p>
                                        <? } ?>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="main-btn-danggiao">
                            <button class="xacnhan-3" data="<?= $row_tin['dh_id'] ?>" data1="3" onclick="xac_nhan_bh(this)">Xác nhận</button>
                            <div class="btn-480">
    ...
    <div id="modal-giaohang-thatbai" class="modal giao_hang_that_bai">
        <div class="modal-content-huydon">
            ...
            <div class="huydon-footer">
                ...
                <button type="button" class="modal-btn-xacnhan" data="">Xác nhận</button>
            </div>
        </div>
