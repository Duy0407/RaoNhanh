...
if (isset($_COOKIE['UID']) && isset($_COOKIE['UT'])) {
    ...
    $sql_dm = new db_query("SELECT `tags_id`, `ten_tags` FROM `key_tags` WHERE id_danhmuc = 40");
...
<head>
    ...
    <title>Đăng tin xe cộ xe đạp điện</title>
...
<body>
    ...
    <section id="m_dangtin_xc_xedapdien" class="xeco">
        ...
        <form class="form-dtin-cont form_bds_chung" id="form_xeco_xedapdien" data="<?= $acc_id ?>" data1="<?= $acc_type ?>" data3="<?= $xacthuc_lket ?>">
