...
<head>
    ...
    <title>Đăng tin nội thất vườn</title>
        ...
        <div class="tindang-container">
            ...
            <div class="tindang-content-cont hd-disflex">
                ...
                <div class="tindang-col-right">
                    <form class="form-dtin-cont" id="form_noithatvuon">
                        <div class="row-tin-dang danhmuc_tt">
                            <p class="font-dam hd_font15-17">Danh mục sản phẩm <span class="color_red">*</span></p>
                            <input data="<?= $id ?>" type="text" class="dmuc-spham" readonly name="san-pham-laptop" placeholder="Nội thất - Ngoại thất >> Vườn">
                        </div>
                        ...
                        <div class="row-tin-dang-btn cont-btn-sb hd-disflex hide-480-mobile">
                            ...
                            <button type="button" id="xoa_tddang_tin" class="btn-submit td-dang-tin noithatvuon hd_cspointer font-bold">ĐĂNG TIN</button>
                        </div>
                    </form>
                </div>
            </div>
...
<script type="text/javascript">
    $(".td-dang-tin").click(function() {
        var form_noithatvuon = $("#form_noithatvuon");
        form_noithatvuon.validate({
        ...
        if (form_noithatvuon.valid() === false) {
        ...
        if (form_noithatvuon.valid() === true) {
            ...
            $.ajax({
                type: 'POST',
                url: '/ajax_noithat_ngoaithat/dtin_vuon.php',
                data: fd,
                processData: false,
                contentType: false,
                beforeSend: function() {
                    $('.noithatvuon').prop('disabled', true);
                },
                success: function(data) {
                    if (data == "") {
                        ...
                        $('.noithatvuon').prop('disabled', false);
                    }
                }
            })
        }
