...
if (isset($_COOKIE['UID']) && isset($_COOKIE['UT']) && $id != 0) {
    ...
    $list_dh = new db_query("SELECT `dh_id`,`id_nguoi_dh`, `id_nguoi_ban`, `id_spham`, `ghi_chu`, `loai_ttoan`, `tien_ttoan`, `dia_chi_nhanhang`, `trang_thai`,
                            `tgian_xnbh`, `tgian_htat`, `usc_name`,`chat365_id`,`usc_id`, `usc_logo`, `usc_phone`, `new_title`, `new_money`, `new_unit`, `new_user_id`, `new_type`, `new_image`
                            FROM `dat_hang` INNER JOIN `new` ON `new`.`new_id` = `dat_hang`.`id_spham`
                            INNER JOIN `user` ON `user`.`usc_id` = `dat_hang`.`id_nguoi_dh`
                            WHERE `trang_thai` = 4 AND `id_nguoi_ban` = $id_user AND `dh_id` = $id ");
        ...
        <div class="box-right edit_pers">
            <div class="box-right-detail">
                <div class="detail-top">
                    <a href="/quan-ly-don-hang-hoan-tat.html"><img src="/images/bo-sung-raonhanh/muiten-back.svg" alt=""></a>
                ...
                <div class="detail-main">
                    <div class="detail-main-t">
                        ...
                        <div class="main-t-p">
                            ...
                            <p class="color_orange text_status">HOÀN TẤT ĐƠN HÀNG</p>
                        </div>
                            ...
                            <div class="bot-ql">
                                ...
                                <div class="content-bot-c">
                                    <div class="detail-sp">
                                        ...
                                        <p class="text_sp">Ngày giao: <?= date('d/m/Y', $row_tin['tgian_htat']) ?> &nbsp;&nbsp;<?= date('H:i', $row_tin['tgian_htat']) ?></p>
                                    </div>
                                </div>
                            </div>
                            <div class="sp-price">
