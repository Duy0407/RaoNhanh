...
<head>
    ...
    <title>Đăng tin bất động sản căn hộ chung cư</title>
        ...
        <div class="tindang-container">
            ...
            <div class="tindang-content-cont hd-disflex">
                ...
                <div class="tindang-col-right">
                    <form class="form-dtin-cont" id="form_bds_chungcu" data="<?= $acc_id ?>" data1="<?= $acc_type ?>">
                        <div class="row-tin-dang danhmuc_tt">
                            <p class="font-dam hd_font15-17">Danh mục sản phẩm <span class="color_red">*</span></p>
                            <input type="text" class="dmuc-spham" data="27" readonly name="san-pham-laptop" placeholder="Bất động sản >> Căn hộ chung cư">
                        </div>
                        <div class="row-tin-dang box_input_infor">
                            ...
                            <select class="slect-hang banthue hd_height36" name="ban_thue">
                                <option disabled selected value="0">Cần bán/Cho thuê</option>
                        ...
                        <div class="row-tin-dang box_input_infor">
                            ...
                            <select class="slect-hang  hd_height36" name="loaihinh">
                                ...
                                <option value="4">Căn hộ dịch vụ, mini</option>
                                <option value="5">Tập thể, cư xá</option>
                                <option value="6">Officetel</option>
                            </select>
                        </div>
                        <div class="row-tin-dang box_input_infor">
                            ...
                            <div class="d_flex top15 space_b ">
                                <div class="checkbox1 w50 d_flex align_c">
                                    <input type="radio" class="checkbox_dacdiem dacdiem1" name="tinh_trang">
                                    <label class="color-blk">Đã bàn giao</label>
                                </div>
                                <div class="checkbox1 w50 d_flex align_c">
                                    <input type="radio" class="checkbox_dacdiem dacdiem2" name="tinh_trang">
                        ...
                        <div class="row-tin-dang box_input_infor">
                            ...
                            <input type="text" name="tangso" placeholder="Tầng số" onkeydown="javascript: return ['Backspace','Delete','ArrowLeft','ArrowRight'].includes(event.code) ? true : !isNaN(Number(event.key)) && event.code!=='Space'">
                        </div>
                        <!-- số phòng ngủ ,vệ sinh người bán -->
                        ...
                        <!-- hết số phòng ngủ ,vệ sinh người bán -->
                        <!-- giấy tờ pháp lý ,tình trạng nội thất người bán -->
                        ...
                        <div class="row-tin-dang position_ral box_input_infor validate_input">
                            ...
                            <input type="text" name="dientich" placeholder="Diện tích" onkeydown="javascript: return ['Backspace','Delete','ArrowLeft','ArrowRight'].includes(event.code) ? true : !isNaN(Number(event.key)) && event.code!=='Space'">
...
<script>
    $('.checkbox_dacdiem').click(function() {
        $('.checkbox_dacdiem').not($(this)).prop('checked', false);
    });
    ...
    $(".td-dang-tin").click(function() {
        ...
        if (form_bds_chungcu.valid() === true) {
            ...
            $.ajax({
                url: '/ajax_bds/dangtin_bdschungcu.php',
                type: 'POST',
                data: fd,
                contentType: false,
                processData: false,
