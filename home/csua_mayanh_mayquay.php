                ...
                <div class="tindang-col-right" data="<?= $id_cs ?>">
                    <form class="form-dtin-cont" id="form_dt_camera" data="<?= $us_id ?>" data1="<?= $us_type ?>">
                        <div class="row-tin-dang-dau">
                            ...
                            <input type="text" class="dmuc-spham" readonly name="danhmucsanpham_dt" data="<?= $id_dm ?>" placeholder="Đồ điện tử >> Máy ảnh máy quay">
                        </div>
                        <div class="row-tin-dang box_input_infor">
                            <p class="font-dam hd_font15-17">Tiêu đề <span class="color_red">*</span></p>
                            <input class="input_infor_tag error" type="text" name="tieude_camera" value="<?= $row_tt['new_title'] ?>" placeholder="Nhập tiêu đề" autocomplete="off">
                        </div>
                        <div class="row-tin-dang box_input_infor">
                            ...
                            <select name="thietbi" class="slect-thietbi slect-thietbi-m-anh hd_height36" data="<?= $id_dm ?>" onchange="hang_doi(this)">
                                <option disabled value="">Thiết bị</option>
                        ...
                        <div class="row-tin-dang reder-field-hang dong_doi box_input_infor">
                            ...
                            <? if ($id_hang == 34) { ?>
                                <input type="text" name="hang_camera" class="hang_camera input_infor_tag" value="<?= $row_tt['hang'] ?>" autocomplete="off" placeholder="Nhập hãng ">
                            <? } else { ?>
