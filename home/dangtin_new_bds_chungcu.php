...
<head>
    ...
    <title>Đăng tin bất động sản chung cư</title>
        ...
        <form class="form-dtin-cont form_bds_chung" id="form_bds_chungcu" data="<?= $acc_id ?>" data1="<?= $acc_type ?>">
            <div class="container_content">
                ...
                <div class="ctn_ct_box1 d_flex fl_cl w100">
                    ...
                    <div class="ctn_ct_b1_fr2 w100">
                        <div class="b1_fr2_title w100">
                            <p class="b1_fr2_title_p p_400_s16_l19 d_flex fl_row al_ct" data="27">
                    ...
                    <div class="ctn_ct_b4_fr d_flex fl_row al_ct">
                        ...
                        <div class="ctn_ct_b4_fr2 box_input_infor">
                            <p class="b4_fr2_title p_400_s15_l18">
                                Địa chỉ căn hộ <span class="cl_red">*</span>
                            </p>
                            <input type="text" name="td_diachi_nha" class="td_ttin_diachi b4_fr2_input p_400_s14_l17 " placeholder="Địa chỉ căn hộ" autocomplete="off">
                        </div>
                    </div>
                </div>
                <!-- ----------------------------------------------------------------------box5--------------------------------------------------------------------- -->
                    ...
                    <div class="ctn_ct_b5_fr d_flex fl_cl">
                        <div class="ctn_ct_b5_fr_child d_flex fl_row al_ct">
                            ...
                            <div class="b5_fr2">
                                ...
                                <input type="text" name="td_block_thap" class="b5_fr2_input p_400_s14_l17 " placeholder="Block/Tháp" autocomplete="off">
                            </div>
                        </div>
                        <div class="b5_fr3">
                            <p class="b5_fr3_title p_400_s15_l18">
                                Tầng số
                            </p>
                            <input type="text" name="tangso" class="b5_fr3_input p_400_s14_l17 " placeholder="Tầng số" autocomplete="off" oninput="<?= $oninput ?>">
                        </div>
                    </div>
                ...
                <div class="ctn_ct_box6 d_flex fl_cl">
                    ...
                    <p class="ctn_ct_box6_tinhtrangbds p_400_s15_l18">
                        Tình trạng bất động sản <span class="cl_red">*</span>
                    </p>
                    <div class="ctn_ct_b6_box2 box_input_infor">
                        <div class="d_flex fl_row al_ct w100">
                            <div class="b6_box2_dabangiao d_flex fl_row al_ct">
                                <input type="radio" name="tinh_trang" value="1" class="b6_box2_dabangiao_ip img20">
                                <p class="b6_box2_dabangiao_text pdl_10 p_400_s14_l17">
                                    Đã bàn giao
                                </p>
                            </div>
                            <div class="b6_box2_chuabangiao d_flex fl_row al_ct">
                                <input type="radio" name="tinh_trang" value="2" class="b6_box2_chuabangiao_ip img20">
                    ...
                    <div class="ctn_ct_b6_box">
                        <div class="b6_box d_flex fl_cl box_input_infor">
                            <p class="b6_box_title p_400_s15_l18">
                                Loại hình căn hộ <span class="cl_red">*</span>
                            </p>
                    ...
                    <div class="ctn_ct_b7_ft d_flex fl_cl">
                        ...
                        <div class="b7_ft d_flex fl_row">
                            <div class="b7_ft1 d_flex fl_row al_ct">
                                <input name="td_cangoc" type="radio" value="1" class="b7_ft1_input img20 cursor_Pt">
                                <p class="b7_ft1_p p_400_s14_l17 pdl_10">Có</p>
                            </div>
                            <div class="b7_ft2 d_flex fl_row al_ct">
                                <input name="td_cangoc" type="radio" value="2" class="b7_ft2_input img20 cursor_Pt">
