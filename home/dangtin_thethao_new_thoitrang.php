...
if (isset($_COOKIE['UID']) && isset($_COOKIE['UT'])) {
    ...
    $acc_type = $_COOKIE['UT'];
    $id_cat_parent = 209;
    $sql_dm = new db_query("SELECT `tags_id`, `ten_tags` FROM `key_tags` WHERE id_danhmuc = 104");
...
<body>
    ...
    <section id="m_dangtin_thethao" class="thethao">
        ...
        <form class="form-dtin-cont form_bds_chung" id="form_thethaothoitrang" data="<?= $acc_id ?>" data1="<?= $acc_type ?>" data3="<?= $xacthuc_lket ?>">
            <div class="container_content">
                ...
                <div class="ctn_ct_box1 d_flex fl_cl w100">
                    ...
                    <div class="ctn_ct_b1_fr2 w100">
                        <div class="b1_fr2_title w100">
                            <p class="b1_fr2_title_p p_400_s16_l19 d_flex fl_row al_ct" data="104">
                                Thể thao <span class="d_flex fl_row al_ct pdl_5 pdr_5">
                                    <img src="/images/m_raonhanh_imgnew/double_angle.png" class="img_16">
                                </span> Thời trang thể thao
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="b6_monthethao d_flex fl_cl box_input_infor">
                    <p class="b6_mtt_txt p_400_s15_l18">
                        Môn thể thao <span class="cl_red">*</span>
                    </p>
                    <select class="slect-hang hd_height36 slect-hang mon_the_thao" name="mon_thethao">
                        ...
                        ?>
                            <option value="<?= $mon_tt['id'] ?>"><?= $mon_tt['ten_mon'] ?></option>
                        <? }
                        ?>
                    </select>
                </div>
                ...
                <div class="b6_loaihinh loai_dungcu d_flex fl_cl box_input_infor">
                    <p class="b6_lhinh_txt p_400_s15_l18">
                        Loại thời trang <span class="cl_red">*</span>
                    </p>
                    <select class="slect-hang hd_height36 b6_lhinh_select loai_thoitrang_ban" name="loai_thoitrang_ban">
                        <option value="">Loại thời trang</option>
                        <? foreach ($db_lchung as $lc) {
                            if ($lc['id_danhmuc'] == 104) {
                        ?>
                                <option value="<?= $lc['id'] ?>"><?= $lc['ten_loai'] ?></option>
                        <? }
                        } ?>
                    </select>
                </div>
    ...
    <script>
        $(".mon_the_thao").change(function() {
            ...
            var type = $("#form_thethaothoitrang").attr("data1");
            $.ajax({
        ...
        $(".b11_btn_dangtin").click(function() {
            ...
            if (form_thethaothoitrang.valid() === true) {
                ...
                var user_id = $("#form_thethaothoitrang").attr("data");
                var user_type = $("#form_thethaothoitrang").attr("data1");
                var id_dm = $(".b1_fr2_title_p").attr('data');
                ...
                var xac_thuc = $("#form_thethaothoitrang").attr("data3");
