...
<head>
    ...
    <title>Đăng tin sức khỏe sắc đẹp Thực phẩm chức năng</title>
        ...
        <div class="tindang-container">
            ...
            <div class="tindang-content-cont hd-disflex">
                ...
                <div class="tindang-col-right" data="<?= date('Y-m-d', time()) ?>">
                    <form class="form-dtin-cont" id="form_tpchucnang" data="<?= $acc_id ?>" data1="<?= $acc_type ?>">
                        <div class="row-tin-dang danhmuc_tt">
                            <p class="font-dam hd_font15-17">Danh mục sản phẩm <span class="color_red">*</span></p>
                            <input type="text" class="dmuc-spham" data="109" readonly name="san-pham-laptop" placeholder="Sức khỏe - Sắc đẹp >> Thực phẩm chức năng">
                        </div>
                        ...
                        <div class="row-tin-dang box_input_infor">
                            ...
                            <input class="input_infor_tag error" type="date" name="han_sd" placeholder="Nhập tiêu đề">
                        </div>
                        ...
                        <div class="box_input_infor mt20">
                            ...
                            <select class="slect-chitiet_dm hd_height36" style="width:100%" name="chitiet_dm">
                                ...
                                <?
                                $sql_dm = new db_query("SELECT `tags_id`, `ten_tags` FROM `key_tags` WHERE id_danhmuc = 109");
                        ...
                        <div class="row-tin-dang cont-btn-sb hd-disflex hide-480-mobile">
                            ...
                            <button type="button" id="xoa_tddang_tin" class="btn-submit td-dang-tin tpchucnang hd_cspointer font-bold">ĐĂNG TIN</button>
                        </div>
                    </form>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    $(".td-dang-tin").click(function() {
        ...
        if (form_tpchucnang.valid() === true) {
            ...
            $.ajax({
                url: '/ajax_sksd/dangtin_sksd_thucphamcn.php',
                type: 'POST',
                data: fd,
                contentType: false,
                processData: false,
                beforeSend: function() {
                    $('.tpchucnang').prop('disabled', true);
                },
                success: function(data) {
                    if (data == "") {
                        ...
                        $('.tpchucnang').prop('disabled', false);
                    }
                }
            })
        }
