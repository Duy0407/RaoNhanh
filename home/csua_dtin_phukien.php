...
<head>
    ...
    <title>Chỉnh sửa phụ kiện thể thao</title>
        ...
        <div class="tindang-container">
            ...
            <div class="tindang-content-cont hd-disflex">
                ...
                <div class="tindang-col-right" data="<?= $id_cs ?>">
                    <form class="form-dtin-cont" id="form_pkthethao" data="<?= $us_id ?>" data1="<?= $us_type ?>">
                        <div class="row-tin-dang danhmuc_tt">
                            <p class="font-dam hd_font15-17">Danh mục sản phẩm <span class="color_red">*</span></p>
                            <input type="text" class="dmuc-spham" readonly name="san-pham-laptop" data="<?= $id_dm ?>" placeholder="Thể thao >> Phụ kiện thể thao">
                        </div>
                        ...
                        <!-- loại phụ kiện, trạng thái người bán -->
                        <div class="d_flex j_between dangtin_tt_fl_des">
                            <div class="row-tin-dang rowflex2 box_input_infor loai_dungcu">
                                <p class="font-dam hd_font15-17">Loại phụ kiện <span class="color_red">*</span></p>
                                <? if ($id_monthethao != 8) { ?>
                                    <select class="slect-hang hd_height36 loai_dungcu_ban" name="loai_phukien_ban">
                        ...
                        <div class="box_input_infor ctiet_danhmuc mt20">
                            <? if ($id_monthethao == 3 || $id_monthethao == 4 || $id_monthethao == 8 || $id_monthethao == 7) { ?>
                        ...
                        <div class="row-tin-dang cont-btn-sb hd-disflex">
                            ...
                            <button type="button" class="btn-submit td-dang-tin pk_thethao hd_cspointer font-bold">ĐĂNG TIN</button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <script type="text/javascript">
        ...
        $(".pk_thethao").click(function() {
            ...
            form_pkthethao.validate({
                ...
                messages: {
                    ...
                    loai_phukien_ban: "Vui lòng chọn loại phụ kiện",
        ...
        $(".td-xem-truoc").click(function() {
            ...
            if (form_pkthethao.valid() === true) {
                ...
                var tieu_de = $("input[name='tieu_de']").val();
                var mon_the_thao = $("select[name='mon_thethao']").val();
                var loai_phukien_ban = $(".loai_phukien_ban").val();
                var tinhtrang_ban = $("select[name='tinhtrang_ban']").val();
