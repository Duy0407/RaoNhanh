   ...
   <div class="container">
    ...
    kiến trúc cổ.</a></h3>
     ...
     <div class="content col-9">
       <div class="ct_title">
         <p id="abc">CHỈNH SỬA TIN RAO VẶT</p>
       </div>
       <div class="clear"></div>
               ...
               <div class="box1_2">
                 <div class="category_select">
                     <div>
                         ...
                         <a target="_blank" id="menu_btn"><span><img src="../images/menu_icon.png" alt=""></span><div class="chon_danhmuc">CHON DANH MỤC</div></a>
                     </div>
...
<!--                       <td><span class="chon_goi_vip">CHỌN GÓI ĐĂNG TIN</span></td>-->
                 ...
                 <div class="contact_detail">
                   ...
                   <h5><input type="checkbox" class="check_box_user" value="1">Sử dụng thông tin đăng ký tài khoản để đăng tin:</h5>
