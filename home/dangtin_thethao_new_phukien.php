...
if (isset($_COOKIE['UID']) && isset($_COOKIE['UT'])) {
    ...
    $acc_type = $_COOKIE['UT'];
    $id_cat_parent = 209;
    $sql_dm = new db_query("SELECT `tags_id`, `ten_tags` FROM `key_tags` WHERE id_danhmuc = 105");
...
<body>
    ...
    <section id="m_dangtin_thethao" class="thethao">
        ...
        <form class="form-dtin-cont form_bds_chung" id="form_pkthethao" data="<?= $acc_id ?>" data1="<?= $acc_type ?>" data3="<?= $xacthuc_lket ?>">
            <div class="container_content">
                ...
                <div class="b6_loaihinh loai_dungcu d_flex fl_cl box_input_infor">
                    ...
                    <select class="slect-hang hd_height36 b6_lhinh_select loai_phukien_ban" name="loai_phukien_ban">
