...
if (isset($_COOKIE['UID']) && isset($_COOKIE['UT']) && $id_cs != 0 && $id_dm != 0) {
    ...
    if (mysql_num_rows($check_tind->result) > 0) {
        ...
        $list_tm = new db_query("SELECT `id`, `ten_loai`  FROM `loai_chung` WHERE `id_danhmuc` = $id_dm ");
            ...
            <div class="tindang-container">
                ...
                <div class="tindang-content-cont hd-disflex">
                    ...
                    <div class="tindang-col-right" data="<?= $id_cs ?>">
                        <form class="form-dtin-cont" id="form_doco" data="<?= $us_id ?>" data1="<?= $us_type ?>">
                            <div class="row-tin-dang danhmuc_tt">
                                <p class="font-dam hd_font15-17">Danh mục sản phẩm <span class="color_red">*</span></p>
                                <input type="text" class="dmuc-spham" readonly name="san-pham-laptop" data="<?= $id_dm ?>" placeholder="Dịch vụ - Giải trí >> Đồ sưu tầm, đồ cổ">
                            </div>
                            <div class="row-tin-dang box_input_infor">
                                <p class="font-dam hd_font15-17">Tiêu đề <span class="color_red">*</span></p>
                                <input class="input_infor_tag error" type="text" name="tieu_de" autocomplete="off" value="<?= $row_tt['new_title'] ?>" placeholder="Nhập tiêu đề">
                            </div>
                            <div class="row-tin-dang box_input_infor">
                                ...
                                <select class="slect-hang  hd_height36" name="loai_san_pham">
                                    ...
                                    <? while ($row_l = mysql_fetch_assoc($list_tm->result)) { ?>
                                        <option value="<?= $row_l['id'] ?>" <?= ($row_tt['loai_chung'] == $row_l['id']) ? "selected" : "" ?>><?= $row_l['ten_loai'] ?></option>
                                    <? } ?>
                                </select>
                            </div>
                            <div class="row-tin-dang box_input_infor">
                            ...
                            <div class="row-tin-dang cont-btn-sb hd-disflex">
                                ...
                                <button type="button" class="btn-submit td-dang-tin dt_doco hd_cspointer font-bold">ĐĂNG TIN</button>
                            </div>
                        </form>
                    </div>
                </div>
    ...
    <script>
        $(".dt_doco").click(function() {
            ...
            if (form_doco.valid() === true) {
                ...
                $.ajax({
                    type: 'POST',
                    url: '/ajax_dvgiaitri/csua_doco.php',
                    data: fd,
                    processData: false,
                    contentType: false,
