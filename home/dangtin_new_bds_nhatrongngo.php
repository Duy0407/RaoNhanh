...
if (isset($_COOKIE['UID']) && isset($_COOKIE['UT'])) {
    ...
    // tag danh muc
    $ban = new db_query("SELECT `tags_id`, `ten_tags` ,`type_tags` FROM `key_tags` WHERE `id_danhmuc` = 26 AND type_tags = 1");
...
<head>
    ...
    <title>Đăng tin bất động sản nhà trong ngõ</title>
                ...
                <div class="ctn_ct_box1 d_flex fl_cl w100">
                    ...
                    <div class="ctn_ct_b1_fr2 w100">
                        <div class="b1_fr2_title w100">
                            <p class="b1_fr2_title_p p_400_s16_l19 d_flex fl_row al_ct" data="26">
    ...
    <script>
        ...
        $(".b11_btn_dangtin").click(function() {
            ...
            if (form_bds_nhatrongngo.valid() === true) {
                ...
                $.ajax({
                    url: '/ajax_bds/dangtin_bdsnhatrongngo.php',
                    type: 'POST',
                    data: fd,
                    contentType: false,
                    processData: false,
