...
<head>
    ...
    <title>Đăng tin bất động sản nhà trong ngõ</title>
        ...
        <div class="tindang-container">
            ...
            <div class="tindang-content-cont hd-disflex">
                ...
                <div class="tindang-col-right">
                    <form class="form-dtin-cont" id="form_bds_nhatrongngo" data="<?= $acc_id ?>" data1="<?= $acc_type ?>">
                        <div class="row-tin-dang danhmuc_tt">
                            <p class="font-dam hd_font15-17">Danh mục sản phẩm <span class="color_red">*</span></p>
                            <input type="text" class="dmuc-spham" data="26" readonly name="san-pham-laptop" placeholder="Bất động sản >> Nhà trong ngõ">
                        </div>
...
<script>
    ...
    $(".td-dang-tin").click(function() {
        ...
        if (form_bds_nhatrongngo.valid() === true) {
            ...
            var ban_thue = $("select[name='ban_thue']:checked").val();
