...
if (isset($_COOKIE['UID']) && isset($_COOKIE['UT'])) {
    ...
    $querypk = new db_query("SELECT id, ten_loai FROM `loai_chung` WHERE `id_danhmuc` = $id and `id_cha` = 0 ");
...
<head>
    ...
    <title>Đăng tin đồ tiện tử phụ kiện</title>
                ...
                <div class="ctn_ct_box6 d_flex fl_cl">
                    ...
                    <div class="ctn_ct_b6_fr d_flex fl_row fl_st">
                        <div class="b6_fr1 d_flex fl_cl box_input_infor">
                            ...
                            <select class="b6_fr1_select slect-hang hd_height36" name="phu_kien" data="<?= $id ?>" onchange="hang_doi(this), lpkien_doi(this)">
