        ...
        <div class="tindang-container">
            ...
            <div class="tindang-content-cont hd-disflex">
                ...
                <div class="tindang-col-right">
                    <form class="form-dtin-cont" id="form_thucung_meo" data="<?= $acc_id ?>" data1="<?= $acc_type ?>">
                        <div class="row-tin-dang danhmuc_tt">
                            <p class="font-dam hd_font15-17">Danh mục sản phẩm <span class="color_red">*</span></p>
                            <input type="text" class="dmuc-spham" data="112" readonly name="san-pham-laptop" placeholder="Thú cưng >> Mèo">
                        </div>
                        ...
                        <div class="row-tin-dang box_input_infor">
                            ...
                            <select class="slect-hang  hd_height36" name="giong_thucung">
                                ...
                                <? foreach ($result_meo as $meo) : ?>
                                    <option value="<?= $meo['id'] ?>"><?= $meo['giong_thucung'] ?></option>
                                <? endforeach ?>
                            </select>
                        </div>
                        <div class="row-tin-dang box_input_infor">
                        ...
                        <div class="row-tin-dang">
                            ...
                            <div class="input-gia-cont">
                                <div class="box_input_infor">
                                    <input class="input_infor_tag error" type="text" name="td_gia_spham" onkeyup="format_gtri(this)" placeholder="" autocomplete="off" oninput="<?= $oninput ?>" id="gia-ban-sp" onkeydown="javascript: return ['Backspace','Delete','ArrowLeft','ArrowRight'].includes(event.code) ? true : !isNaN(Number(event.key)) && event.code!=='Space'">
                                </div>
                        ...
                        <div class="box_input_infor mt20">
                            ...
                            <select class="slect-chitiet_dm hd_height36" style="width:100%" name="chitiet_dm">
                                ...
                                <?
                                $sql_dm = new db_query("SELECT `tags_id`, `ten_tags` FROM `key_tags` WHERE id_danhmuc = 112 AND id_parent = 0");
                        ...
                        <div class="row-tin-dang cont-btn-sb hd-disflex hide-480-mobile">
                            ...
                            <button type="button" id="xoa_tddang_tin" class="btn-submit td-dang-tin thucung_meo hd_cspointer font-bold">ĐĂNG TIN</button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    $(".td-dang-tin").click(function() {
        ...
        if (form_thucung_meo.valid() === true) {
            ...
            $.ajax({
                ...
                processData: false,
                beforeSend: function() {
                    $('.thucung_meo').prop('disabled', true);
                },
                success: function(data) {
                    if (data == "") {
                        ...
                        $('.thucung_meo').prop('disabled', false);
                    }
                }
            })
        }
