        ...
        <div class="tindang-container">
            ...
            <div class="tindang-content-cont hd-disflex">
                ...
                <div class="tindang-col-right">
                    <form class="form-dtin-cont" id="form_xeco_car" data="<?= $acc_id ?>" data1="<?= $acc_type ?>">
                        <div class="row-tin-dang danhmuc_tt">
                            <p class="font-dam hd_font15-17">Danh mục sản phẩm <span class="color_red">*</span></p>
                            <input type="text" class="dmuc-spham" data="10" readonly name="san-pham-laptop" placeholder="Xe cộ  >>  Ô tô">
                        </div>
                        ...
                        <div class="row-tin-dang box_input_infor">
                            ...
                            <select class="slect-hang  hd_height36" name="hop_so">
                                <option disabled selected value="">Hộp số</option>
                                <option value="1">Tự động</option>
                                <option value="2">Số sàn</option>
                                <option value="3">Bán tự động</option>
                            </select>
                        </div>
                        <div class="row-tin-dang box_input_infor">
                        ...
                        <div class="nhom-tin-dang row-tin-dang j_cont ">
                        ...
                        <div class="row-tin-dang">
                            ...
                            <select class="slect-hang  hd_height36" name="bao_hanh">
                                ...
                                <? foreach ($result_bh as $tr) : ?>
                                    <option value="<?= $tr['id_baohanh'] ?>"><?= $tr['tgian_baohanh'] ?></option>
                                <? endforeach ?>
                            </select>
                        </div>
                        <div class="row-tin-dang box_input_infor">
                        ...
                        <div class="sokm_show" hidden>
                            <div class="row-tin-dang">
                                ...
                                <input class="so_km_di" type="text" name="km_di" placeholder="Số km đã đi" onkeydown="javascript: return ['Backspace','Delete','ArrowLeft','ArrowRight'].includes(event.code) ? true : !isNaN(Number(event.key)) && event.code!=='Space'">
                            </div>
                        </div>
                        ...
                        <div class="row-tin-dang cont-btn-sb hd-disflex">
                            ...
                            <button type="button" id="xoa_tddang_tin" class="btn-submit dangtin_oto td-dang-tin hd_cspointer font-bold">ĐĂNG TIN</button>
                        </div>
                    </form>
                </div>
            </div>
