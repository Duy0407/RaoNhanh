...
<head>
    ...
    <title>Đăng tin tìm việc làm</title>
            ...
            <div class="dang-tin-uv">
                ...
                <div class="dang-tin-uv-nd">
                    <div class="dang-tin-uv-trai">
                        <div class="dang-tin-uv-trai-upload">
                        ...
                        <div class="after-upload-video">
                            <div class="dang-tin-video-after hd-textalign hd_cspointer hd-disflex">
                                ...
                                <div class="avt_xoavideo" data="">
                                    <img width="86px" height="86px" style="border-radius:5px" id="video_chon" controls class="continue_upload_video d_none" src="">
                    ...
                    <form class="dang-tin-uv-phai" id="form_tim_viec">
                        ...
                        <div class="dang-tin-1">
                            ...
                            <input class="input-1" type="text" name="title" id="" placeholder="VD: Tìm việc làm kế toán tổng hợp">
                        </div>
                        <div class="dang-tin-1">
                            <p class="thong-tin">Địa chỉ <span class="color_red">*</span></p>
                            <input readonly class="diadiem_lamviec input-1" type="text" name="td_diachi_lamviec" id="dia_chi" placeholder="Chọn địa chỉ">
                        </div>
                        <div class="dang-tin-1">
                        ...
                        <div class="dang-tin-1">
                            ...
                            <input class="input-1" type="text" name="age" id="" placeholder="Nhập tuổi">
                        </div>
                        <div class="dang-tin-1">
                        ...
                        <div class="dang-tin-1">
                            ...
                            <input class="input-1" type="text" name="chungchi" id="" placeholder="Nhập chứng chỉ">
                        </div>
                        <div class="dang-tin-1">
                        ...
                        <div class="dang-tin-1">
                            ...
                            <textarea class="input-3" name="mota" id="" placeholder="Giới thiệu về bản thân ứng viên"></textarea>
                        </div>
                        <div class="dang-tin-1">
