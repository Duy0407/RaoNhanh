...
<head>
    ...
    <title>Đăng tin đồ dùng văn phòng</title>
    ...
    <link type="text/css" rel="stylesheet" href="/css/style_new/select2.min.css" />
        ...
        <div class="tindang-container">
            ...
            <div class="tindang-content-cont hd-disflex">
                ...
                <div class="tindang-col-right">
                    <form class="form-dtin-cont" id="form_dodung_vanphong" data="<?= $us_id ?>" data1="<?= $us_type ?>">
                        <div class="row-tin-dang danhmuc_tt">
                            <p class="font-dam hd_font15-17">Danh mục sản phẩm <span class="color_red">*</span></p>
                            <input type="text" class="dmuc-spham" readonly name="san-pham-laptop" data="<?= $id ?>" placeholder="Đồ dùng văn phòng, công nông nghiệp  >>  Đồ dùng văn phòng">
                        </div>
                        ...
                        <div class="row-tin-dang cont-btn-sb hd-disflex hide-480-mobile">
                            ...
                            <button type="button" id="xoa_tddang_tin" class="btn-submit td-dang-tin dodung_vanphong hd_cspointer font-bold">ĐĂNG TIN</button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <script type="text/javascript">
        $(".td-dang-tin").click(function() {
            ...
            if (form_dodung_vanphong.valid() === true) {
                ...
                $.ajax({
                    type: 'POST',
                    url: '/ajax_ddcnn/dtin_ddvphong.php',
                    data: fd,
                    processData: false,
                    contentType: false,
                    beforeSend: function() {
                        $('.dodung_vanphong').prop('disabled', true);
                    },
                    success: function(data) {
                        if (data == "") {
                            ...
                            $('.dodung_vanphong').prop('disabled', false);
                        }
                    }
                })
            }
