...
if (isset($_COOKIE['UID']) && isset($_COOKIE['UT'])) {
    $acc_id = $_COOKIE['UID'];
    $acc_type = $_COOKIE['UT'];
    $sql_dm = new db_query("SELECT `tags_id`, `ten_tags` FROM `key_tags` WHERE id_danhmuc = 116");
...
<body>
    ...
    <section id="m_dangtin_vanphongcnn" class="suckhoe vanphongcnn">
        ...
        <form class="form-dtin-cont form_bds_chung" id="form_dodung_vanphong" data="<?= $acc_id ?>" data1="<?= $acc_type ?>" data3="<?= $xacthuc_lket ?>">
    ...
    <script>
        $(".b11_btn_dangtin").click(function() {
            ...
            if (form_dodung_vanphong.valid() === true) {
                ...
                var xac_thuc = $("#form_dodung_vanphong").attr("data3");
