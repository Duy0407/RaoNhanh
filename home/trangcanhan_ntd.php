...
<head>
    ...
    <title>Trang cá nhân <?= $rowui['usc_name'] ?> - <?=$ntd?></title>
    <meta name="robots" content="noindex,nofollow"/>
    <meta name="google-site-verification" content="8HoYLGUD3DXbNpPr7JHZjAxMghKbHnuSClcHal7OnRA" />
    <link rel="canonical" href="https://raonhanh365.vn/trang-ca-nhan-<?= replaceTitle($rowui['usc_name']) ?>-ntd<?=$ntd?>.html" />
    <meta name="description" content="Trang cá nhân của <?= $rowui['usc_name'] ?> - <?=$ntd?> đang có nhu cầu tuyển dụng và tìm việc làm. Tham khảo ngay"/>
    <meta name="Keywords" content="Trang cá nhân của <?= $rowui['usc_name'] ?> - <?=$ntd?>"/>

    <meta property="og:locale" content="vi_VN" />
    <meta property="og:type" content="website" />
    <meta property="og:title" content="Trang cá nhân <?= $rowui['usc_name'] ?> - <?=$ntd?>"/>
    <meta property="og:description" content="Trang cá nhân của <?= $rowui['usc_name'] ?> - <?=$ntd?> đang có nhu cầu tuyển dụng và tìm việc làm. Tham khảo ngay"/>
    <meta property="og:site_name" content="raonhanh365.vn" />

    <meta name="twitter:card" content="summary" />
    <meta name="twitter:description" content="Trang cá nhân của <?= $rowui['usc_name'] ?> - <?=$ntd?> đang có nhu cầu tuyển dụng và tìm việc làm. Tham khảo ngay" />
    <meta name="twitter:title" content="Trang cá nhân <?= $rowui['usc_name'] ?> - <?=$ntd?>" />
                ...
                <div class="stutus">
                    ...
                    <div class="item">
                        <div class="item-01">
                            ...
                            {
                            ?>
                            <a class="showpp" href="javascript:void(0)" onclick="show_reg(this,'popup-login')">
                                <div class="showname">
                                    <div class="images">
            ...
            <div class="tabcontent" id="thongtincanhan">
                ...
                <div class="thongtin panel" id="Danhgia">
                    <div class="content dgia">
                        ...
                        <div class="danh_gia">
                            <div class="images">
                                <img onerror='this.onerror=null;this.src="/images/icon_raonhanh.png";' class="lazyload" src="/images/loading.gif" data-src="<?= $rowdg['usc_logo']?>" alt="avarta">
                            </div>
    ...
    <div class="popup" id="popup1" style="display: none;">
        <div class="modal-content">
            ...
            <form id="ratingForm" method="post">
                ...
                <div class="btn-rate">
                    <button type="submit" name="btn_rating" id="btn_rating" class="submit clearfix" >Đánh giá</button>
