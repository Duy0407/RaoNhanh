...
if (isset($_COOKIE['UID']) && isset($_COOKIE['UT'])) {
    ...
    $acc_type = $_COOKIE['UT'];
    $id_cat_parent = 209;
    $sql_dm = new db_query("SELECT `tags_id`, `ten_tags` FROM `key_tags` WHERE id_danhmuc = 75");
...
<body>
    ...
    <section id="m_dangtin_thethao" class="thethao">
        ...
        <form class="form-dtin-cont form_bds_chung" id="form_dcuthethao" data="<?= $acc_id ?>" data1="<?= $acc_type ?>" data3="<?= $xacthuc_lket ?>">
            <div class="container_content">
                ...
                <div class="b6_loaihinh loai_dungcu d_flex fl_cl box_input_infor">
                    <p class="b6_lhinh_txt p_400_s15_l18">
                        Loại dụng cụ <span class="cl_red">*</span>
                    </p>
                    <select class="slect-hang hd_height36 b6_lhinh_select loai_dungcu_ban" name="loai_dungcu_ban">
    ...
    <script>
        ...
        $(".b11_btn_dangtin").click(function() {
            ...
            if (form_dcuthethao.valid() === true) {
                ...
                var id_dm = $(".b1_fr2_title_p").attr('data');
                var user_id = $("#form_dcuthethao").attr("data");
                var user_type = $("#form_dcuthethao").attr("data1");
                var tieu_de = $("input[name='tieu_de']").val();
                var mon_the_thao = $("select[name='mon_thethao']").val();
                var loai_dungcu = $("select[name='loai_dungcu_ban']").val();
                ...
                var xac_thuc = $("#form_dcuthethao").attr("data3");
    ...
    <script>
        ...
        function xem_trc_tin() {
            var form_dcuthethao = $(".form-dtin-cont");
            form_dcuthethao.validate({
                errorPlacement: function(error, element) {
                    error.appendTo(element.parents(".box_input_infor"));
                    error.wrap("<span class='error'>");
