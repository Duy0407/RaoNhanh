...
if (isset($_COOKIE['UID']) && isset($_COOKIE['UT'])) {
    ...
    $sql_dm = new db_query("SELECT `tags_id`, `ten_tags` FROM `key_tags` WHERE id_danhmuc = 41");
...
<head>
    ...
    <title>Đăng tin xe cộ xe máy điện</title>
...
<body>
    ...
    <!-- content -->
    <section id="m_dangtin_xc_xemaydien" class="xeco">
        <div class="container_title">
            <p class="ctn_tt_p p_600_s24_l28">Đăng tin</p>
        </div>
        <form class="form-dtin-cont form_bds_chung" id="form_xeco_xemaydien" data="<?= $acc_id ?>" data1="<?= $acc_type ?>" data3="<?= $xacthuc_lket ?>">
                ...
                <div class="ctn_ct_box6 d_flex fl_cl">
                        ...
                        <div class="b6_fr2 d_flex fl_cl box_input_infor">
                            ...
                            <select class="b6_hangxe_select slect-hang hd_height36" name="dong_co">
                                ...
                                <? foreach ($db_dluong as $dc) {
                                    if ($dc['id_danhmuc'] == 41) {
                                ?>
                                        <option class="p_400_s14_l17" value="<?= $dc['id_dl'] ?>"> <?= $dc['ten_dl'] ?></option>
                                <? }
                                } ?>
                            </select>
                        </div>
                    ...
                    <div class="ctn_ct_b6_bs">
                        <div class="b6_bs_biensoxe">
                            ...
                            <input type="text" name="td_bien_soxe" class="b6_bs_biensoxe_input p_400_s14_l17" placeholder="Biển số xe">
                        </div>
                    </div>
                    <div class="ctn_ct_b6_tinhtrang d_flex fl_cl">
                        ...
                        <div class="b6_tinhtrang_fr d_flex fl_row">
                            <div class="b6_tinhtrang_cu d_flex fl_row">
                                ...
                                <p class="b6_tinhtrang_cu_text pdl_10 p_400_s14_l17">Cũ</p>
                            </div>
                            <div class="b6_tinhtrang_moi d_flex fl_row">
                                ...
                                <p class="b6_tinhtrang_moi_text pdl_10 p_400_s14_l17">Mới</p>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        $(".b11_btn_dangtin").click(function() {
            ...
            if (form_xeco_xemaydien.valid() === true) {
                ...
                var xac_thuc = $("#form_xeco_xemaydien").attr("data3");
                ...
                $.ajax({
                    url: '/ajax_xeco/dangtin_xeco_xedapdien.php',
                    type: 'POST',
                    data: fd,
                    contentType: false,
                    processData: false,
