...
<head>
    ...
    <title>Đăng tin nội thất ô tô</title>
        ...
        <div class="tindang-container">
            ...
            <div class="tindang-content-cont hd-disflex">
                ...
                <div class="tindang-col-right">
                    <form class="form-dtin-cont" id="form_xeco_noithatoto" data="<?= $acc_id ?>" data1="<?= $acc_type ?>">
                        <div class="row-tin-dang danhmuc_tt">
                            <p class="font-dam hd_font15-17">Danh mục sản phẩm <span class="color_red">*</span></p>
                            <input type="text" class="dmuc-spham" data="42" readonly name="san-pham-laptop" placeholder="Xe cộ  >>  Nội thất ô tô">
                        </div>
                        ...
                        <div class="row-tin-dang box_input_infor">
                            ...
                            <select class="slect-hang  hd_height36" name="loai_noi_that">
                                <option disabled selected value="">Loại nội thất</option>
                                <?
                                ...
                                <? foreach ($result_nt as $nt) : ?>
                                    <option value="<?= $nt['id'] ?>"><?= $nt['ten_loai'] ?></option>
                                <? endforeach ?>
                            </select>
                        </div>
                        <div class="row-tin-dang box_input_infor">
                        ...
                        <div class="row-tin-dang box_input_infor">
                            ...
                            <select class="slect-chitiet_dm hd_height36" style="width:100%" name="chitiet_dm">
                                ...
                                <?
                                $sql_dm = new db_query("SELECT `tags_id`, `ten_tags` FROM `key_tags` WHERE id_danhmuc = 42");
                        ...
                        <div class="row-tin-dang cont-btn-sb hd-disflex">
                            ...
                            <button type="button" id="xoa_tddang_tin" class="btn-submit dt_noithat td-dang-tin hd_cspointer font-bold">ĐĂNG TIN</button>
                        </div>
                    </form>
                </div>
            </div>
...
<script>
    $(".td-dang-tin").click(function() {
        ...
        if (form_xeco_noithatoto.valid() === true) {
            ...
            $.ajax({
                url: '/ajax_xeco/dangtin_xeco_notthat.php',
                type: 'POST',
                data: fd,
                contentType: false,
                processData: false,
                beforeSend: function() {
                    $('.dt_noithat').prop('disabled', true);
                },
                success: function(data) {
                    if (data == "") {
                        ...
                        $('.dt_noithat').prop('disabled', false);
                    }
                }
            })
        }
