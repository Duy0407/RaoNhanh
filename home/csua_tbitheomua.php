...
if (isset($_COOKIE['UID']) && isset($_COOKIE['UT']) && $id_cs != 0 && $id_dm != 0) {
    ...
    if (mysql_num_rows($check_tind->result) > 0) {
        $list_tt = new db_query("SELECT n.`new_title`, n.`new_money`, n.`gia_kt`, n.`new_cate_id`, n.`new_city`, n.`new_image`, n.`new_unit`, n.`new_tinhtrang`,
                                ...
                                d.`new_description`, d.`loai_thiet_bi`, n.`new_phone`, n.`new_email`
        ...
        <div class="tindang-container">
            ...
            <div class="tindang-content-cont hd-disflex">
                ...
                <div class="tindang-col-right" data="<?= $id_cs ?>">
                    <form class="form-dtin-cont" id="form_tb_theomua" data="<?= $us_id ?>" data1="<?= $us_type ?>">
                        <div class="row-tin-dang danhmuc_tt">
                            <p class="font-dam hd_font15-17">Danh mục sản phẩm <span class="color_red">*</span></p>
                            <input data="<?= $id_dm ?>" type="text" class="dmuc-spham" readonly name="san-pham-laptop" placeholder="Đồ gia dụng  >>  Thiết bị theo mùa">
                        </div>
                        <div class="row-tin-dang box_input_infor">
                            <p class="font-dam hd_font15-17">Tiêu đề <span class="color_red">*</span></p>
                            <input class="input_infor_tag error" value="<?= $row_tt['new_title'] ?>" type="text" name="tieu_de" placeholder="Nhập tiêu đề" autocomplete="off">
                        </div>

                        <div class="row-tin-dang box_input_infor">
                            <p class="font-dam hd_font15-17">Loại thiết bị<span class="color_red">*</span></p>
                            <select class="slect-hang loai_thiet_bi hd_height36" name="loai_thiet_bi" data="<?= $id_dm ?>" onchange="tags_doi(this)">
                                <option disabled value="">Loại thiết bị</option>
                                <? while ($row_nhom = mysql_fetch_assoc($list_nhom->result)) { ?>
                                    <option value="<?= $row_nhom['id'] ?>" <?= ($row_nhom['id'] == $thiet_bi) ? "selected" : "" ?>><?= $row_nhom['name'] ?></option>
                                <? } ?>
                            </select>
                        </div>
                        <div class="row-tin-dang box_input_infor">
                        ...
                        <div class="row-tin-dang cont-btn-sb hd-disflex hide-480-mobile">
                            ...
                            <button type="button" class="btn-submit td-dang-tin tb_theomua hd_cspointer font-bold">ĐĂNG TIN</button>
                        </div>
                    </form>
                </div>
            </div>
...
<script>
    $(".tb_theomua").click(function() {
        ...
        if (form_tb_theomua.valid() === true) {
            ...
            $.ajax({
                type: 'POST',
                url: '/ajax_dogiadung/csua_tbitheomua.php',
                data: fd,
                processData: false,
                contentType: false,
