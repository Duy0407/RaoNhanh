...
if (isset($_COOKIE['UID']) && isset($_COOKIE['UT'])) {
    ...
    $list_dh = new db_query("SELECT `dh_id`,`id_nguoi_dh`, `id_nguoi_ban`, `id_spham`, `ghi_chu`, `loai_ttoan`, `tien_ttoan`, `dia_chi_nhanhang`, `trang_thai`,
                            ...
                            WHERE `trang_thai` = 2 AND `id_nguoi_dh` = $id_user ORDER BY `tgian_giaohang` DESC ");
                                    ...
                                    <div class="box-right-content-bot">
                                        <div class="bot-l">
                                            ...
                                            <div class="content-bot-c">
                                                <a href="/chi-tiet-don-dang-giao-nguoi-mua-<?= $row_tin['dh_id'] ?>.html" class="ten_sp color_orange"><?= $row_tin['new_title'] ?></a>
    ...
    <div id="modal-huydon" class="modal">
        <div class="modal-content-huydon">
            ...
            <div class="huydon-footer">
                ...
                <button type="button" class="modal-btn-xacnhan" id="xacnhan_huydon">Xác nhận</button>
            </div>
        </div>
    </div>
    ...
    <div id="modal-giaohang-thatbai" class="modal giao_hang_that_bai">
        <div class="modal-content-huydon">
            ...
            <div class="huydon-footer">
                ...
                <a href="quan-ly-don-hang-dang-giao.html"><button type="button" class="modal-btn-xacnhan" id="">Xác nhận</button></a>
            </div>
        </div>
    </div>
