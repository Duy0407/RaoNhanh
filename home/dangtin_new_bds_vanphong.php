...
if (isset($_COOKIE['UID']) && isset($_COOKIE['UT'])) {
    ...
    // tag danh muc
    $ban = new db_query("SELECT `tags_id`, `ten_tags` ,`type_tags` FROM `key_tags` WHERE `id_danhmuc` = 34 AND type_tags = 1");
...
<head>
    ...
    <title>Đăng tin bất động sản văn phòng</title>
                ...
                <div class="ctn_ct_box1 d_flex fl_cl w100">
                    ...
                    <div class="ctn_ct_b1_fr2 w100">
                        <div class="b1_fr2_title w100">
                            <p class="b1_fr2_title_p p_400_s16_l19 d_flex fl_row al_ct" data="34">
                    ...
                    <div class="ctn_ct_b6_box">
                        <div class="b6_box d_flex fl_cl box_input_infor">
                            <p class="b6_box_title p_400_s15_l18">
                                Loại hình văn phòng <span class="cl_red">*</span>
                            </p>
                            <select class="slect-hang  hd_height36" name="loaihinh">
                                <option disabled selected value="">Chọn</option>
                                <option value="1">Mặt bằng kinh doanh</option>
                                <option value="2">Văn phòng</option>
                                <option value="3">Shophouse</option>
                                <option value="4">Officetel</option>
                            </select>
                        </div>
                    ...
                    <div class="ctn_ct_b8_fr d_flex fl_row ">
                        <div class="b8_fr1 d_flex fl_cl box_input_infor">
                            ...
                            <div class="b8_fr1_content d_flex fl_row jtf_spb">
                                <input name="dientich" type="text" class="b8_fr1_input p_400_s14_l17" autocomplete="off" placeholder="Diện tích">
    ...
    <script>
        ...
        $(".b11_btn_dangtin").click(function() {
            ...
            if (form_bds_vanphong.valid() === true) {
                ...
                $.ajax({
                    url: '/ajax_bds/dangtin_bdsvanphong.php',
                    type: 'POST',
                    data: fd,
                    contentType: false,
                    processData: false,
