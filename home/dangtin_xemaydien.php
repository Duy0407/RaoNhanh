...
<head>
    ...
    <title>Đăng tin xe máy điện</title>
        ...
        <div class="tindang-container">
            ...
            <div class="tindang-content-cont hd-disflex">
                ...
                <div class="tindang-col-right">
                    <form class="form-dtin-cont" id="form_xeco_xemaydien" data="<?= $acc_id ?>" data1="<?= $acc_type ?>">
                        <div class="row-tin-dang danhmuc_tt">
                            <p class="font-dam hd_font15-17">Danh mục sản phẩm <span class="color_red">*</span></p>
                            <input type="text" class="dmuc-spham" data="41" readonly name="san-pham-laptop" placeholder="Xe cộ  >>  Xe máy điện">
                        </div>
                        ...
                        <div class="row-tin-dang">
                            ...
                            <select class="slect-hang  hd_height36" name="dong_co">
                                ...
                                <? while ($row_dongco = mysql_fetch_assoc($list_dongco->result)) { ?>
                                    <option value="<?= $row_dongco['id_dl'] ?>"><?= $row_dongco['ten_dl'] ?></option>
                                <? } ?>
                            </select>
                        </div>
                        <div class="row-tin-dang">
                        ...
                        <div class="row-tin-dang cont-btn-sb hd-disflex">
                            ...
                            <button type="button" id="xoa_tddang_tin" class="btn-submit xemaydien td-dang-tin hd_cspointer font-bold">ĐĂNG TIN</button>
                        </div>
                    </form>
                </div>
            </div>
...
<script>
    $(".td-dang-tin").click(function() {
        ...
        if (form_xeco_xemaydien.valid() === true) {
            ...
            $.ajax({
                url: '/ajax_xeco/dangtin_xeco_xemaydien.php',
                type: 'POST',
                data: fd,
                contentType: false,
                processData: false,
                beforeSend: function() {
                    $('.xemaydien').prop('disabled', true);
                },
