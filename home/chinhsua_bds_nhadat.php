 ...
 <head>
     ...
     <title>Chỉnh sửa tin bất động sản nhà đất</title>
                 ...
                 <div class="tindang-col-right">
                     <form class="form-dtin-cont" id="form_bds_nhadat" data="<?= $acc_id ?>" data1="<?= $acc_type ?>" data2="<?= $id_nd ?>">
                         <div class="row-tin-dang danhmuc_tt">
                             ...
                             <input type="text" class="dmuc-spham" readonly name="san-pham-laptop" placeholder="Bất động sản >> Nhà đất">
                         </div>
                         <div class="row-tin-dang box_input_infor">
                             ...
                             <select class="slect-hang banthue hd_height36" name="ban_thue">
                                 ...
                                 <option value="1" <? if ($sql_des['can_ban_mua'] == 1) echo 'selected' ?>>Cần bán
                                 </option>
                                 <option value="2" <? if ($sql_des['can_ban_mua'] == 2) echo 'selected' ?>>Cho thuê
                                 </option>
                             </select>
                         </div>
                         <div class="row-tin-dang box_input_infor">
                             <p class="font-dam hd_font15-17">Tiêu đề <span class="color_red">*</span></p>
                             <input class="input_infor_tag" type="text" name="tieu_de" autocomplete="off" placeholder="Nhập tiêu đề" value="<?= $sql_nd['new_title'] ?>">
                         </div>
                             ...
                             <div class="row-dang-tin-nd">
                                 ...
                                 <div class="d_flex j_between d_so_sl_sotang">
                                     ...
                                     <div class="row-tin-dang rowflex2">
                                         ...
                                         <select class="slect-hang  hd_height36" name="huong_cua">
                                             ...
                                             <option value="2" <? if ($sql_des['huong_chinh'] == 2) echo 'selected' ?>>Tây
                                             </option>
                                             <option value="3" <? if ($sql_des['huong_chinh'] == 3) echo 'selected' ?>>Nam
                                             </option>
                                             <option value="4" <? if ($sql_des['huong_chinh'] == 4) echo 'selected' ?>>Bắc
                                             </option>
                                             ...
                                             <option value="7" <? if ($sql_des['huong_chinh'] == 7) echo 'selected' ?>>Tây
                                                 bắc </option>
                                             <option value="8" <? if ($sql_des['huong_chinh'] == 8) echo 'selected' ?>>Tây
                                                 nam </option>
                                         </select>
                                     </div>
                                 </div>
                                 <div class="d_flex j_between d_so_sl_sotang">
                                     <div class="row-tin-dang rowflex2 box_input_infor">
                                         <p class="font-dam hd_font15-17">Số phòng ngủ <span class="color_red">*</span>
                                         </p>
                                     ...
                                     <div class="row-tin-dang rowflex2">
                                         <p class="font-dam hd_font15-17">Số phòng vệ sinh </p>
                                     ...
                                     <div class="row-tin-dang rowflex2">
                                         ...
                                         <select class="slect-hang  hd_height36" name="tinhtrangnt">
                                             ...
                                             <option value="1" <? if ($sql_des['tinh_trang_noi_that'] == 1)
                                                                    echo 'selected' ?>>Nội thất cao cấp</option>
                                             <option value="2" <? if ($sql_des['tinh_trang_noi_that'] == 2)
                                                                    echo 'selected' ?>>Nội thất đầy đủ</option>
                                             <option value="3" <? if ($sql_des['tinh_trang_noi_that'] == 3)
                                                                    echo 'selected' ?>>Hoàn thiện cơ bản</option>
                                             <option value="4" <? if ($sql_des['tinh_trang_noi_that'] == 4)
                                                                    echo 'selected' ?>>Bàn giao thô</option>
                                         </select>
                                     </div>
                                 </div>
                                 <div class="row-tin-dang box_input_infor">
                                 ...
                                 <div class="row-tin-dang position_ral box_input_infor d0407">
                                     ...
                                     <input class="input_infor_tag" type="text" name="dientich" placeholder="Diện tích" onkeydown="javascript: return ['Backspace','Delete','ArrowLeft','ArrowRight'].includes(event.code) ? true : !isNaN(Number(event.key)) && event.code!=='Space'" value="<?= $sql_des['dien_tich'] ?>">
                                 ...
                                 <div class="d_flex j_between d_so_sl_sotang">
                                     <div class="row-tin-dang rowflex2 position_ral">
                                         ...
                                         <input type="text" name="chieudai" value="<?= ($sql_des['chieu_dai'] != 0) ? $sql_des['chieu_dai'] : "" ?>" placeholder="Chiều dài" onkeydown="javascript: return ['Backspace','Delete','ArrowLeft','ArrowRight'].includes(event.code) ? true : !isNaN(Number(event.key)) && event.code!=='Space'">
                                         <span class="donvi_dt font-14" style="color:#666666">m</span>
                                     </div>
                                     <div class="row-tin-dang rowflex2 position_ral">
                                         <p class="font-dam hd_font15-17">Chiều ngang</p>
                                         <input type="text" name="chieungang" placeholder="Chiều ngang" value="<?= ($sql_des['chieu_rong'] != 0) ? $sql_des['chieu_rong'] : "" ?>" onkeydown="javascript: return ['Backspace','Delete','ArrowLeft','ArrowRight'].includes(event.code) ? true : !isNaN(Number(event.key)) && event.code!=='Space'">
                                         <span class="donvi_dt font-14" style="color:#666666">m</span>
                                     </div>
                                 </div>
                         ...
                         <div class="row-tin-dang box_input_infor">
                             ...
                             <textarea class="texa-mo-ta input_infor_tag" placeholder="Nhập mô tả" name="mota"><?= $sql_des['new_description'] ?></textarea>
                         </div>
                         <div class="box_input_infor">
                         ...
                         <div class="row-tin-dang box_input_infor">
                             ...
                             <input readonly type="text" name="td_dia_chi" class="td_ttin_diachi input_infor_tag error" placeholder="Địa chỉ" value="<?= $sql_nd['dia_chi'] ?>">
                         </div>
                         <div class="row-tin-dang box_input_infor">
                         ...
                         <div class="row-tin-dang-btn cont-btn-sb hd-disflex">
                             <button type="button" class="btn-submit td-xem-truoc hd_cspointer font-bold" onclick="xem_trc_tin()">XEM
                                 TRƯỚC</button>
                             <button type="button" class="btn-submit dang_tin td-dang-tin hd_cspointer font-bold">CHỈNH
                                 SỬA</button>
                         </div>
                     </form>
                 </div>
