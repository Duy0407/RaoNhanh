...
<head>
    ...
    <title>Đăng tin sức khỏe sắc đẹp Vật tư y tế</title>
        ...
        <div class="tindang-container">
            ...
            <div class="tindang-content-cont hd-disflex">
                ...
                <div class="tindang-col-right">
                    <form class="form-dtin-cont" id="form_vattu_yte" data="<?= $acc_id ?>" data1="<?= $acc_type ?>">
                        <div class="row-tin-dang danhmuc_tt">
                            <p class="font-dam hd_font15-17">Danh mục sản phẩm <span class="color_red">*</span></p>
                            <input type="text" class="dmuc-spham" data="63" readonly name="san-pham-laptop" placeholder="Sức khỏe - Sắc đẹp >> Vật tư y tế">
                        </div>
                        ...
                        <div class="d_flex j_between mt20">
                            <div class="row-tin-dang rowflex2 no_mg">
                                ...
                                <input type="text" name="hang" placeholder="Nhập hãng">
                            </div>
                        ...
                        <div class="row-tin-dang">
                            ...
                            <div class="input-gia-cont">
                                <div class="box_input_infor">
                                    <input class="input_infor_tag error" onkeyup="format_gtri(this)" type="text" name="td_gia_spham" placeholder="" autocomplete="off" oninput="<?= $oninput ?>" id="gia-ban-sp" onkeydown="javascript: return ['Backspace','Delete','ArrowLeft','ArrowRight'].includes(event.code) ? true : !isNaN(Number(event.key)) && event.code!=='Space'">
                                </div>
                        ...
                        <div class="row-tin-dang cont-btn-sb hd-disflex hide-480-mobile">
                            ...
                            <button type="button" id="xoa_tddang_tin" class="btn-submit td-dang-tin vattu_yte hd_cspointer font-bold">ĐĂNG TIN</button>
                        </div>
                    </form>
                </div>
            </div>
...
<script>
    ...
    $(".td-dang-tin").click(function() {
        ...
        if (form_vattu_yte.valid() === true) {
            ...
            $.ajax({
                url: '/ajax_sksd/dangtin_sksd_vattuyte.php',
                type: 'POST',
                data: fd,
                contentType: false,
                processData: false,
                beforeSend: function() {
                    $('.vattu_yte').prop('disabled', true);
                },
                success: function(data) {
                    if (data == "") {
                        tbao_dtin_tcong();
