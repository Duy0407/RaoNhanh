...
<head>
    ...
    <title>Đăng tin xe cộ nội thất ô tô</title>
...
<body>
    ...
    <section id="m_dangtin_xc_noithatoto" class="xeco">
        ...
        <form class="form-dtin-cont form_bds_chung" id="form_xeco_noithatoto" data="<?= $acc_id ?>" data1="<?= $acc_type ?>" data3="<?= $xacthuc_lket ?>">
