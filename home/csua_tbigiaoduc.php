...
if (isset($_COOKIE['UID']) && isset($_COOKIE['UT']) && $id_cs != 0 && $id_dm != 0) {
    ...
    if (mysql_num_rows($check_tind->result) > 0) {
        $list_tt = new db_query("SELECT n.`new_title`, n.`new_money`, n.`gia_kt`, n.`new_cate_id`, n.`new_city`, n.`new_image`, n.`new_unit`, n.`new_tinhtrang`,
                                ...
                                d.`new_description`, n.`new_phone`, n.`new_email`
...
<head>
    ...
    <title>Chỉnh sửa thiết bị giáo dục</title>
...
<body>
        ...
        <div class="tindang-container">
            ...
            <div class="tindang-content-cont hd-disflex">
                ...
                <div class="tindang-col-right" data="<?= $id_cs ?>">
                    <form class="form-dtin-cont" id="form_tbgiaoduc" data="<?= $us_id ?>" data1="<?= $us_type ?>">
                        <div class="row-tin-dang danhmuc_tt">
                            <p class="font-dam hd_font15-17">Danh mục sản phẩm <span class="color_red">*</span></p>
                            <input type="text" class="dmuc-spham" readonly name="san-pham-laptop" data="<?= $id_dm ?>" placeholder="Đồ dùng văn phòng, công nông nghiệp  >>  Thiết bị giáo dục">
                        </div>
                        <div class="row-tin-dang box_input_infor">
                            <p class="font-dam hd_font15-17">Tiêu đề <span class="color_red">*</span></p>
                            <input class="input_infor_tag error" type="text" name="tieu_de" value="<?= $row_tt['new_title'] ?>" placeholder="Nhập tiêu đề">
                        </div>
                        <div class="row-tin-dang box_input_infor">
                        ...
                        <div class="row-tin-dang cont-btn-sb hd-disflex hide-480-mobile">
                            ...
                            <button type="button" class="btn-submit td-dang-tin tb_giaoduc hd_cspointer font-bold">CHỈNH SỬA</button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <script type="text/javascript">
        $(".tb_giaoduc").click(function() {
            var form_tbgiaoduc = $("#form_tbgiaoduc");
            form_tbgiaoduc.validate({
            ...
            if (form_tbgiaoduc.valid() === true) {
                ...
                $.ajax({
                    type: 'POST',
                    url: '/ajax_ddcnn/csua_tbigiaoduc.php',
                    data: fd,
                    processData: false,
                    contentType: false,
