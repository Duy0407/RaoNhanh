...
if (isset($_COOKIE['UID']) && isset($_COOKIE['UT']) && $id_dm != 0 && $id_cs != 0) {
    ...
    $list_tt = new db_query("SELECT n.`new_title`, n.`new_money`, n.`gia_kt`, n.`new_cate_id`, n.`new_city`, n.`new_image`, n.`new_unit`,
                                n.`chotang_mphi`, n.`quan_huyen`, n.`phuong_xa`, n.`new_sonha`, n.`dia_chi`, n.`new_video`,  n.`new_ctiet_dmuc`,
                                d.`new_description`, n.`new_phone`, n.`new_email` FROM `new` AS n INNER JOIN `new_description` AS d ON n.`new_id` = d.`new_id`
...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="../css/style_new/style_d.css?v=<?= $version ?>">
    <link type="text/css" rel="stylesheet" href="/css/style_new/style.css?v=<?= $version ?>">
        ...
        <div class="tindang-container">
            ...
            <div class="tindang-content-cont hd-disflex">
                ...
                <div class="tindang-col-right">
                    <form class="form-dtin-cont" id="form_dulich" data1="<?= $us_id ?>" data2="<?= $us_type ?>" data="<?= $id_cs ?>">
                        <div class="row-tin-dang danhmuc_tt">
                            <p class="font-dam hd_font15-17">Danh mục sản phẩm <span class="color_red">*</span></p>
                            <input type="text" class="dmuc-spham" readonly name="san-pham-laptop" data="<?= $id_dm ?>" placeholder="Du lịch">
                        </div>
                        ...
                        <div class="row-tin-dang box_input_infor">
                            ...
                            <input type="text" name="td_dia_chi" class="td_ttin_diachi input_infor_tag" placeholder="Địa chỉ" value="<?= $row_tt['dia_chi'] ?>" readonly data-tt="<?= $tinh_thanh ?>" data-qh="<?= $quan_huyen ?>" data-px="<?= $phuong_xa ?>" data-sn="<?= $so_nha ?>">
                        </div>
                        <div class="row-tin-dang box_input_infor">
                        ...
                        <div class="row-tin-dang cont-btn-sb hd-disflex hide-480-mobile">
                            ...
                            <button type="button" class="btn-submit td-dang-tin dulich hd_cspointer font-bold">CHỈNH SỬA</button>
                        </div>
                    </form>
                </div>
            </div>
...
<script type="text/javascript">
    $(".dulich").click(function() {
        ...
        if (form_dulich.valid() === true) {
            var user_id = $("#form_dulich").attr("data1");
            var user_type = $("#form_dulich").attr("data2");
