...
if (isset($_COOKIE['UID']) && isset($_COOKIE['UT'])) {
    ...
    if ($type_user == 5) {
        ...
        // tin da an
        $all_tindaan = new db_query("SELECT `new_id`, `new_title`, `link_title`, 
        `new_cate_id`, `da_ban`,`sluong_daban`,`new_active`,
        `new_money`, `new_unit`, `new_image`, `new_create_time`, `dia_chi`,
        `chotang_mphi`, `new_pin_cate`,`tgian_ban`,
        `new_pin_home`, `new_day_tin`,tong_sluong FROM `new` WHERE `new_type` = $usertype 
        AND `new_user_id` = $id_user AND `new_buy_sell` = 2 AND `new_cate_id` != 120 
        AND `new_cate_id` != 121 AND `new_active` = 0 ORDER BY `new_id` DESC $limit");
            ...
            <div class="d_flex j_between hs_df_1">
                ...
                <div class="khoiphai_quanly khoiphai_quanly_df">
                    ...
                    <div class="d_them_div_qltin">
                        ...
                        <!-- TIN DA AN -->
                        <div class="khoi_noidung_daan khoi_noidungban_df_qlt">
                            <? while ($showtindaan = (mysql_fetch_assoc($all_tindaan->result))) {
                                $avatar_tindaan = $showtindaan['new_image'];
                                $avatar_tindaan = explode(';', $avatar_tindaan);
                                $cat_id = $showtindaan['new_cate_id'];
                                $id_tin = $showtindaan['new_id'];
                            ?>
                                <div class="khoicon_ndban d_flex fl_cl">
                                    <div class="d_them_div_flex d_flex fl_row al_ct">
                                        <div class="anh_daidientin">
                                            <a href="/<?= replaceTitle($showtindaan['link_title']) ?>-c<?= $showtindaan['new_id'] ?>.html" class="img_tinban">
                                                <img src="<?= $avatar_tindaan[0] ?>" alt="" class="anh_avt_tin" onerror="this.src=`/images/anh_moi/dai_dien_avt.png`">
                                                <? if ($showtindaan['da_ban'] == 0 && $xacthuc_lket == 1) { ?>
                                                    <!-- đang ghim -->
                                                    <? if ($showtindaan['new_pin_home'] != 0 || $showtindaan['new_pin_cate'] != 0 || $showtindaan['new_day_tin'] != "") { ?>
                                                        <p class="text-main-content-ghim">ĐANG GHIM</p>
                                                        <!-- het hang -->
                                                    <? } else if ($showtindaan['tong_sluong'] == 0) { ?>
                                                        <p class="hethang_img">Hết hàng</p>
                                                        <!-- tin dang an -->
                                                    <? } else if ($showtindaan['new_active'] == 0) { ?>
                                                        <p class="dangan_img">Tin đang ẩn</p>
                                                    <? } ?>
                                                <? } else if ($showtindaan['da_ban'] == 0 && $xacthuc_lket == 0) { ?>
                                                    <!-- đang ghim -->
                                                    <? if ($showtindaan['new_pin_home'] != 0 || $showtindaan['new_pin_cate'] != 0 || $showtindaan['new_day_tin'] != "") { ?>
                                                        <p class="text-main-content-ghim">ĐANG GHIM</p>
                                                        <!-- het hang -->
                                        ...
                                        <div class="khoi_text_ban khoi_text_ban_qltin">
                                            <div class="text-tilte d_flex fl_row al_ct jtf_spb">
                                                <a href="/<?= replaceTitle($showtindaan['link_title']) ?>-c<?= $showtindaan['new_id'] ?>.html" class="title_ban title_ban_df font-16 mb20 elipsis1"><?= $showtindaan['new_title'] ?></a>
                                            </div>
                                            <div class="time_ban_qltdn d_flex fl_row al_ct">
                                                ...
                                                <p class="font-14 font-bold time_ban time_ban_df"><?= lay_tgian($showtindaan['new_create_time']) ?></p>
                                            </div>
                                            <div class="address_ban_qltdn d_flex fl_row al_ct">
                                                ...
                                                <p class="font-14 address_ban address_ban_qltl_df elipsis1"><?= $showtindaan['dia_chi'] ?></p>
                                            </div>
                                            <div class="m_tieuthu_qlt d_flex fl_row jtf_spb">
                                                <div class="m_money_qlt">
                                                    <? if ($showtindaan['chotang_mphi'] == 1) { ?>
                                                        <div class="money-qlt">Cho tặng miễn phí</div>
                                                    <? } else if ($showtindaan['new_money'] > 0) { ?>
                                                        <div class="money-qlt d_flex fl_row al_ct">
                                                            <div class="pdr_5">
                                                                <?= number_format($showtindaan['new_money']) ?> <?= $arr_dvtien[$showtindaan['new_unit']] ?>
                                                            </div>
                                                            <? if ($xacthuc_lket == 1) { ?>
                                                ...
                                                <? if ($xacthuc_lket == 1) { ?>
                                                    <!-- <div class="m_amount_qlt d_flex fl_row al_ct">
                                                        ...
                                                        <p class="m_amount_qlt_text pdl_5 pdr_5 p_400_s14_l17">
                                                            Số lượng: <?= $showtindaan['tong_sluong'] ?>
                                                        </p>
                                                    ...
                                                    <div class="m_sold_qlt d_flex fl_row al_ct">
                                                        ...
                                                        <p class="m_sold_qlt_text pdl_5 p_400_s14_l17">
                                                            Đã bán: <?= $showtindaan['sluong_daban'] ?>
                                                        </p>
                                                    </div> -->
                                                <? } ?>
                                            </div>
                                    ...
                                    <div class="div_3cham_bao_nut">
                                        ...
                                        <? } else { ?>
                                            ...
                                            <div class="btn_div_3cham_bao_nut btn_qlt_df btn_qlt_df_chung btn_qlt_df_3 hid_1200">
                                                <div class="m_anhientin ctn_anhien_<?= $id_tin ?>" data="<?= $id_tin ?>" data1="<?= $showtindaan['new_active'] ?>">
                                                    <!-- an -->
                                                    <? if ($showtindaan['new_active'] == 1) { ?>
                                                ...
                                                <? if ($xacthuc_lket == 0 && $showtindaan['new_active'] == 1) { ?>
                                                    <span class="m_daban_cxtlk cursor_Pt df_daban" data="<?= $id_tin ?>" data1="<?= $showtindaan['da_ban'] ?>">
                                                ...
                                                <? if ($showtindaan['new_pin_home'] == 0 && $showtindaan['new_pin_cate'] == 0 && $showtindaan['new_day_tin'] == "") { ?>
                                                    <? if ($xacthuc_lket == 1  && $showtindaan['new_active'] == 0) { ?>
                                                        <span class="m_boder_bannhanhhon border-gt btn_qlt_df_3_d <?= ($xacthuc_lket == 1 && $showtindaan['new_active'] == 0) ? "op0_5" : "aaaa" ?>">
                                                    ...
                                                    <? } else if ($xacthuc_lket == 1  && $showtindaan['new_active'] == 1) { ?>
                                                        <span class="m_boder_bannhanhhon border-gt btn_qlt_df_3_d <?= ($xacthuc_lket == 1 && $showtindaan['new_active'] == 1) ? "op0_5" : "aaaa" ?>">
                                                            <div class="btn-gt cus_poi text-gt d_flex fl_row al_ct" data="<?= $id_tin ?>">
                                                                <img src="/images/m_raonhanh_imgnew/cartspeed.png" alt="Bán nhanh hơn" class="m_bannhanhhon_qlt img_18">
                                                                <span class="text-gt m_txt_bannh p_400_s15_l18" data="<?= $id_tin ?>">Bán nhanh hơn</span>
                                                            </div>
                                                        </span>
                                                    <? } else if ($xacthuc_lket == 0  && $showtindaan['new_active'] == 0) { ?>

                                                    <? } else { ?>
                                                        <span class="m_boder_bannhanhhon border-gt btn_qlt_df_3_d">
                                                            <div class="btn-gt cus_poi text-gt d_flex fl_row al_ct" data="<?= $id_tin ?>">
                                                                <img src="/images/m_raonhanh_imgnew/cartspeed.png" alt="Bán nhanh hơn" class="m_bannhanhhon_qlt img_18">
                                                                <span class="text-g m_txt_bannh v p_400_s15_l18" data="<?= $id_tin ?>">Bán nhanh hơn</span>
                                                            </div>
                                                        </span>
                                                    <? } ?>
                                                <? } ?>
