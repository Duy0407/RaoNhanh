...
<body>
    ...
    <?php include "../includes/person_sell/inc_sidebar_left.php"?>
        ...
        <div class="box-right">
            ...
            <div class="text-no-news">
                <div class="titlt-nn">Ôi không, chẳng có gì ở đây cả</div>
                <div class="content-nn">Bạn chưa đăng tin nào cả <br> Đăng bán những món đồ hấp dẫn ngay thôi nào</div>
                <div class="box-up-news">
                    <a href="" class="text-box-un">Đăng tin</a>
                </div>
            </div>
        </div>
        </section>
