...
<body>
            ...
            <div class="tindang-container">
                ...
                <div class="tindang-content-cont hd-disflex">
                    ...
                    <div class="tindang-col-right">
                        <form class="form-dtin-cont fid_gia_mb" id="form_service" data="<?= $us_id ?>" data1="<?= $us_type ?>">
                            <div class="row-tin-dang danhmuc_tt">
                                <p class="font-dam hd_font15-17">Danh mục sản phẩm <span class="color_red">*</span></p>
                                <input type="text" class="dmuc-spham" readonly name="san-pham-laptop" data="<?= $id ?>" placeholder="Dịch vụ - Giải trí >> Dịch vụ">
                            </div>
                            ...
                            <div class="row-tin-dang d_8-7_tclass1 fid_gia_mb1">
                                ...
                                <div class="d_themdiv_gia_7_8">
                                    <div class="input-gia-cont d_8-7_tclass3">
                                        <div class="box_input_infor box_giaspham">
                                    ...
                                    <span class="sp-lienhe-nban d_8-7_tclass4 fig_gia_nguoiban_lienhe">
                            ...
                            <div class="row-tin-dang cont-btn-sb hd-disflex">
                                ...
                                <button type="button" id="xoa_tddang_tin" class="btn-submit td-dang-tin service hd_cspointer font-bold">ĐĂNG TIN</button>
                            </div>
                        </form>
                    </div>
                </div>
    ...
    <script type="text/javascript">
        $(".td-dang-tin").click(function() {
            ...
            if (form_service.valid() === true) {
                $("#xoa_tddang_tin").removeClass("td-dang-tin");
                var user_id = $("#form_service").attr("data");
                var user_type = $("#form_service").attr("data1");
                ...
                $.ajax({
                    type: 'POST',
                    url: '/ajax_dvgiaitri/dtin_dichvu.php',
                    data: fd,
                    processData: false,
                    contentType: false,
                    beforeSend: function() {
