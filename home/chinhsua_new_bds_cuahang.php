...
if (isset($_COOKIE['UID']) && isset($_COOKIE['UT']) && $id_nd != 0) {
    ...
    $list_tin = new db_query("SELECT `new`.`new_id`, `new_title`, `new_money`, `new_cate_id`, `new_city`, `new_image`, `new_unit`, `new_phone`, `new_email`,
                            `new_address`, `quan_huyen`, `phuong_xa`, `new_sonha`, `dia_chi`, `new_video`, `new_ctiet_dmuc`, `datcoc`,`dc_unit`,
                            `new_description`, `can_ban_mua`, `ten_toa_nha`, `tong_so_tang`, `huong_chinh`, `giay_to_phap_ly`, `dac_diem`, `dien_tich`,
                            `chieu_dai`, `chieu_rong`, `canhan_moigioi`, `tinh_trang_noi_that` FROM `new`
    ...
    if (mysql_num_rows($list_tin->result) > 0) {
        ...
        // tag danh muc
        $ban = new db_query("SELECT `tags_id`, `ten_tags` FROM `key_tags` WHERE `id_danhmuc` = 33 AND type_tags = '" . $item_td['can_ban_mua'] . "' ");
...
<head>
    ...
    <title>Chỉnh sửa bất động sản cửa hàng</title>
                ...
                <div class="ctn_ct_box1 d_flex fl_cl w100">
                    ...
                    <div class="ctn_ct_b1_fr2 w100">
                        <div class="b1_fr2_title w100">
                            <p class="b1_fr2_title_p p_400_s16_l19 d_flex fl_row al_ct" data="33" data1="<?= $id_nd ?>">
                ...
                <div class="ctn_ct_box4 d_flex fl_cl">
                    ...
                    <div class="ctn_ct_b4_fr d_flex fl_row al_ct">
                        <div class="ctn_ct_b4_fr1">
                            <p class="b4_fr1_title p_400_s15_l18">Tên cửa hàng</p>
                            <input type="text" name="ten_toanha" class="b4_fr1_input p_400_s14_l17" value="<?= $item_td['ten_toa_nha'] ?>" placeholder="Tên cửa hàng" autocomplete="off">
                        </div>
                        <div class="ctn_ct_b4_fr2 box_input_infor">
                            <p class="b4_fr2_title p_400_s15_l18">Địa chỉ cửa hàng <span class="cl_red">*</span></p>
                            <input type="text" name="td_diachi_nha" class="td_ttin_diachi b4_fr2_input p_400_s14_l17" value="<?= $item_td['dia_chi'] ?>" data-tt="<?= $tinh_thanh ?>" data-qh="<?= $quan_huyen ?>" data-px="<?= $phuong_xa ?>" data-sn="<?= $so_nha ?>" placeholder="Địa chỉ cửa hàng" autocomplete="off">
                        </div>
                    </div>
                </div>
                <!-- ----------------------------------------------------------------------box6--------------------------------------------------------------------- -->
                <div class="ctn_ct_box6 d_flex fl_cl">
                    ...
                    <div class="ctn_ct_b6_ft d_flex fl_row al_ct">
                        <div class="b6_ft1 d_flex fl_cl">
                            ...
                            <input type="text" name="so_tang" class="b5_fr1_input p_400_s14_l17" value="<?= $item_td['tong_so_tang'] ?>" placeholder="Tổng số tầng" autocomplete="off" oninput="<?= $oninput ?>">
                        </div>
                    ...
                    <div class="ctn_ct_b7_ft d_flex fl_cl">
                        ...
                        <div class="b7_ft d_flex fl_row">
                            <div class="b7_ft1 d_flex fl_row al_ct">
                                <input name="dacdiem" value="1" type="checkbox" <?= (in_array(1, explode(',', $item_td['dac_diem']))) ? 'checked' : '' ?> class="b7_ft1_input img24 cursor_Pt checkbox_dacdiem">
                                <p class="b7_ft1_p p_400_s14_l17 pdl_10">Hẻm xe hơi</p>
                            </div>
                            <div class="b7_ft2 d_flex fl_row al_ct">
                                <input name="dacdiem" value="2" type="checkbox" <?= (in_array(2, explode(',', $item_td['dac_diem']))) ? 'checked' : '' ?> class="b7_ft2_input img24 cursor_Pt checkbox_dacdiem">
                                <p class="b7_ft2_p p_400_s14_l17 pdl_10">Nở hậu</p>
                            </div>
                            <div class="b7_ft3 d_flex fl_row al_ct">
                                <input name="dacdiem" value="3" type="checkbox" <?= (in_array(3, explode(',', $item_td['dac_diem']))) ? 'checked' : '' ?> class="b7_ft3_input img24 cursor_Pt checkbox_dacdiem">
    ...
    <script>
        ...
        $(".b11_btn_dangtin").click(function() {
            ...
            if (form_bds_cuahang.valid() === true) {
                ...
                // end
                $.ajax({
                    url: '/ajax_bds/chinhsua_bdscuahang.php',
                    type: 'POST',
                    data: fd,
                    contentType: false,
                    processData: false,
