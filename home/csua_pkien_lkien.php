                ...
                <div class="tindang-col-right" data="<?= $id_cs ?>">
                    <form class="form-dtin-cont" id="form_dt_phukien" data="<?= $us_id ?>" data1="<?= $us_type ?>">
                        <div class="row-tin-dang-dau">
                            ...
                            <input type="text" class="dmuc-spham" readonly data="<?= $id_dm ?>" name="danhmucsanpham_dt" placeholder="Đồ điện tử >> Phụ kiện, Linh kiện">
                        </div>
                        ...
                        <div class="row-tin-dang box_input_infor">
                            ...
                            <select name="linhkien" class="slect-thietbi slect-thietbi-pkien hd_height36" data="<?= $id_dm ?>">
                                <option disabled selected value="">Linh kiện/ Phụ kiện</option>
                                <option value="1" <?= ($row_tt['link_kien_phu_kien'] == 1) ? "selected" : "" ?>>Phụ kiện</option>
                                <option value="2" <?= ($row_tt['link_kien_phu_kien'] == 2) ? "selected" : "" ?>>Linh kiện</option>
                            </select>
                        </div>
                        <!-- phu kien -->
                        <? if ($linhphu_kien == 1) { ?>
