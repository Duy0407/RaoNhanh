...
if (isset($_COOKIE['UID']) && isset($_COOKIE['UT'])) {
    ...
    $list_tm = new db_query("SELECT `id`, `ten_loai`  FROM `loai_chung` WHERE `id_danhmuc` = $id ");
...
<head>
    ...
    <title>Đăng tin đồ sưu tầm, đồ cổ</title>
            ...
            <div class="tindang-container">
                ...
                <div class="tindang-content-cont hd-disflex">
                    ...
                    <div class="tindang-col-right">
                        <form class="form-dtin-cont fid_gia_mb" id="form_doco" data="<?= $us_id ?>" data1="<?= $us_type ?>">
                            <div class="row-tin-dang danhmuc_tt">
                                <p class="font-dam hd_font15-17">Danh mục sản phẩm <span class="color_red">*</span></p>
                                <input type="text" class="dmuc-spham" readonly name="san-pham-laptop" data="<?= $id ?>" placeholder="Dịch vụ - Giải trí >> Đồ sưu tầm, đồ cổ">
                            </div>
                            ...
                            <div class="row-tin-dang box_input_infor">
                                ...
                                <select class="slect-hang  hd_height36" name="loai_san_pham">
                                    <option value="">Loại sản phẩm</option>
                                    <? while ($row_l = mysql_fetch_assoc($list_tm->result)) { ?>
                                        <option value="<?= $row_l['id'] ?>"><?= $row_l['ten_loai'] ?></option>
                                    <? } ?>
                                </select>
                            </div>
                            <div class="row-tin-dang box_input_infor">
                                ...
                                <div class="d_themdiv_gia_7_8">
                                    <div class="input-gia-cont d_8-7_tclass3">
                                        <div class="box_input_infor">
                                            <input type="text" name="td_gia_spham" class="input_infor_tag error" id="gia-ban-sp" oninput="<?= $oninput ?>" onkeyup="format_gtri(this)" autocomplete="off">
                                        </div>
                            ...
                            <div class="row-tin-dang cont-btn-sb hd-disflex">
                                ...
                                <button type="button" id="xoa_tddang_tin" class="btn-submit td-dang-tin dt_doco hd_cspointer font-bold">ĐĂNG TIN</button>
                            </div>
                        </form>
                    </div>
                </div>
        ...
        $(".td-dang-tin").click(function() {
            ...
            form_doco.validate({
                ...
                messages: {
                    ...
                    loai_san_pham: "Vui lòng chọn tình trạng đồ cổ",
                    tinhtrang: "Vui lòng chọn tình trạng đồ cổ",
            ...
            if (form_doco.valid() === true) {
                $("#xoa_tddang_tin").removeClass("td-dang-tin");
                var user_id = $("#form_doco").attr("data");
                var user_type = $("#form_doco").attr("data1");
                ...
                $.ajax({
                    type: 'POST',
                    url: '/ajax_dvgiaitri/dtin_doco.php',
                    data: fd,
                    processData: false,
                    contentType: false,
                    beforeSend: function() {
                        $('.dt_doco').prop('disabled', true);
                    },
