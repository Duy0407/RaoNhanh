...
if (isset($_COOKIE['UID']) && isset($_COOKIE['UT'])) {
    ...
    $list_dh = new db_query("SELECT `dh_id`,`id_nguoi_dh`, `id_nguoi_ban`, `id_spham`, `ghi_chu`, `loai_ttoan`, `tien_ttoan`, `dia_chi_nhanhang`, `trang_thai`,
                            `ly_do_hdon`, `usc_name`, `chat365_id`, `usc_id`, `usc_phone`, `usc_type`, `usc_logo`, `new_title`, `new_money`, `new_unit`,
                            ...
                            WHERE `id_nguoi_dh` = $id_user AND (`trang_thai` = 4 OR `xnhan_nmua` = 1) ORDER BY `tgian_htat` DESC ");
                                    ...
                                    <div class="box-right-content-bot">
                                        <div class="bot-l">
                                            ...
                                            <div class="content-bot-c">
                                                <a href="/chi-tiet-hoan-tat-don-hang-nguoi-mua-<?= $row_tin['dh_id'] ?>.html" class="ten_sp color_orange"><?= $row_tin['new_title'] ?></a>
