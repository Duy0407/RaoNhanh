...
if (isset($_COOKIE['UID']) && isset($_COOKIE['UT'])) {
    $acc_id = $_COOKIE['UID'];
    $acc_type = $_COOKIE['UT'];
    $sql_dm = new db_query("SELECT `tags_id`, `ten_tags` FROM `key_tags` WHERE id_danhmuc = 94");
...
<body>
    ...
    <!-- content -->
    <section id="m_dangtin_douongthucpham" class="suckhoe douongthucpham" data="<?= date('Y-m-d') ?>">
        <div class="container_title">
            <p class="ctn_tt_p p_600_s24_l28">Đăng tin</p>
        </div>
        <form class="form-dtin-cont form_bds_chung" id="form_thucpham" data="<?= $acc_id ?>" data1="<?= $acc_type ?>" data3="<?= $xacthuc_lket ?>">
            <div class="container_content">
                ...
                <div class="ctn_ct_box1 d_flex fl_cl w100">
                    ...
                    <div class="ctn_ct_b1_fr2 w100">
                        <div class="b1_fr2_title w100">
                            <p class="b1_fr2_title_p p_400_s16_l19 d_flex fl_row al_ct" data="94">
                ...
                <div class="b6_loaihinh loai_dungcu d_flex fl_cl box_input_infor">
                    ...
                    <select class="slect-hang hd_height36 b6_lhinh_select loai_thuc_pham" name="loai_thuc_pham">
                        <option value="" selected disabled>Loại thực phẩm</option>
                        <? foreach ($db_lchung as $rows) {
                            if ($rows['id_danhmuc'] == 94) { ?>
    ...
    <script>
        ...
        $(".b11_btn_dangtin").click(function() {
            ...
            if (form_thucpham.valid() === true) {
                ...
                var user_id = $("#form_thucpham").attr("data");
                var user_type = $("#form_thucpham").attr("data1");
                ...
                // truong moi loai_thuc_pham
                var loai_thuc_pham = $("select[name='loai_thuc_pham']").val();
                ...
                var xac_thuc = $("#form_thucpham").attr("data3");
                ...
                fd.append('loai_thuc_pham', loai_thuc_pham);
                // -------------------------da xac thuc thanh toan----------------------------------------------
    ...
    <script>
        ...
        function xem_trc_tin() {
            var form_thucpham = $(".form-dtin-cont");
            form_thucpham.validate({
                errorPlacement: function(error, element) {
                    error.appendTo(element.parents(".box_input_infor"));
                    error.wrap("<span class='error'>");
            ...
            if (form_thucpham.valid() === true) {
                ...
                fd.append('loai_sp', loai_thuc_pham);
