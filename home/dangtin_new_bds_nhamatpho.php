...
if (isset($_COOKIE['UID']) && isset($_COOKIE['UT'])) {
    ...
    // tag danh muc
    $ban = new db_query("SELECT `tags_id`, `ten_tags` ,`type_tags` FROM `key_tags` WHERE `id_danhmuc` = 28 AND type_tags = 1");
...
<head>
    ...
    <title>Đăng tin bất động sản nhà mặt phố</title>
...
<body>
    ...
    <!-- content -->
    <section id="m_dangtin_bds_nhamatpho">
        <div class="container_title">
            <p class="ctn_tt_p p_600_s24_l28">Đăng tin</p>
        </div>
        <form class="form-dtin-cont form_bds_chung" id="form_bds_nhamatpho" data="<?= $acc_id ?>" data1="<?= $acc_type ?>">
                ...
                <div class="ctn_ct_box1 d_flex fl_cl w100">
                    ...
                    <div class="ctn_ct_b1_fr2 w100">
                        <div class="b1_fr2_title w100">
                            <p class="b1_fr2_title_p p_400_s16_l19 d_flex fl_row al_ct" data="28">
                    ...
                    <div class="ctn_ct_b6_ft d_flex fl_row al_ct">
                        <div class="b6_ft1 d_flex fl_cl">
                            ...
                            <select class="slect-hang  hd_height36" name="so_tang">
                                ...
                                <? foreach ($result_sotang as $rs_st) { ?>
                                    <option value="<?= $rs_st['id'] ?>">
                                        <?= $rs_st['so_luong']; ?>
                                    </option>
                                <? } ?>
                            </select>
    ...
    <script>
        ...
        $(".b11_btn_dangtin").click(function() {
            ...
            if (form_bds_nhamatpho.valid() === true) {
                ...
                $.ajax({
                    url: '/ajax_bds/dangtin_bdsnhamatpho.php',
                    type: 'POST',
                    data: fd,
                    contentType: false,
                    processData: false,
