...
<head>
    ...
    <title>Đăng tin thời trang nước hoa </title>
                ...
                <div class="tindang-col-right">
                    <form class="form-dtin-cont" id="form_thoitrang_nuochoa" data="<?= $us_id ?>" data1="<?= $us_type ?>">
                        <div class="row-tin-dang danhmuc_tt">
                            ...
                            <input type="text" class="dmuc-spham" readonly name="san-pham-laptop" data="<?= $id ?>" placeholder="Thời trang >> Nước hoa">
                        </div>
                        ...
                        <div class="row-tin-dang-btn cont-btn-sb hd-disflex hide-480-mobile">
                            ...
                            <button type="button" id="xoa_tddang_tin" class="btn-submit td-dang-tin nuochoa hd_cspointer font-bold">ĐĂNG TIN</button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <script type="text/javascript">
        $(".td-dang-tin").click(function() {
            ...
            if (form_thoitrang_nuochoa.valid() === true) {
                ...
                $.ajax({
                    type: 'POST',
                    url: '/ajax_thoitrang/dtin_nuochoa.php',
                    data: fd,
                    processData: false,
                    contentType: false,
                    beforeSend: function() {
                        $('.nuochoa').prop('disabled', true);
                    },
