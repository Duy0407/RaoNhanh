...
if(isset($_COOKIE['UID']))
{
 ...
 if (isset($_POST["postok"])) {
    ...
    if ($title != '') {
        $db_qr = new db_query ("INSERT INTO vieclam(new_title,new_alias,birthday,new_sex,new_phone,new_picture,new_level,new_exp,new_skill,new_city,new_district,new_address,new_job_kind,new_end_date,new_job_type,new_job_detail,new_money_min,new_money_max,new_pay_type,new_desc,new_type,new_user_id,save_time_vl)
        VALUES('".$title."','".$title_ali."','".strtotime($birth)."','".$gender."','".$phone."','".$upload_dir.$image."','".$level."','".$exp."','".$skill."','".$city."','".$district."','".$address."','".$jobkind."','".strtotime($enddate)."','".$jobtype."','".$detailjob."','".$moneymin."','".$moneymax."','".$paytype."','".$desc."','2','".$userid."','".time()."')");
        if($db_qr){
                    ...
                    <fieldset>
                        ...
                        <div class="tong_s_1">
                            <div class=" dang_tin_s_1">
                                ...
                                <input class="dang_tin_right_s" type="number" name="phone" id="phone" placeholder="Nhập số điện thoại..." min="0">
                            </div>
                        ...
                        <div class="tong_s_1">
                            ...
                            <div class="gr-01 dang_tin_s_1">
                                <label class="title_dttd_s">Chứng chỉ / kỹ năng<span>*</span></label>
                        ...
                        <div class="nn_to dang_tin_s">
                            ...
                            <select class="form-control style_select" name="lhlv[]" id="lhlv"  style="width:100%" >
                        ...
                        <div class="nn_to dang_tin_s">
                            ...
                            <select class="form-control style_select" name="ctcv[]"  id="ctcv"  style="width:100%" >
                        ...
                        <div class="upload ">
                            ...
                            <input type="file" name="image" style="display: block;width: 218px;" accept="image/*" class="up_anh_1"> 
                        </div>
