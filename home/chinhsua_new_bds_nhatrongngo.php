...
<head>
    ...
    <title>Chỉnh sửa bất động sản nhà trong ngõ</title>
                ...
                <div class="ctn_ct_box4 d_flex fl_cl">
                    ...
                    <div class="ctn_ct_b4_fr d_flex fl_row al_ct">
                        ...
                        <div class="ctn_ct_b4_fr2 box_input_infor">
                            ...
                            <input type="text" name="td_diachi_nha" class="td_ttin_diachi b4_fr2_input p_400_s14_l17" value="<?= $item_td['dia_chi'] ?>" data-tt="<?= $item_td['new_city'] ?>" data-qh="<?= $item_td['quan_huyen'] ?>" data-px="<?= $item_td['phuong_xa'] ?>" data-sn="<?= $item_td['so_nha'] ?>" placeholder="Địa chỉ nhà" autocomplete="off">
                        </div>
                    </div>
                </div>
                <!-- ----------------------------------------------------------------------box5--------------------------------------------------------------------- -->
