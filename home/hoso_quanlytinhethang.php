...
if (isset($_COOKIE['UID']) && isset($_COOKIE['UT'])) {
    ...
    if ($type_user == 5) {
        ...
        // tin đã hết hàng
        $all_tinhethang = new db_query("SELECT `new_id`, `new_title`, `link_title`, `new_cate_id`, `da_ban`,
        ...
        AND `new_buy_sell` = 2 AND `new_cate_id` != 120 AND `new_cate_id` != 121 AND tong_sluong = 0 ORDER BY `new_id` DESC $limit");
                ...
                <div class="khoiphai_quanly khoiphai_quanly_df">
                    ...
                    <div class="d_them_div_qltin">
                        ...
                        <div class="khoi_noidung_tin_daban khoi_noidungban_df_qlt">
                            <? while ($all_tin_hethang = (mysql_fetch_assoc($all_tinhethang->result))) {
                                $avatar_tinhethang = $all_tin_hethang['new_image'];
                                $avatar_tinhethang = explode(';', $avatar_tinhethang);
                                $id_tin = $all_tin_hethang['new_id'];
                            ?>
                                <div class="khoicon_ndban d_flex fl_cl">
                                    <div class="d_them_div_flex d_flex fl_row al_ct">
                                        <div class="anh_daidientin">
                                            <a href="/<?= replaceTitle($all_tin_hethang['new_title']) ?>-c<?= $all_tin_hethang['new_id'] ?>.html" v class="img_tinban">
                                                <img src="<?= $avatar_tinhethang[0] ?>" alt="" class="anh_avt_tin" onerror="this.src=`/images/anh_moi/dai_dien_avt.png`">
                                        ...
                                        <div class="khoi_text_ban khoi_text_ban_qltin">
                                            <div class="text-tilte d_flex fl_row al_ct jtf_spb">
                                                <a href="/<?= replaceTitle($all_tin_hethang['link_title']) ?>-c<?= $all_tin_hethang['new_id'] ?>.html" class="title_ban title_ban_df font-16 mb20 elipsis1"><?= $all_tin_hethang['new_title'] ?></a>
                                            </div>
                                            <div class="time_ban_qltdn d_flex fl_row al_ct">
                                                ...
                                                <p class="font-14 font-bold time_ban time_ban_df"><?= lay_tgian($all_tin_hethang['new_create_time']) ?></p>
                                            </div>
                                            <div class="address_ban_qltdn d_flex fl_row al_ct">
                                                ...
                                                <p class="font-14 address_ban address_ban_qltl_df elipsis1"><?= $all_tin_hethang['dia_chi'] ?></p>
                                            </div>
                                            <div class="m_tieuthu_qlt d_flex fl_row jtf_spb">
                                                <div class="m_money_qlt">
                                                    <? if ($all_tin_hethang['chotang_mphi'] == 1) { ?>
                                                        <div class="money-qlt">Cho tặng miễn phí</div>
                                                    <? } else if ($all_tin_hethang['new_money'] > 0) { ?>
                                                        <div class="money-qlt d_flex fl_row al_ct">
                                                            <div class="pdr_5">
                                                                <?= number_format($all_tin_hethang['new_money']) ?> <?= $arr_dvtien[$all_tin_hethang['new_unit']] ?>
                                                            </div>
                                                            <? if ($xacthuc_lket == 1) { ?>
                                                ...
                                                <? if ($xacthuc_lket == 1) { ?>
                                                    <!-- <div class="m_amount_qlt d_flex fl_row al_ct">
                                                        ...
                                                        <p class="m_amount_qlt_text pdl_5 pdr_5 p_400_s14_l17">
                                                            Số lượng: <?= $all_tin_hethang['tong_sluong'] ?>
                                                        </p>
                                                    ...
                                                    <div class="m_sold_qlt d_flex fl_row al_ct">
                                                        ...
                                                        <p class="m_sold_qlt_text pdl_5 p_400_s14_l17">
                                                            Đã bán: <?= $all_tin_hethang['sluong_daban'] ?>
                                                        </p>
                                                    </div> -->
                                                <? } ?>
                                            </div>
                                    ...
                                    <div class="div_3cham_bao_nut">
                                        ...
                                        <? } else { ?>
                                            ...
                                            <div class="btn_div_3cham_bao_nut btn_qlt_df btn_qlt_df_chung btn_qlt_df_3 hid_1200">
                                                <div class="m_anhientin ctn_anhien_<?= $id_tin ?>" data="<?= $id_tin ?>" data1="<?= $all_tin_hethang['new_active'] ?>">
                                                    <!-- an -->
                                                    <? if ($all_tin_hethang['new_active'] == 1) { ?>
                                                ...
                                                <? if ($xacthuc_lket == 0 && $all_tin_hethang['new_active'] == 1) { ?>
                                                    <span class="m_daban_cxtlk cursor_Pt df_daban" data="<?= $id_tin ?>" data1="<?= $all_tin_hethang['da_ban'] ?>">
                                                ...
                                                <? if ($all_tin_hethang['new_pin_home'] == 0 && $all_tin_hethang['new_pin_cate'] == 0 && $all_tin_hethang['new_day_tin'] == "") { ?>
                                                    <? if ($xacthuc_lket == 1  && $all_tin_hethang['new_active'] == 0) { ?>
                                                        <span class="m_boder_bannhanhhon border-gt btn_qlt_df_3_d <?= ($xacthuc_lket == 1 && $all_tin_hethang['new_active'] == 0) ? "op0_5" : "aaaa" ?>">
                                                    ...
                                                    <? } else if ($xacthuc_lket == 1  && $all_tin_hethang['new_active'] == 1) { ?>
                                                        <span class="m_boder_bannhanhhon border-gt btn_qlt_df_3_d <?= ($xacthuc_lket == 1 && $all_tin_hethang['new_active'] == 1) ? "op0_5" : "aaaa" ?>">
                                                            <div class="btn-gt cus_poi text-gt d_flex fl_row al_ct" data="<?= $id_tin ?>">
                                                                <img src="/images/m_raonhanh_imgnew/cartspeed.png" alt="Bán nhanh hơn" class="m_bannhanhhon_qlt img_18">
                                                                <span class="text-gt m_txt_bannh p_400_s15_l18" data="<?= $id_tin ?>">Bán nhanh hơn</span>
                                                            </div>
                                                        </span>
                                                    <? } else if ($xacthuc_lket == 0  && $all_tin_hethang['new_active'] == 0) { ?>
                        ...
                        <div class="m_phantrang w100 d_flex al_ct jtf_ct">
                            <ul class="m_pt_ul d_flex fl_row al_ct">
                                <?= generatePageBar3('', $page, $current_page, $result_tongtinhethang, $url, '?', '', 'active', 'preview', '<', 'next', '>', '', '', '', ''); ?>
                            </ul>
                        </div>
                        <!--  -->
                    </div>
