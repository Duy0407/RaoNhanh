        ...
        <div class="tindang-container">
            ...
            <div class="tindang-content-cont hd-disflex">
                ...
                <div class="tindang-col-right">
                    <form class="form-dtin-cont" id="form_tb_dienlanh">
                        <div class="row-tin-dang danhmuc_tt">
                            <p class="font-dam hd_font15-17">Danh mục sản phẩm <span class="color_red">*</span></p>
                            <input data="<?= $id ?>" type="text" class="dmuc-spham" readonly name="san-pham-laptop" placeholder="Đồ gia dụng  >>  Thiết bị điện lạnh">
                        </div>
                        ...
                        <div class="row-tin-dang cont-btn-sb hd-disflex hide-480-mobile">
                            ...
                            <button type="button" id="xoa_tddang_tin" class="btn-submit td-dang-tin tb_dienlanh hd_cspointer font-bold">ĐĂNG TIN</button>
                        </div>
                    </form>
                </div>
            </div>
...
<script>
    ...
    $(".td-dang-tin").click(function() {
        ...
        if (form_tb_dienlanh.valid() === true) {
            ...
            $.ajax({
                type: 'POST',
                url: '/ajax_dogiadung/dtin_thietbidienlanh.php',
                data: fd,
                processData: false,
                contentType: false,
                beforeSend: function() {
                    $('.tb_dienlanh').prop('disabled', true);
                },
                success: function(data) {
                    if (data == "") {
                        tbao_dtin_tcong();
                        ...
                        $('.tb_dienlanh').prop('disabled', false);
                    }
                }
            })
        }
