...
if (isset($_COOKIE['UID']) && isset($_COOKIE['UT'])) {
    ...
    $list_mhinh = new db_query("SELECT `id_manhinh`, `ten_manhinh` FROM `man_hinh` WHERE `id_danhmuc` = $id AND `id_cha` = 0 ");
...
<head>
    ...
    <title>Đăng tin đồ tiện tử máy tính bảng</title>
                ...
                <div class="ctn_ct_box6 d_flex fl_cl">
                    ...
                    <div class="ctn_ct_b6_fr d_flex fl_row fl_st">
                        <div class="b6_fr1 d_flex fl_cl box_input_infor">
                            ...
                            <select class="b6_fr1_select slect-hang hd_height36" name="hang_tablet" data="<?= $id ?>" onchange="hang_doi(this)">
                    ...
                    <div class="ctn_ct_b6_nl d_flex fl_cl box_input_infor">
                        ...
                        <div class="b6_nl_fr d_flex fl_row">
                            <div class="b6_nl_child b6_nl_xang d_flex fl_row al_ct ">
                                <input type="radio" name="phien_ban" value="1" class="img20 cursor_Pt b6_nl_xang_input b6_nl_input">
                                <p class="b6_nl_xang_text pdl_10">Quốc tế</p>
                            </div>
                            <div class="b6_nl_child b6_nl_dau d_flex fl_row al_ct ">
                                <input type="radio" name="phien_ban" value="2" class="img20 cursor_Pt b6_nl_dau_input b6_nl_input">
                    ...
                    <div class="ctn_ct_b6_nl d_flex fl_cl box_input_infor">
                        ...
                        <div class="b6_nl_fr d_flex fl_row">
                            <div class="b6_nl_child b6_nl_xang d_flex fl_row al_ct ">
                                <input type="radio" name="sdung_sim" value="1" class="img20 cursor_Pt b6_nl_xang_input b6_nl_input">
                                <p class="b6_nl_xang_text pdl_10">Có sử dụng</p>
                            </div>
                            <div class="b6_nl_child b6_nl_dau d_flex fl_row al_ct ">
                                <input type="radio" name="sdung_sim" value="2" class="img20 cursor_Pt b6_nl_dau_input b6_nl_input">
