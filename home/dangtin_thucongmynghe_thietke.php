...
<head>
    ...
    <title>Đăng tin thủ công mỹ nghệ thiết kế, phong thủy</title>
        ...
        <div class="tindang-container">
            ...
            <div class="tindang-content-cont hd-disflex">
                ...
                <div class="tindang-col-right">
                    <form class="form-dtin-cont" id="form_tcmn_thietkephongthuy" data="<?= $us_id ?>" data1="<?= $us_type ?>">
                        <div class="row-tin-dang danhmuc_tt">
                            <p class="font-dam hd_font15-17">Danh mục sản phẩm <span class="color_red">*</span></p>
                            <input type="text" class="dmuc-spham" readonly name="san-pham-laptop" data="<?= $id ?>" placeholder="Thủ công - Mỹ nghệ - Quà tặng >> Thiết kế, phong thủy">
                        </div>
                        ...
                        <div class="row-tin-dang cont-btn-sb hd-disflex hide-480-mobile">
                            ...
                            <button type="button" id="xoa_tddang_tin" class="btn-submit td-dang-tin thietkephongthuy hd_cspointer font-bold">ĐĂNG TIN</button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        $(".td-dang-tin").click(function() {
            ...
            if (form_tcmn_thietkephongthuy.valid() === true) {
                ...
                $.ajax({
                    ...
                    contentType: false,
                    beforeSend: function() {
                        $('.thietkephongthuy').prop('disabled', true);
                    },
                    success: function(data) {
                        if (data == "") {
                            ...
                            $('.thietkephongthuy').prop('disabled', false);
                        }
                    }
                })
            }
