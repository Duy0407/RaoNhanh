...
if (isset($_COOKIE['UID']) && isset($_COOKIE['UT'])) {
    $acc_id = $_COOKIE['UID'];
    $acc_type = $_COOKIE['UT'];
    $sql_dm = new db_query("SELECT `tags_id`, `ten_tags` FROM `key_tags` WHERE id_danhmuc = 114");
...
<body>
    ...
    <section id="m_dangtin_thucung" class="suckhoe thethao thucung" data="<?= date('Y-m-d') ?>">
        ...
        <form class="form-dtin-cont form_bds_chung" id="form_doan_phukien" data="<?= $acc_id ?>" data1="<?= $acc_type ?>" data3="<?= $xacthuc_lket ?>">
            <div class="container_content">
                ...
                <div class="b6_loaihinh loai_dungcu d_flex fl_cl box_input_infor">
                    ...
                    <select id="giong_thucung" class="slect-hang hd_height36 b6_lhinh_select giong_thucung" name="giong_thucung">
    ...
    <script>
        ...
        $(".b11_btn_dangtin").click(function() {
            ...
            if (form_doan_phukien.valid() === true) {
                ...
                var xac_thuc = $("#form_doan_phukien").attr("data3");
