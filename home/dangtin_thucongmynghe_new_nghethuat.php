...
if (isset($_COOKIE['UID']) && isset($_COOKIE['UT'])) {
    $acc_id = $_COOKIE['UID'];
    $acc_type = $_COOKIE['UT'];
    $sql_dm = new db_query("SELECT `tags_id`, `ten_tags` FROM `key_tags` WHERE id_danhmuc = 88");
...
<head>
    ...
    <title>Đăng tin Nghệ thuật thủ công </title>
...
<body>
    ...
    <section id="m_dangtin_thucongmynghe" class="suckhoe thucongmynghe">
        ...
        <form class="form-dtin-cont form_bds_chung" id="form_tcmn_nghethuat" data="<?= $acc_id ?>" data1="<?= $acc_type ?>" data3="<?= $xacthuc_lket ?>">
    ...
    <script>
        $(".b11_btn_dangtin").click(function() {
            ...
            if (form_tcmn_nghethuat.valid() === true) {
                ...
                $.ajax({
                    url: '/ajax_tcquatang/dtin_nghethuat.php',
                    type: 'POST',
                    data: fd,
                    contentType: false,
                    processData: false,
