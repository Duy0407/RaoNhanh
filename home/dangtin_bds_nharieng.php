...
<head>
    ...
    <title>Đăng tin bất động sản nhà riêng, nguyên căn</title>
        ...
        <div class="tindang-container">
            ...
            <div class="tindang-content-cont hd-disflex">
                ...
                <div class="tindang-col-right">
                    <form class="form-dtin-cont" id="form_bds_nharieng" data="<?= $acc_id ?>" data1="<?= $acc_type ?>">
                        <div class="row-tin-dang danhmuc_tt">
                            <p class="font-dam hd_font15-17">Danh mục sản phẩm <span class="color_red">*</span></p>
                            <input type="text" class="dmuc-spham" data="29" readonly name="san-pham-laptop" placeholder="Bất động sản >> Nhà riêng, nguyên căn">
                        </div>
