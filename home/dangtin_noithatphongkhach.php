...
<head>
    ...
    <title>Đăng tin nội thất phòng khách</title>
        ...
        <div class="tindang-container">
            ...
            <div class="tindang-content-cont hd-disflex">
                ...
                <div class="tindang-col-right">
                    <form class="form-dtin-cont fid_gia_mb" id="form_noithatpk">
                        <div class="row-tin-dang danhmuc_tt">
                            <p class="font-dam hd_font15-17">Danh mục sản phẩm <span class="color_red">*</span></p>
                            <input data="<?= $id ?>" type="text" class="dmuc-spham" readonly name="san-pham-laptop" placeholder="Nội thất - Ngoại thất >> Nội thất phòng khách">
                        </div>
                            ...
                            <div class="d_themdiv_gia_7_8">
                                <div class="input-gia-cont d_8-7_tclass3">
                                    ...
                                    <div class="money_div d_8-7_tclass5">
                                        <select class="dt-money-up donvi_ban" name="donvi_ban">
                        ...
                        <div class="row-tin-dang-btn cont-btn-sb hd-disflex hide-480-mobile">
                            ...
                            <button type="button" id="xoa_tddang_tin" class="btn-submit td-dang-tin noithatpk hd_cspointer font-bold">ĐĂNG TIN</button>
                        </div>
                    </form>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    $(".td-dang-tin").click(function() {
        ...
        if (form_noithatpk.valid() === true) {
            ...
            $.ajax({
                type: 'POST',
                url: '/ajax_noithat_ngoaithat/dtin_phongkhach.php',
                data: fd,
                processData: false,
                contentType: false,
                beforeSend: function() {
                    $('.noithatpk').prop('disabled', true);
                },
                success: function(data) {
                    if (data == "") {
                        tbao_dtin_tcong();
