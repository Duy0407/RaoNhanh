...
<head>
    ...
    <title>Chỉnh sửa tin xe đạp điện</title>
                ...
                <div class="tindang-col-right">
                    <form class="form-dtin-cont" id="form_xeco_xedapdien" data="<?= $acc_id ?>" data1="<?= $acc_type ?>" data2="<?= $id_xc ?>">
                        <div class="row-tin-dang danhmuc_tt">
                            ...
                            <input type="text" data="<?= $sql_nd['new_cate_id'] ?>" class="dmuc-spham" readonly name="san-pham-laptop" placeholder="Xe cộ  >>  Xe đạp điện">
                        </div>
                        ...
                        <div class="row-tin-dang cont-btn-sb hd-disflex">
                            ...
                            <button type="button" class="btn-submit xedapdien td-dang-tin hd_cspointer font-bold">CHỈNH SỬA</button>
                        </div>
                    </form>
                </div>
            </div>
