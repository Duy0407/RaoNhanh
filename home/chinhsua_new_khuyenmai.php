...
if (isset($_COOKIE['UID']) && isset($_COOKIE['UT']) && $id_dm != 0 && $id_nd != 0) {
    ...
    if (mysql_num_rows($list_tin->result) > 0) {
        ...
        // tag danh muc
        $ban = new db_query("SELECT `tags_id`, `ten_tags` FROM `key_tags` WHERE `id_danhmuc` = 24 AND type_tags = '" . $item_td['can_ban_mua'] . "' ");
...
<body>
    ...
    <section id="m_dangtin_khuyenmai" class="suckhoe khuyenmai">
        ...
        <form class="form-dtin-cont form_bds_chung" id="form_khuyenmai" data="<?= $acc_id ?>" data1="<?= $acc_type ?>" data2="<?= $id_nd ?>">
    ...
    <script>
        ...
        $(".b11_btn_chinhsua").click(function() {
            ...
            if (form_khuyenmai.valid() === true) {
                ...
                var id_nd = $("#form_khuyenmai").attr("data2");
