...
<head>
    ...
    <title>Đăng tin đồ chuyên dụng, giống nuôi trồng</title>
    ...
    <link type="text/css" href="/css/style_new/select2.min.css" rel="stylesheet" />
...
<body>
        ...
        <div class="tindang-container">
            ...
            <div class="tindang-content-cont hd-disflex">
                ...
                <div class="tindang-col-right">
                    <form class="form-dtin-cont" id="form_gnuoitrong" data="<?= $us_id ?>" data1="<?= $us_type ?>">
                        <div class="row-tin-dang danhmuc_tt">
                            <p class="font-dam hd_font15-17">Danh mục sản phẩm <span class="color_red">*</span></p>
                            <input type="text" class="dmuc-spham" readonly name="san-pham-laptop" data="<?= $id ?>" placeholder="Đồ dùng văn phòng, công nông nghiệp  >>  Đồ chuyên dụng, Giống nuôi trồng">
                        </div>
                        ...
                        <div class="row-tin-dang border_price">
                        ...
                        <div class="row-tin-dang box_input_infor">
                            ...
                            <select class="slect-hang hd_height36" name="chitiet_dm">
                                ...
                                <? while ($row_dm = mysql_fetch_assoc($list_ktag->result)) { ?>
                                    <option value="<?= $row_dm['tags_id'] ?>"><?= $row_dm['ten_tags'] ?></option>
                                <? } ?>
                            </select>
                        </div>
                        <div class="row-tin-dang box_input_infor">
                        ...
                        <div class="row-tin-dang cont-btn-sb hd-disflex hide-480-mobile">
                            ...
                            <button type="button" id="xoa_tddang_tin" class="btn-submit td-dang-tin nuoitrong hd_cspointer font-bold">ĐĂNG TIN</button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <script type="text/javascript">
        $(".td-dang-tin").click(function() {
            var form_giongnuoitrong = $("#form_gnuoitrong");
            form_giongnuoitrong.validate({
            ...
            if (form_giongnuoitrong.valid() === false) {
            ...
            if (form_giongnuoitrong.valid() === true) {
