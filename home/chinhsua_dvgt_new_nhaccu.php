...
if (isset($_COOKIE['UID']) && isset($_COOKIE['UT']) && $id_nd != 0 && $id_dm != 0) {
    ...
    $list_tin = new db_query("SELECT `new`.`new_id`, `new_title`,`link_title`,`new_money`, `new_cate_id`, 
                                ...
                                `new_description`,`new_description`,`loai_chung`,`canhan_moigioi`
...
<body>
    ...
    <section id="m_dangtin_dichvu" class="suckhoe dichvugiaitri">
        ...
        <form class="form-dtin-cont form_bds_chung" id="form_dv_nhaccu" data="<?= $acc_id ?>" data1="<?= $acc_type ?>" data2="<?= $id_nd ?>" data3="<?= $xacthuc_lket ?>">
            <div class="container_content">
                ...
                <div class="ctn_ct_box1 d_flex fl_cl w100">
                    ...
                    <div class="ctn_ct_b1_fr2 w100">
                        <div class="b1_fr2_title w100">
                            <p class="b1_fr2_title_p p_400_s16_l19 d_flex fl_row al_ct" data="100">
                ...
                <div class="b6_loaihinh loai_dungcu d_flex fl_cl box_input_infor">
                    <p class="b6_lhinh_txt p_400_s15_l18">
                        Loại nhạc cụ <span class="cl_red">*</span>
                    </p>
                    <select class="slect-hang hd_height36 b6_lhinh_select loai_nhac_cu" name="loai_nhac_cu">
                        <option value="">Loại nhạc cụ</option>
                        <? foreach ($db_lchung as $rows) {
                            if ($rows['id_danhmuc'] == 100) { ?>
    ...
    <script>
        // 
        $('.loai_nhac_cu').on('change', function() {
            var id_nc = $("select[name='loai_nhac_cu']").val();
        ...
        $(".b11_btn_chinhsua").click(function() {
            ...
            if (form_dv_nhaccu.valid() === true) {
                ...
                var user_id = $("#form_dv_nhaccu").attr("data");
                var user_type = $("#form_dv_nhaccu").attr("data1");
                var id_dm = $(".b1_fr2_title_p").attr('data');
                var id_nd = $("#form_dv_nhaccu").attr("data2");
                ...
                var xac_thuc = $("#form_dv_nhaccu").attr("data3");
