                ...
                <div class="tindang-col-right">
                    <form class="form-dtin-cont" id="form_dt_tablet" data="<?= $us_id ?>" data1="<?= $us_type ?>">
                        <div class="row-tin-dang-dau">
                            ...
                            <input type="text" class="dmuc-spham" name="danhmucsanpham_dt" readonly data="<?= $id ?>" placeholder="Đồ điện tử >> Máy tính bảng">
                        </div>
                        <div class="row-tin-dang box_input_infor">
                            <p class="font-dam hd_font15-17">Tiêu đề <span class="color_red">*</span></p>
                            <input class="input_infor_tag error focus-outline" type="text" name="tieude_tablet" placeholder="Nhập tiêu đề" autocomplete="off">
                        </div>
                        <div class="row-tin-dang box_input_infor">
                            <p class="font-dam hd_font15-17">Hãng <span class="color_red">*</span></p>
                            <select name="hang_tablet" class="slect-hang hd_height36" data="<?= $id ?>" onchange="hang_doi(this)">
                        ...
                        <div class="row-tin-dang box_input_infor">
                            ...
                            <input readonly type="text" name="td_dia_chi" class="td_ttin_diachi input_infor_tag error" placeholder="Địa chỉ" class="focus-outline">
                        </div>
                        <div class="row-tin-dang box_input_infor">
