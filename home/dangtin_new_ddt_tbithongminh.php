...
if (isset($_COOKIE['UID']) && isset($_COOKIE['UT'])) {
    ...
    $qr_thietbi = new db_query("SELECT `id`, `ten_loai`  FROM `loai_chung` WHERE `id_danhmuc` = $id ");
...
<head>
    ...
    <title>Đăng tin đồ tiện tử thiết bị thông minh</title>
                ...
                <div class="ctn_ct_box6 d_flex fl_cl">
                    ...
                    <div class="ctn_ct_b6_fr d_flex fl_row fl_st">
                        <div class="b6_fr1 d_flex fl_cl box_input_infor">
                            ...
                            <select class="b6_fr1_select slect-hang hd_height36" name="thiet_bi" data="<?= $id ?>" onchange="tbi_doi(this)">
                                <option disabled selected value="">Chọn</option>
                                <? while ($row_tbi = mysql_fetch_assoc($qr_thietbi->result)) { ?>
                                    <option value="<?= $row_tbi['id'] ?>"><?= $row_tbi['ten_loai'] ?></option>
                                <? } ?>
                            </select>
                        </div>
                        <div class="b6_fr2 d_flex fl_cl box_input_infor hang_doi">
                            <p class="b6_fr1_title p_400_s15_l18">Hãng <span class="cl_red">*</span></p>
                            <select class="b6_fr1_select slect-hang hd_height36 hang_tb" name="hang_tb">
                                <option disabled selected value="">Chọn</option>
                            </select>
                        </div>
                    </div>
