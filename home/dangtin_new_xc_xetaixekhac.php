...
<head>
    ...
    <title>Đăng tin xe tải, xe ben</title>
...
<body>
    ...
    <section id="m_dangtin_xc_xetai" class="xeco">
        ...
        <form class="form-dtin-cont form_bds_chung" id="form_xeco_xetaixekhac" data="<?= $acc_id ?>" data1="<?= $acc_type ?>" data3="<?= $xacthuc_lket ?>">
                        ...
                        <div class="b6_ft1 d_flex fl_cl box_input_infor">
                            ...
                            <select class="slect-hang  hd_height36" name="trong_tai">
                                ...
                                <? foreach ($result_tt as $tt) : ?>
                                    <option class="p_400_s14_l17" value="<?= $tt['id_dl'] ?>"><?= $tt['ten_dl'] ?></option>
                                <? endforeach ?>
                            </select>
                        </div>
                    </div>
