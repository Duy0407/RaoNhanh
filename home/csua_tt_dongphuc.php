...
<head>
    ...
    <title>Chỉnh sửa thời trang đồ đôi, đồng phục </title>
                ...
                <div class="tindang-col-right" data="<?= $id_cs ?>">
                    <form class="form-dtin-cont" id="form_thoitrang_dongphuc" data="<?= $us_id ?>" data1="<?= $us_type ?>">
                        <div class="row-tin-dang danhmuc_tt">
                            ...
                            <input type="text" class="dmuc-spham" readonly name="san-pham-laptop" data="<?= $id_dm ?>" placeholder="Thời trang >> Đồ đôi, đồng phục">
                        </div>
                        ...
                        <div class="row-tin-dang-btn cont-btn-sb hd-disflex hide-480-mobile">
                            ...
                            <button type="button" class="btn-submit td-dang-tin dongphuc hd_cspointer font-bold">ĐĂNG TIN</button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <script type="text/javascript">
        $(".dongphuc").click(function() {
            ...
            if (form_thoitrang_dongphuc.valid() === true) {
                ...
                $.ajax({
                    type: 'POST',
                    url: '/ajax_thoitrang/csua_dongphuc.php',
                    data: fd,
                    processData: false,
                    contentType: false,
