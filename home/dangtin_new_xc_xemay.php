...
<body>
    ...
    <section id="m_dangtin_xc_xemay" class="xeco">
        ...
        <form class="form-dtin-cont form_bds_chung" id="form_xeco_moto" data="<?= $acc_id ?>" data1="<?= $acc_type ?>" data3= "<?= $xacthuc_lket?>">
                ...
                <div class="ctn_ct_box6 d_flex fl_cl">
                    ...
                    <div class="ctn_ct_b6_dtbsx d_flex fl_row fl_st">
                        ...
                        <div class="b6_bs_biensoxe">
                            ...
                            <input type="text" name="td_bien_soxe" class="b6_bs_biensoxe_input" placeholder="Biển số xe">
                        </div>
                    </div>
                    ...
                    <div class="ctn_ct_b6_sokmdadi">
                        <div class="b6_sokmdadi d_flex fl_cl flex_start box_input_infor">
                            ...
                            <input type="text" class="b6_sokmdadi_input" placeholder="Số Km đã đi" name="km_di" onkeydown="javascript: return ['Backspace','Delete','ArrowLeft','ArrowRight'].includes(event.code) ? true : !isNaN(Number(event.key)) && event.code!=='Space'">
                        </div>
                    </div>
                </div>
                <!-- ---------------------------------------------------------------------Thong tin ban hang------------------------------------------------------------------------- -->
