...
<head>
    ...
    <link rel="stylesheet" href="../css/style_new/footer.css?v='<?= $version ?>'">
    ...
    <title>Chọn loại đăng tin</title>
...
<body>
    ...
    <section>
        <div class="content-register">
            <p class="register-title">Người đăng tin</p>
            <div class="box-regis">
                <div class="box-choose">
                    <p class="text">Tin mua</p>
                    <img class="image lazyload" src="../images/loading.gif" data-src="../images/newImages/regis-sell.png" alt="" class="img-u">
                    <a href="/dang-tin-san-pham-mua.html" class="choose" id="register_buy">Đăng tin mua</a>
                </div>
                <div class="box-choose">
                    <p class="text">Tin bán</p>
                    <img class="image lazyload" src="../images/loading.gif" data-src="../images/newImages/pana.png" alt="" class="img-u">
                    <a href="/dang-tin-san-pham-ban.html" class="choose" id="choose_sell">Đăng tin bán</a>
                </div>
            </div>
        </div>
    </section>
