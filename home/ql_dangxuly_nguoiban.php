...
if (isset($_COOKIE['UID']) && isset($_COOKIE['UT'])) {
    ...
    $list_dh = new db_query("SELECT `dh_id`,`id_nguoi_dh`, `id_nguoi_ban`, `id_spham`, `ghi_chu`, `loai_ttoan`, `tien_ttoan`, `dia_chi_nhanhang`, `trang_thai`,
                            ...
                            WHERE `trang_thai` = 1 AND `id_nguoi_ban` = $id_user ");
...
<body>
                            ...
                            while ($row_tin = mysql_fetch_assoc($list_dh->result)) {
                                ...
                                <div class="content-item-1">
                                    ...
                                    <div class="box-right-content-bot">
                                        ...
                                        <div class="content-bot-c ml_10">
                                            <a class="ten_sp color_orange" href="chi-tiet-don-dang-xu-ly-<?= $row_tin['dh_id'] ?>.html">
                                                <?= $row_tin['new_title'] ?>
                                            </a>
                                    ...
                                    <div class="main-t-btn-ql">
                                        <button class="xacnhan-2" data="<?= $row_tin['dh_id'] ?>">Bắt đầu giao hàng</button>
    ...
    <div id="modal_giaohang" class="modal">
        <div class="modal-content-huydon">
            <div class="huydon-header">
                <p>Xác nhận giao hàng</p>
                <span class="close">&times;</span>
            </div>
            <div class="huydon-content">
                <p>Người bán chủ động trao đổi với người mua hình thức và phương tiện giao hàng. </p>
            </div>
            <div class="huydon-footer">
                <button type="button" class="modal-btn-huy huy_giaohang">Hủy bỏ</button>
                <button type="button" class="modal-btn-xacnhan" data="" onclick="bd_giaohang(this)">Xác nhận giao hàng</button>
            </div>
        </div>
