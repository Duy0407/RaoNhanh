...
if (isset($_COOKIE['UID']) && isset($_COOKIE['UT'])) {
    $acc_id = $_COOKIE['UID'];
    $acc_type = $_COOKIE['UT'];
    $sql_dm = new db_query("SELECT `tags_id`, `ten_tags` FROM `key_tags` WHERE id_danhmuc = 113");
...
<head>
    ...
    <title>Đăng tin Thú cưng Chim </title>
...
<body>
    ...
    <section id="m_dangtin_thucung" class="suckhoe thucung">
        ...
        <form class="form-dtin-cont form_bds_chung" id="form_tc_chim" data="<?= $acc_id ?>" data1="<?= $acc_type ?>" data3="<?= $xacthuc_lket ?>">
    ...
    <script>
        $(".b11_btn_dangtin").click(function() {
            var form_tc_chim = $("#form_tc_chim");
            form_tc_chim.validate({
            ...
            if (form_tc_chim.valid() === false) {
                $("#xoa_tddang_tin").addClass("b11_btn_dangtin");
                event.preventDefault();
                event.stopPropachimtion();
            ...
            if (form_tc_chim.valid() === true) {
                $("#xoa_tddang_tin").removeClass("b11_btn_dangtin");
                var user_id = $("#form_tc_chim").attr("data");
                var user_type = $("#form_tc_chim").attr("data1");
                ...
                var xac_thuc = $("#form_tc_chim").attr("data3");
                ...
                $.ajax({
                    url: '/ajax_thucung/dangtin_thucung_chim.php',
                    type: 'POST',
                    data: fd,
                    contentType: false,
                    processData: false,
    ...
    <script>
        ...
        function xem_trc_tin() {
            var form_tc_chim = $(".form-dtin-cont");
            form_tc_chim.validate({
                errorPlacement: function(error, element) {
                    error.appendTo(element.parents(".box_input_infor"));
                    error.wrap("<span class='error'>");
