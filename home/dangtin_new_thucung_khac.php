...
if (isset($_COOKIE['UID']) && isset($_COOKIE['UT'])) {
    $acc_id = $_COOKIE['UID'];
    $acc_type = $_COOKIE['UT'];
    $sql_dm = new db_query("SELECT `tags_id`, `ten_tags` FROM `key_tags` WHERE id_danhmuc = 115");
...
<body>
    ...
    <section id="m_dangtin_thucung" class="suckhoe thucung">
        ...
        <form class="form-dtin-cont form_bds_chung" id="form_tc_khac" data="<?= $acc_id ?>" data1="<?= $acc_type ?>" data3="<?= $xacthuc_lket ?>">
            <div class="container_content">
                ...
                <div class="dotuoi_thucung d_flex fl_cl box_input_infor m_input_chung pd_t_20">
                    ...
                    <input type="text" class="do_tuoi input_infor_tag" name="do_tuoi" placeholder="Nhập độ tuổi">
                </div>
                <!-- kich co -->
                <div class="kichco_thucung d_flex fl_cl box_input_infor m_input_chung pd_t_20">
                    ...
                    <input type="text" class="kichco input_infor_tag" name="kichco" placeholder="Nhập Kích cỡ thú cưng">
                </div>
                <!-- giới tính -->
    ...
    <script>
        $(".b11_btn_dangtin").click(function() {
            ...
            if (form_tc_khac.valid() === true) {
                ...
                var xac_thuc = $("#form_tc_khac").attr("data3");
