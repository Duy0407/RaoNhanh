                ...
                <div class="tindang-col-right">
                    <form class="form-dtin-cont" id="form_dt_laptop" data="<?= $us_id ?>" data1="<?= $us_type ?>">
                        <div class="row-tin-dang">
                            ...
                            <input type="text" class="dmuc-spham" readonly name="san-pham-laptop" data="<?= $id ?>" placeholder="Đồ điện tử >> Laptop">
                        </div>
                        <div class="row-tin-dang box_input_infor">
                            <p class="font-dam hd_font15-17">Tiêu đề <span class="color_red">*</span></p>
                            <input class="input_infor_tag error" type="text" name="tieude1" placeholder="Nhập tiêu đề" autocomplete="off">
                        </div>

                        <div class="row-tin-dang box_input_infor">
                            <p class="font-dam hd_font15-17">Hãng <span class="color_red">*</span></p>
                            <select name="hangsp" class="slect-hang hd_height36" data="<?= $id ?>" onchange="hang_doi(this)">
                        ...
                        <div class="tt-o-cung hd-disflex mt20">
