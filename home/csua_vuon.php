        ...
        <div class="tindang-container">
            ...
            <div class="tindang-content-cont hd-disflex">
                ...
                <div class="tindang-col-right" data="<?= $id_cs ?>">
                    <form class="form-dtin-cont" id="form_noithatvuon" data="<?= $us_id ?>" data1="<?= $us_type ?>">
                        <div class="row-tin-dang danhmuc_tt">
                            <p class="font-dam hd_font15-17">Danh mục sản phẩm <span class="color_red">*</span></p>
                            <input data="<?= $id_dm ?>" type="text" class="dmuc-spham" readonly name="san-pham-laptop" placeholder="Nội thất - Ngoại thất >> Vườn">
                        </div>
                        ...
                        <div class="row-tin-dang-btn cont-btn-sb hd-disflex hide-480-mobile">
                            <button type="button" class="btn-submit td-xem-truoc hd_cspointer font-bold">XEM
                                TRƯỚC</button>
                            <button type="button" class="btn-submit td-dang-tin noithatvuon hd_cspointer font-bold">ĐĂNG
                                TIN</button>
                        </div>
                    </form>
                </div>
...
<script type="text/javascript">
    $(".noithatvuon").click(function() {
        ...
        if (form_noithatvuon.valid() === true) {
            ...
            $.ajax({
                type: 'POST',
                url: '/ajax_noithat_ngoaithat/csua_ntkhac_vuon.php',
                data: fd,
                processData: false,
                contentType: false,
