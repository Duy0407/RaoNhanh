...
<body>
    ...
    <section id="m_dangtin_thethao" class="thethao">
        ...
        <form class="form-dtin-cont form_bds_chung" id="form_dcuthethao" data="<?= $acc_id ?>" data1="<?= $acc_type ?>" data2="<?= $id_nd ?>" data3="<?= $xacthuc_lket ?>">
            <div class="container_content">
                ...
                <div class="b6_loaihinh loai_dungcu d_flex fl_cl box_input_infor">
                    ...
                    <? if ($id_monthethao != 8) { ?>
                        <select class="slect-hang hd_height36 loai_dungcu_ban" name="loai_dungcu_ban">
                            ...
                            <? foreach ($db_lchung as $lc) {
                                if ($lc['id_danhmuc'] == 75 && $lc['id_cha'] == $item_td['mon_the_thao']) {
                            ?>
                    ...
                    <? } else { ?>
                        <input type="text" class="hd_height36 loai_dungcu_ban" name="loai_dungcu_ban" value="<?= $item_td['loai_chung'] ?>">
                    <? } ?>
                </div>
                <!-- tinh trang -->
    ...
    <script>
        ...
        $(".b11_btn_chinhsua").click(function() {
            ...
            if (form_dcuthethao.valid() === true) {
                ...
                var id_nd = $("#form_dcuthethao").attr("data2");
