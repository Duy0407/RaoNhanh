...
if (isset($_COOKIE['UID']) && isset($_COOKIE['UT'])) {
    ...
    $qr_nhom = new db_query("SELECT `id`, `name`  FROM `nhom_sanpham` WHERE `id_danhmuc` = $id ");
} else {
    header('Location: /');
}
?>
            ...
            <div class="container_content">
                ...
                <div class="ctn_ct_b3_fr">
                    <div class="ctn_ct_b3_fr1 box_input_infor">
                        ...
                        <input type="text" name="tieu_de" value="" class="b3_fr1_input p_400_s14_l17" placeholder="Nhập tiêu đề" autocomplete="off">
                ...
                <div class="b6_nl_title d_flex fl_cl">
                    <div class="d_flex fl_row fl_st w_100">
                        <div class="d_flex fl_cl box_input_infor w_100">
                            ...
                            <select class="b6_fr1_select slect-hang hd_height36 nhom_spham" name="nhom_spham" data="<?= $id ?>">
