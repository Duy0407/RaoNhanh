    ...
    if ($cou_file > 0 || $cou_dang > 0) {
        ...
        if (mysql_num_rows($query_check->result) > 0) {
            ...
            $query_xc = new db_query("UPDATE `new` SET `new_title`='$tieu_de',`new_money`='$td_gia_spham',
                                                        ...
                                                        `phuong_xa`='$phuong_xa',`new_phone` = '$sdt_lienhe',
                                                        `new_email` = '$email_lhe' ,`new_sonha`='".$so_nha."', 
                                                        `dia_chi`='".$dia_chi."', `new_video`='$file_video', 
                                                        `new_ctiet_dmuc`='$ctiet_dmuc',`new_tinhtrang`='$tinhtrang',
                                                        `new_baohanh`='$bao_hanh',`thoigian_kmbd` = '$ngay_bat_dau',
            ...
            $query_des = new db_query("UPDATE `new_description` SET 
                                                                ...
                                                                `mau_sac`='$mau_sac',`dong_co`='$dong_co',
                                                                `xuat_xu`='$xuat_xu',`td_bien_soxe` = '$td_bien_soxe', 
