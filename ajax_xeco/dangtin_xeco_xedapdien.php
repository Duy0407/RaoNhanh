        ...
        if ($cou_file > 0 || $cou_dang > 0) {
            ...
            if (mysql_num_rows($query_check->result) > 0) {
                ...
                $query_dt = new db_query("INSERT INTO `new`(`new_title`,`link_title`,`new_money`, `new_cate_id`, `new_city`, `new_user_id`, `new_image`,
                                            ...
                                            `da_ban`,`chotang_mphi`, `quan_huyen`, `phuong_xa`, `new_sonha`,`dia_chi`, `new_video`, `new_ctiet_dmuc`,`new_tinhtrang`,
                ...
                $query_decription = new db_query("INSERT INTO `new_description`(`new_id`, `new_description`,`hang`,`mau_sac`,`dong_co`,`canhan_moigioi`,
                                            `td_bien_soxe`,`xuat_xu`) VALUES ('$id_dt','$mo_ta','$hang_xe','$mau_sac','$dong_co','$canhan_moigioi',
                                            '$td_bien_soxe','$xuat_xu')");
                ...
                //     'FromWeb' => $domain
                // ];
                // $MessageInforSupport = "Xin chào, " . $usc_company . "" . $phone . "" . $email . "tôi vừa đăng tin xe đạp điện trên " . $domain;
                // $message = "Tôi tên là: " . $user_name . ", " . $phone . "" . $email . "tôi vừa đăng tin xe đạp điện trên " . $domain;
                // $data_send_to_group = [
                //     'LiveChat' => $LiveChat,
