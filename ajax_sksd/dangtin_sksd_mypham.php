            ...
            if ($user_id != 0 && $user_type != 0 && $tieu_de != "") {
                if ($cou_file > 0 || $cou_dang > 0) {
                    ...
                    if (mysql_num_rows($query_check->result) > 0) {
                        ...
                        $query_decription = new db_query("INSERT INTO `new_description`(`new_id`, `new_description`,`loai_hinh_sp`,`loai_sanpham`,`hang`,
                                            `han_su_dung`,`canhan_moigioi`) VALUES ('$id_dt','$mo_ta','$loaihinh','$loai_mypham','$hang','$hansudung','$canhan_moigioi')");
                        ...
                        //     'FromWeb' => $domain
                        // ];
                        // $MessageInforSupport = "Xin chào, " . $usc_company . "" . $phone . "" . $email . "tôi vừa đăng tin sức khỏe sắc đẹp mỹ phẩm trên " . $domain;
                        // $data_send_to_group = [
                        //     'LiveChat' => $LiveChat,
