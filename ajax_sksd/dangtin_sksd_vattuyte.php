...
if (isset($_COOKIE['UID'])) {
    ...
    $loai_vattu = getValue('loai_vattu', 'int', 'POST', 0);
    ...
    if ($user_id != 0 && $user_type != 0 && $tieu_de != '') {
        if ($cou_file > 0 || $cou_dang > 0) {
            ...
            if (mysql_num_rows($query_check->result) > 0) {
                ...
                $query_decription = new db_query("INSERT INTO `new_description`(`new_id`, `new_description`,`loai_sanpham`,`hang_vattu`,`canhan_moigioi`)
                                                VALUES ('$id_dt','$mo_ta','$loai_vattu','$hang','$canhan_moigioi')");
                ...
                //     'FromWeb' => $domain
                // ];
                // $MessageInforSupport = "Xin chào, " . $usc_company . "" . $phone . "" . $email . "tôi vừa đăng tin vật tư - y tế trên " . $domain;
                // $data_send_to_group = [
                //     'LiveChat' => $LiveChat,
                ...
                //     'loai_sanpham' => $loai_vattu, // Loại vật tư, Loại phụ kiện
                //     'hang_vattu' => $hang,
