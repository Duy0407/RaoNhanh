        ...
        if ($cou_file > 0 || $cou_dang > 0) {
            ...
            if (mysql_num_rows($query_check->result) > 0) {
                ...
                $query = new db_query("UPDATE `new` SET `new_title`='$tieu_de',`new_money`='$td_gia_spham', `new_city`='$tinh_thanh', `new_image`='$file_anh',
                                    ...
                                    `new_tinhtrang`='$tinhtrang', `new_buy_sell` = '2', `new_phone`='$sdt_lhe',`new_email` ='$email_lhe'
                ...
                $query_des = new db_query("UPDATE `new_description` SET  `new_description`='$mo_ta', `loai_sanpham`='$loai_vattu', `hang_vattu`='$hang',
                ...
                //     'FromWeb' => $domain
                // ];
                // $MessageInforSupport = "Xin chào, " . $usc_company . "" . $phone . "" . $email . "tôi vừa chỉnh sửa tin đăng vật tư - y tế: " . $id_nd . " trên " . $domain;
                // $data_send_to_group = [
                //     'LiveChat' => $LiveChat,
