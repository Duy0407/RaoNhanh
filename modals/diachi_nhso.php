        ...
        <form id="form_md_diachi">
            <div class="hd-padding30-50 ">
                ...
                <div class="hd-align-center md-dia-chi select-change box_input_infor">
                    ...
                    <select name="quanhuyen" class="md_quan_huyen" data="<?= $quan_huyen1 ?>" onchange="quan_huyen(this)">
                        <option value="">Quận/huyện</option>
                        <? if (isset($tinh_thanh1) && $tinh_thanh1 != "") {
                            $list_qhuyen = new db_query("SELECT `cit_id`, `cit_name` FROM `city2` WHERE `cit_parent` = $tinh_thanh1 ");
                ...
                <div class="bnt-cont-dc-poup">
                    <button type="button" class="btn-xac-nhan xacnhan_dc hd_cspointer" onclick="md_dia_chi()">Xác nhận</button>
                </div>
            </div>
        </form>
    </div>
