...
//     var listProduct = $('#list_product').val();
...
//         check = false;
//     }else{
//         var checkExistEmail = checkExitsEmail(2,email);
...
//         $("#password").addClass("error");
//         $('.error_password').text('Độ dài mật khẩu tối thiểu 6 ký tự');
//         check = false;
...
//         $("#repassword").addClass("error");
//         $('.error_repassword').text('Độ dài mật khẩu tối thiểu 6 ký tự');
//         check = false;
...
//     if(listProduct == ''){
//         $('#list_product').addClass("error");
//         $('.error_list_product').text('Bạn chưa nhập danh mục sản phẩm');
//         check = false;
//     }else{
//         $('#list_product').removeClass("error"), $(".error_list_product").text('');
//     }

//     // loại sản phẩm
//     if(productType == ''){
//         $('#product_type').addClass("error");
//         $('.error_product_type').text('Bạn chưa nhập loại sản phẩm');
//         check = false;
//     }else{
//         $('#product_type').removeClass("error"), $(".error_product_type").text('');
//     }
...
$(document).ready(function(){
    $('#list_product').change(function(){
        ...
        let url = "/ajaxNew/ajaxListCategoryDetail.php";
        let response = callAjax('post', url, formData, true);
        if (response != undefined) {
    ...
    $('.btn_regist_buy').click(function(){
        ...
        if(checkValid){
            ...
            formData.append('cate',$('#list_product').val());
            formData.append('catDetail',$('#product_type').val());
            let url = "/ajaxNew/registAcountBuy.php";
            let response = callAjax('post', url, formData, true);
            if (response != undefined) {
