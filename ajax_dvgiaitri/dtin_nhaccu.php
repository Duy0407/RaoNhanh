...
if (isset($_COOKIE['UID'])) {
    ...
    $loai_nhaccu = getValue('loai_ncu', 'int', 'POST', 0);
        ...
        if ($cou_file > 0 || $cou_dang > 0) {
            ...
            if (mysql_num_rows($check_tde->result) > 0) {
                ...
                $inser_td = new db_query("INSERT INTO `new`(`new_title`,`link_title`, `new_money`, `new_cate_id`, `new_city`, `new_user_id`, `new_image`,
                                    ...
                                    '" . $so_nha . "', '" . $dia_chi . "', '$file_video','$ctiet_dmuc','$tinh_trang',2,'$ngay_dang'
                ...
                $inser_des = new db_query("INSERT INTO `new_description` (`new_id`, `new_description`, `loai_chung`,`canhan_moigioi`) VALUES ('$id_dt','$mo_ta','$loai_nhaccu','$canhan_moigioi')");
                ...
                //     'FromWeb' => $domain
                // ];
                // $MessageInforSupport = "Xin chào, " . $usc_company . "" . $phone . "" . $email . "tôi vừa đăng tin dịch vụ giải trí nhạc cụ trên " . $domain;
                // $data_send_to_group = [
                //     'LiveChat' => $LiveChat,
                ...
                //     'loai_chung' => $loai_nhaccu, // Loại nhạc cụ
