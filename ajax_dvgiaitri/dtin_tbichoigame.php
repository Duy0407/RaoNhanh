                ...
                if ($cou_file > 0 || $cou_dang > 0) {
                    ...
                    if (mysql_num_rows($check_tde->result) > 0) {
                        ...
                        for ($i = 0; $i < $cou_file; $i++) {
                            ...
                            $filename = '/pictures/dichvu_giaitri/' . time() . '_' . $filename_strr;
                        ...
                        $inser_td = new db_query("INSERT INTO `new`( `new_title`,`link_title`, `new_money`, `new_cate_id`, `new_city`, `new_user_id`, `new_image`,
                                    ...
                                    `chotang_mphi`, `quan_huyen`, `phuong_xa`, `new_sonha`, `dia_chi`, `new_video`, `new_ctiet_dmuc`, `new_tinhtrang`,`new_buy_sell`,
                                    ...
                                    '', '" . $dia_chi . "', '$file_video','$ctiet_dmuc','$tinh_trang',2,'$ngay_dang','$bao_hanh'
                        ...
                        $inser_des = new db_query("INSERT INTO `new_description`(`new_id`, `new_description`,`hang`,`canhan_moigioi`) VALUES ('$id_dt','$mo_ta','$hang','$canhan_moigioi')");
                        ...
                        //     'FromWeb' => $domain
                        // ];
                        // $MessageInforSupport = "Xin chào, " . $usc_company . "" . $phone . "" . $email . "tôi vừa đăng tin thiết bị chơi game trên " . $domain;
                        // $data_send_to_group = [
                        //     'LiveChat' => $LiveChat,
