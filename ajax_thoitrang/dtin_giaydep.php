...
if (isset($_COOKIE['UID'])) {
    ...
    $loai_spham = getValue('loai_san_pham', 'int', 'POST', 0);
    // truong moi
        ...
        if ($cou_file > 0 || $cou_dang > 0) {
            ...
            if (mysql_num_rows($check_tde->result) > 0) {
                ...
                $inser_td = new db_query("INSERT INTO `new`(`new_title`, `new_money`, `new_cate_id`, `new_city`, `new_user_id`, `new_image`,
                                        ...
                                        `chotang_mphi`, `quan_huyen`, `phuong_xa`, `new_sonha`, `dia_chi`, `new_video`, `new_ctiet_dmuc`,`new_tinhtrang`,`link_title`,
                ...
                $inser_des = new db_query("INSERT INTO `new_description`(`new_id`, `new_description`, `loai_chung`,`canhan_moigioi`)
                                                            VALUES ('$id_dt','$mo_ta', '$loai_spham','$canhan_moigioi')");
                include('../ajax/xac_thuc_chung.php');

                // fastcgi_finish_request();
                // $tt_crea = 'Thời trang - Giày dép';
                ...
                // create_new_api($id_dm, $id_dt, $tieu_de, $gia_spham, '', $don_vi, $tang_mphi, $arr_newcate_id, $cat_parent_id,
                //  $user_id, $tinh_thanh, $quan_huyen, $phuong_xa, $ngay_dang, $ctiet_dm, $mo_ta, $dia_chi, $dia_chi);
