    ...
    if ($user_id != 0 && $user_type != 0 && $id_dm != 0 && $tieu_de != '') {
        if ($cou_file > 0 || $cou_dang > 0) {
            ...
            if (mysql_num_rows($check_tde->result) > 0) {
                ...
                // create_new_api($id_dm, $id_dt, $tieu_de, $gia_spham, '', $don_vi, $tang_mphi, $arr_newcate_id, 
                // $cat_parent_id, $user_id, $tinh_thanh, $quan_huyen, $phuong_xa, $ngay_dang, $ctiet_dm, $mo_ta, $dia_chi, $dia_chi);
            }
        } else {
