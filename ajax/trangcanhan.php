        ...
        <div class="suatin-content-1">
            ...
            <form action="" method="post" enctype="multipart/form-data">
                <fieldset>
                    ...
                    <!-- <label class="col col-1">Ngành nghề  <span>*</span></label>
                    ...
                    <!-- <label class="col col-1">Công việc chi tiết <span>*</span></label>
                    <select class="nn_ct" name="ctcv" id="ctcv" value="">
                    </select> -->
                    <!-- <div class="gr gr-01">
                        <label class="col col-2">Trình độ học vấn<span>*</span></label>
                        <select name="trinhdo" id="trinhdo">
                            <option value="">Trình độ học vấn</option>
                            <option value="1">Đại học</option>
                            <option value="2">Cao đẳng</option>
                    ...
                    <div class="tong_s_1">
                        ...
                        <div class=" dang_tin_s_1">
                            <label class="col col-2 title_dttd_s">Chứng chỉ / Kỹ năng</label>
                    ...
                    <!-- <div class="gr-01">
                        <label class="col col-2">Kinh nghiệm làm việc<span>*</span></label>
                    ...
                    <!-- <label class="col col-1">Chứng chỉ / Kỹ năng<span>*</span></label>
                    ...
                    <!-- <div class="gr gr-01">
                        <label class="col col-2">Hạn tuyển <span>*</span></label>
                        <input type="date" name="hantuyen" id="hantuyen" >
                    </div>
                    <div class="gr-01">
                        <label class="col col-2">Số lượng tuyển dụng <span>*</span></label>
                    ...
                    <!-- <div class="luong">
                        <label class="col col-1">Mức lương <span>*</span></label>
                    ...
                    <div class="btn-gr-02 dang_tin_s dang_tin_s_submit">
                        <button type="submit" class="btn-dangtin" name="btn_tuyendung">Lưu thông tin</button>
                ...
                <form id="timvieclam" method="post"  enctype="multipart/form-data">
                    <fieldset>
                        ...
                        <div class="tong_s_1">
                            <div class="gr gr-01 dang_tin_s_1">
                                <label class="col col-2 title_dttd_s" >Số điện thoại <span>*</span></label>
                                <input class="dang_tin_right_s" type="tel" name="phone" id="phone_tv" placeholder="Nhập số điện thoại...">
                            </div>
