...
if (isset($_COOKIE['UID'])) {
    ...
    $loai_phukien_ban = getValue('loai_phukien_ban', 'str', 'POST', '');
    // end
    ...
    if ($user_id != "" && $user_type != "" && $id_dm != "" && $id_nd != "") {
        ...
        if ($cou_file > 0 || $cou_dang > 0) {
            ...
            if (mysql_num_rows($check_tde->result) > 0) {
                ...
                $update_des = new db_query("UPDATE `new_description` SET `new_description` = '$mo_ta', `loai_chung` = '$loai_phukien_ban',
