...
include("config.php");
   ...
   if($name != '' && $phone != 0 && $user_id != '')
   {
      $data = new db_execute("UPDATE user SET usc_name='".$name."',usc_phone='".$phone."',usc_city='".$city_info."',usc_gender='".$gender."',usc_birth_day='".$date."',usc_category='".$category."',usc_website='".$web."',usc_facename='".$face."',usc_skype='".$sky."',usc_job='".$nghe."' WHERE usc_id ='".$user_id."'" );
      if($data){
          echo 1;
      }
   }
