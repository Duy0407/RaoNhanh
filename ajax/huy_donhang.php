...
if (isset($_COOKIE['UID']) && isset($_COOKIE['UT'])) {
    ...
    if ($id_dh != 0 && $huy_dh != "") {
        ...
        if(mysql_num_rows($donhang -> result) > 0){
            ...
            if($_COOKIE['UID'] == $row_dh['id_nguoi_dh']){
            ...
            $updat_dh = new db_query("UPDATE `dat_hang` SET `trang_thai` = '$trang_thai', `ly_do_hdon` = '$huy_dh', `tgian_huydhang` = '$tgian_huy' WHERE `dh_id` = $id_dh ");
